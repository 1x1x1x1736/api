...
namespace Seralyth.Menu
{
    ...
    {
        public static void FavoriteAllMods()
        {
            foreach (var category in buttons)
            {
                foreach (var button in category)
                {
                    if (button.isTogglable && !favorites.Contains(button.buttonText))
                        favorites.Add(button.buttonText);
                }
            }
            NotificationManager.SendNotification("<color=grey>[</color><color=yellow>FAVORITES</color><color=grey>]</color> Added all mods to favorites.");
        }

        public static void ClearAllFavorites()
        {
            favorites.Clear();
            favorites.Add("Exit Favorite Mods");
            NotificationManager.SendNotification("<color=grey>[</color><color=yellow>FAVORITES</color><color=grey>]</color> Cleared all favorites.");
        }
        ...
        public static ButtonInfo[][] buttons =
        {
            new[] { // Main [0]
                ...
                new ButtonInfo { buttonText = "Join Discord", method = Important.JoinDiscord, isTogglable = false, toolTip = "Invites you to join the <b>1x1x1x1 Modding food place </b> Discord server.", legal = true},
                ...
                new ButtonInfo { buttonText = "Friends", method =() => { FriendManager.FriendsListUpdated(); CurrentCategoryName = "Friends"; }, isTogglable = false, toolTip = "Opens the friends tab.", legal = true},
                ...
                new ButtonInfo { buttonText = "Movement Mods", method =() => CurrentCategoryName = "Movement Mods", isTogglable = false, toolTip = "Opens the movement mods.", legal = true},
                ...
                new ButtonInfo { buttonText = "Particles", method =() => CurrentCategoryName = "Particles", isTogglable = false, toolTip = "Opens the particles mods."},
                new ButtonInfo { buttonText = "Disco", method =() => CurrentCategoryName = "Disco", isTogglable = false, toolTip = "Opens the disco mods."},
                ...
                new ButtonInfo { buttonText = "Quest Mods", method =() => { CurrentCategoryName = "Quest Mods"; AchievementManager.UnlockAchievement(new AchievementManager.Achievement { name = "Quest Seeker", description = "Follow any quest for fun.", icon = "Images/Mods/Visuals/oculus.png" }); }, isTogglable = false, toolTip = "Accept dares and complete challenges for rewards."},
                ...
                new ButtonInfo { buttonText = "Credits", method =() => CurrentCategoryName = "Credits", isTogglable = false, toolTip = "Opens the menu info page.", legal = true},
                new ButtonInfo { buttonText = "Letter Meanings", method =() => CurrentCategoryName = "Letter Meanings", isTogglable = false, toolTip = "Shows the meanings of shorthand inputs used in mod names.", legal = true},
                new ButtonInfo { buttonText = "Update Category", method =() => { Seralyth.Classes.Mods.Changelog.RefreshCategory(); CurrentCategoryName = "Update Category"; }, isTogglable = false, toolTip = "Opens the update category.", legal = true},
            ...
            new[] { // Settings [1]
                ...
                new ButtonInfo { buttonText = "Favorite Settings", method =() => CurrentCategoryName = "Favorite Settings", isTogglable = false, toolTip = "Opens the settings for your favorites."},
                new ButtonInfo { buttonText = "Update Settings", method =() => CurrentCategoryName = "Update Settings", isTogglable = false, toolTip = "Opens the update settings."}
            },
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Frozen Menu", enableMethod =() => { frozenMenu = true; closeFrozenPosition = GorillaTagger.Instance.rigidbody.transform.position; }, method = Settings.FrozenMenuUpdate, disableMethod =() => { frozenMenu = false; closeFrozenPosition = Vector3.zero; }, toolTip = "Freezes you in place and puts the menu in front of you. Menu faces you, body faces where you look.", legal = true},
                new ButtonInfo { buttonText = "Line Menu", enableMethod =() => { lineMenu = true; closeFrozenPosition = GorillaTagger.Instance.rigidbody.transform.position; }, method = Settings.LineMenuUpdate, disableMethod =() => { lineMenu = false; closeFrozenPosition = Vector3.zero; }, toolTip = "Shows a line menu bar where you can click to enable mods.", legal = true},
                ...
                new ButtonInfo { buttonText = "GunLib Line", enableMethod =() => GunLibLine = true, disableMethod =() => GunLibLine = false, toolTip = "Shows the gun pointer line in GunLib, colored to match your menu theme.", legal = true},
                new ButtonInfo { buttonText = "GunLib Trail", enableMethod =() => GunLibTrail = true, disableMethod =() => GunLibTrail = false, toolTip = "Shows a colored trail behind the GunLib pointer.", legal = true},
                new ButtonInfo { buttonText = "Change GunLib Shape", overlapText = "Change GunLib Shape <color=grey>[</color><color=green>Disabled</color><color=grey>]</color>", method =() => Settings.ChangeGunLibShape(), enableMethod =() => Settings.ChangeGunLibShape(), disableMethod =() => Settings.ChangeGunLibShape(false), incremental = true, isTogglable = false, toolTip = "Changes the pointer shape when locked onto a player in GunLib.", legal = true},
                ...
                new ButtonInfo { buttonText = "Disable Category Display", enableMethod =() => disableCategoryDisplay = true, disableMethod =() => disableCategoryDisplay = false, toolTip = "Hides the current category name next to the FPS counter."},
                new ButtonInfo { buttonText = "Change Category Display", overlapText = "Change Category Display <color=grey>[</color><color=green>Next to FPS</color><color=grey>]</color>", method =() => Settings.ChangeCategoryDisplay(), enableMethod =() => Settings.ChangeCategoryDisplay(), disableMethod =() => Settings.ChangeCategoryDisplay(false), incremental = true, isTogglable = false, toolTip = "Changes where the current category name is shown."},
                ...
                new ButtonInfo { buttonText = "Stump Updates", method =() => Seralyth.Classes.Mods.StumpUpdateDisplay.Instance?.Toggle(), isTogglable = false, toolTip = "View changelog updates.", legal = true},
                new ButtonInfo { buttonText = "Auto Scroll Updates", enableMethod =() => Seralyth.Classes.Mods.StumpUpdateDisplay.AutoScrollEnabled = true, disableMethod =() => Seralyth.Classes.Mods.StumpUpdateDisplay.AutoScrollEnabled = false, toolTip = "Automatically scrolls through the Stump Updates display.", legal = true},
            ...
            new[] { // Movement Settings [4]
                ...
                new ButtonInfo { buttonText = "Joystick Rotation Speed", overlapText = "Joystick Rotation Speed <color=grey>[</color><color=green>60</color><color=grey>]</color>", isSetting = true, value = 60, onValueChanged = () => { }, cycleValue = (val) => { }, toolTip = "Sets the speed of the joystick rotation." },
            },
            ...
            new[] { // Projectile Settings [5]
                ...
                new ButtonInfo { buttonText = "Random Growing Snowball Size", overlapText = "Random Growing Projectile Size", toolTip = "Makes the growing projectiles have random sizes." },
                ...
                new ButtonInfo { buttonText = "Projectile Aura <color=grey>[</color><color=green>T</color><color=grey>]</color>", overlapText = "Orbit Projectiles", toolTip = "Randomly spawns projectiles around you when holding <color=green>trigger</color>." },
                ...
                new ButtonInfo { buttonText = "Projectile Fountain <color=grey>[</color><color=green>T</color><color=grey>]</color>", toolTip = "Fountains projectiles above you when holding <color=green>trigger</color>." },
                ...
                new ButtonInfo { buttonText = "Change Snowball Size", overlapText = "Change Snowball Size <color=grey>[</color><color=green>5</color><color=grey>]</color>", method =() => Overpowered.ChangeSnowballScale(), enableMethod =() => Overpowered.ChangeSnowballScale(), disableMethod =() => Overpowered.ChangeSnowballScale(false), incremental = true, isTogglable = false, toolTip = "Changes the size of the growing snowballs." },
            ...
            new[] { // Room Mods [6]
                ...
                new ButtonInfo { buttonText = "RoomCodeLabel", overlapText = "Room Code: Not In Room", label = true},
                ...
                new ButtonInfo { buttonText = "Name Creator", method = Important.NameCreator, isTogglable = false, toolTip = "Create your own custom name!"},
                new ButtonInfo { buttonText = "Save Created Rooms", method = Important.SaveCreatedRooms, isTogglable = false, toolTip = "Saves all created room buttons to disk."},
                new ButtonInfo { buttonText = "Save Created Names", method = Important.SaveCreatedNames, isTogglable = false, toolTip = "Saves all created name buttons to disk."},
                new ButtonInfo { buttonText = "Delete Created Rooms", method = Important.ClearCreatedRooms, isTogglable = false, toolTip = "Removes all created room buttons from this category."},
                new ButtonInfo { buttonText = "Delete Created Names", method = Important.ClearCreatedNames, isTogglable = false, toolTip = "Removes all created name buttons from this category."},

                new ButtonInfo { buttonText = "Disconnect", method =() => NetworkSystem.Instance.ReturnToSinglePlayer(), isTogglable = false, toolTip = "Disconnects you from the the room.", legal = true},
                ...
                new ButtonInfo { buttonText = "Room Browser", method = Important.RoomBrowserShow, isTogglable = false, toolTip = "Shows current room info, player list, and player count."},
                new ButtonInfo { buttonText = "Join Public Map", method = Important.RoomBrowserJoinMap, isTogglable = false, toolTip = "Joins a random public room for the selected map. Use Cycle Map to change."},
                new ButtonInfo { buttonText = "Cycle Map", method = Important.RoomBrowserCycleMap, isTogglable = false, toolTip = "Cycles through available maps for the Room Browser."},
                new ButtonInfo { buttonText = "Create & Join Room", method = Important.RoomBrowserCreateAndJoin, isTogglable = false, toolTip = "Creates a new public room and joins it."},
                ...
                new ButtonInfo { buttonText = "Auto Join Room \"VR12\"", method =() => Important.QueueRoom("VR12"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"VR12\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"1X1X1X1VR12\"", method =() => Important.QueueRoom("1X1X1X1VR12"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"1X1X1X1VR12\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"1X1X1X1VR121\"", method =() => Important.QueueRoom("1X1X1X1VR121"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"1X1X1X1VR121\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"VR12\"", method =() => Important.QueueRoom("VR12"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"VR12\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"GT13\"", method =() => Important.QueueRoom("GT13"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"GT13\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"K9\"", method =() => Important.QueueRoom("K9"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"K9\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"VMT\"", method =() => Important.QueueRoom("VMT"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"VMT\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"QWERTY\"", method =() => Important.QueueRoom("QWERTY"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"QWERTY\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"1x1x1x1\"", method =() => Important.QueueRoom("1x1x1x1"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"1x1x1x1\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"Hi\"", method =() => Important.QueueRoom("Hi"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"Hi\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"MOD3\"", method =() => Important.QueueRoom("MOD3"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"MOD3\" every couple of seconds until connected." },
            },
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Clear Notifications", method = NotificationManager.ClearAllNotifications, isTogglable = false, toolTip = "Clears your notifications. Good for when they get stuck.", legal = true},
                ...
                new ButtonInfo { buttonText = "100 FPS", method =() => Important.CapFPS(100), toolTip = "Caps your FPS at 100 frames per second."},
                new ButtonInfo { buttonText = "90 FPS", method =() => Important.CapFPS(90), toolTip = "Caps your FPS at 90 frames per second."},
                new ButtonInfo { buttonText = "80 FPS", method =() => Important.CapFPS(80), toolTip = "Caps your FPS at 80 frames per second."},
                ...
                new ButtonInfo { buttonText = "55 FPS", method =() => Important.CapFPS(55), toolTip = "Caps your FPS at 55 frames per second."},
                new ButtonInfo { buttonText = "50 FPS", method =() => Important.CapFPS(50), toolTip = "Caps your FPS at 50 frames per second."},
            ...
            new[] { // Safety Mods [8]
                ...
                new ButtonInfo { buttonText = "Auto Report System <color=grey>[</color><color=green>ARS</color><color=grey>]</color>", enableMethod = Safety.EnableAutoReportSystem, disableMethod = Safety.DisableAutoReportSystem, toolTip = "Automatically reports players who are on the ARS database."},
                ...
                new ButtonInfo { buttonText = "AFR <color=grey>[</color><color=green>Auto Flush Report</color><color=grey>]</color>", enableMethod = Safety.EnableAFR, disableMethod = Safety.DisableAFR, method = Safety.AFR, toolTip = "Automatically flushes pending RPCs and reports anyone back who presses your report button."},
                new ButtonInfo { buttonText = "AF <color=grey>[</color><color=green>Auto Flush Mute</color><color=grey>]</color>", enableMethod = Safety.EnableAF, disableMethod = Safety.DisableAF, method = Safety.AF, toolTip = "Automatically mutes anyone back who tries to mute you."},
                ...
                new ButtonInfo { buttonText = "Block Player", overlapText = "Block Player <color=grey>[</color><color=green>None</color><color=grey>]</color>", method = Settings.HandleBlockedPlayers, isTogglable = false, toolTip = "Blocks or unblocks the player you're pointing at, hiding their mods."},
                new ButtonInfo { buttonText = "Unblock Player", method =() => Settings.Blocked.Clear(), isTogglable = false, toolTip = "Unblocks all blocked players."},

                new ButtonInfo { buttonText = "Copy Room Code", method = Safety.CopyRoomCode, isTogglable = false, toolTip = "Copies your current room code to your clipboard."},
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "Platforms", overlapText = "Platforms <color=grey>[</color><color=green>G</color><color=grey>]</color>", postMethod =() => Movement.Platforms(), toolTip = "Spawns platforms on your hands when holding <color=green>grip</color>.", legal = true},
                new ButtonInfo { buttonText = "Trigger Platforms", overlapText = "Trigger Platforms <color=grey>[</color><color=green>T</color><color=grey>]</color>", postMethod =() => Movement.Platforms(leftTrigger > 0.5f, rightTrigger > 0.5f), toolTip = "Spawns platforms on your hands when holding <color=green>trigger</color>.", legal = true},
                new ButtonInfo { buttonText = "Frozone", overlapText = "Frozone <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Movement.Frozone, toolTip = "Spawns slippery blocks under your hands using <color=green>grip</color>.", legal = true},
                new ButtonInfo { buttonText = "Platform Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Movement.PlatformSpam, toolTip = "Spawns legacy platforms rapidly at your hand for those who have networked platforms.", legal = true},
                new ButtonInfo { buttonText = "Platform Gun", method = Movement.PlatformGun, toolTip = "Spawns legacy platforms rapidly wherever your hand desires for those who have networked platforms.", legal = true},

                new ButtonInfo { buttonText = "Fly <color=grey>[</color><color=green>A</color><color=grey>]</color>", aliases = new[] { "Super Monke" }, method = Movement.Fly, toolTip = "Sends your character forwards when holding <color=green>A</color>.", legal = true},
                new ButtonInfo { buttonText = "Trigger Fly <color=grey>[</color><color=green>T</color><color=grey>]</color>", method = Movement.TriggerFly, toolTip = "Sends your character forwards when holding <color=green>trigger</color>.", legal = true},
                new ButtonInfo { buttonText = "Grip Fly <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Movement.GripFly, toolTip = "Sends your character forwards when holding right <color=green>grip</color>.", legal = true},
                ...
                new ButtonInfo { buttonText = "Hand Fly <color=grey>[</color><color=green>A</color><color=grey>]</color>", method = Movement.HandFly, toolTip = "Sends your character in your hand's direction when holding <color=green>A</color>.", legal = true},
                ...
                new ButtonInfo { buttonText = "Fly Gun", method = Movement.FlyGun, toolTip = "Flies you towards wherever your gun is pointing."},
                ...
                new ButtonInfo { buttonText = "Zoom <color=grey>[</color><color=green>RT</color><color=grey>]</color>", method = Movement.Zoom, toolTip = "Zooms your view in and out using the <color=green>right trigger</color>.", legal = true},
                ...
                new ButtonInfo { buttonText = "Quick Teleports", method = Movement.OpenQuickTeleports, isTogglable = false, toolTip = "Quick teleports to preset maps and saved positions."},
                ...
                new ButtonInfo { buttonText = "Track Player", method = Movement.TrackPlayer, disableMethod = Movement.DisableTrackPlayer, toolTip = "Shows the closest player's name and distance on screen."},
                new ButtonInfo { buttonText = "Cycle Tracked Player", method = Movement.CycleTrackedPlayer, isTogglable = false, toolTip = "Switches to the next player to track."},
                new ButtonInfo { buttonText = "Teleport to Tracked", method = Movement.TeleportToTracked, isTogglable = false, toolTip = "Teleports you to the currently tracked player."},
                new ButtonInfo { buttonText = "Follow Tracked", method =() => { Movement.trackFollowing = true; Movement.TrackPlayer(); }, disableMethod =() => { Movement.trackFollowing = false; }, toolTip = "Flies you towards the tracked player automatically."},
                ...
                new ButtonInfo { buttonText = "Liquid Run Helper", overlapText = "Liquid Run", enableMethod =() => Movement.WaterRunHelper(true), disableMethod =() => Movement.WaterRunHelper(false), toolTip = "Adds back the nostalgic water running to the game." },
                ...
                new ButtonInfo { buttonText = "Backflip <color=grey>[</color><color=green>A</color><color=grey>]</color>", enableMethod =() => TorsoPatch.VRRigLateUpdate += Movement.VRRigLateUpdate_BackFlip, method =() => ghostException = true, disableMethod =() => { TorsoPatch.VRRigLateUpdate -= Movement.VRRigLateUpdate_BackFlip; ghostException = false; }, toolTip = "Makes you backflip when you click your <color=green>A</color> button."},
            ...
            new[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Cosmetic ESP", aliases = new[] { "Special Cosmetic Indicators" }, method = Visuals.CosmeticESP, disableMethod = Visuals.DisableCosmeticESP, toolTip = "Shows icons above people's heads if they are a Finger Painter, Illustrator, Administrator, Stick, Forest Guide, or Another Axiom Creator."},
                ...
                new ButtonInfo { buttonText = "Voice ESP", method = Visuals.VoiceESP, disableMethod = Visuals.DisableVoiceIndicators, toolTip = "Puts voice indicators above people's heads when they're talking, but now they go through walls.", legal = true},
                ...
                new ButtonInfo { buttonText = "Farthest Tracer", method = Visuals.FarthestTracer, toolTip = "Draws a tracer line from your hand to the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Box ESP", method = Visuals.NearestBoxESP, disableMethod = Visuals.DisableBoxESP, toolTip = "Puts a box over the nearest player."},
                new ButtonInfo { buttonText = "Farthest Box ESP", method = Visuals.FarthestBoxESP, disableMethod = Visuals.DisableBoxESP, toolTip = "Puts a box over the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Hollow Box ESP", method = Visuals.NearestHollowBoxESP, disableMethod = Visuals.DisableHollowBoxESP, toolTip = "Puts a hollow box over the nearest player."},
                new ButtonInfo { buttonText = "Farthest Hollow Box ESP", method = Visuals.FarthestHollowBoxESP, disableMethod = Visuals.DisableHollowBoxESP, toolTip = "Puts a hollow box over the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Breadcrumbs", method = Visuals.NearestBreadcrumbs, disableMethod = Visuals.DisableBreadcrumbs, toolTip = "Puts breadcrumb trails over the nearest player."},
                new ButtonInfo { buttonText = "Farthest Breadcrumbs", method = Visuals.FarthestBreadcrumbs, disableMethod = Visuals.DisableBreadcrumbs, toolTip = "Puts breadcrumb trails over the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Bone ESP", method = Visuals.NearestBoneESP, disableMethod = Visuals.DisableBoneESP, toolTip = "Puts bones over the nearest player."},
                new ButtonInfo { buttonText = "Farthest Bone ESP", method = Visuals.FarthestBoneESP, disableMethod = Visuals.DisableBoneESP, toolTip = "Puts bones over the farthest player."},

                new ButtonInfo { buttonText = "Casual Ball ESP", method = Visuals.CasualBallESP, disableMethod = Visuals.DisableBallESP, toolTip = "Puts spheres over balls. Shows everyone."},
                new ButtonInfo { buttonText = "Infection Ball ESP", method = Visuals.InfectionBallESP, disableMethod = Visuals.DisableBallESP, toolTip = "Puts spheres over balls. Shows for the current gamemode."},
                new ButtonInfo { buttonText = "Automatic Ball ESP", method =() => Visuals.AutomaticESP(Visuals.InfectionBallESP, Visuals.CasualBallESP, Visuals.CasualBallESP), disableMethod = Visuals.DisableBallESP, toolTip = "Puts spheres over balls. Shows targets for the current gamemode."},
                new ButtonInfo { buttonText = "Nearest Ball ESP", method = Visuals.NearestBallESP, disableMethod = Visuals.DisableBallESP, toolTip = "Puts a sphere over the nearest ball."},
                new ButtonInfo { buttonText = "Farthest Ball ESP", method = Visuals.FarthestBallESP, disableMethod = Visuals.DisableBallESP, toolTip = "Puts a sphere over the farthest ball."},
                ...
                new ButtonInfo { buttonText = "Nearest Skeleton ESP", method = Visuals.NearestSkeletonESP, disableMethod = Visuals.DisableSkeletonESP, toolTip = "Lets you see the nearest players skeleton through walls."},
                new ButtonInfo { buttonText = "Farthest Skeleton ESP", method = Visuals.FarthestSkeletonESP, disableMethod = Visuals.DisableSkeletonESP, toolTip = "Lets you see the farthest players skeleton through walls."},
                ...
                new ButtonInfo { buttonText = "Nearest Wireframe ESP", method = Visuals.NearestWireframeESP, disableMethod = Visuals.DisableWireframeESP, toolTip = "Puts a wireframe over the nearest player."},
                new ButtonInfo { buttonText = "Farthest Wireframe ESP", method = Visuals.FarthestWireframeESP, disableMethod = Visuals.DisableWireframeESP, toolTip = "Puts a wireframe over the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Chams", method = Visuals.NearestChams, disableMethod = Visuals.DisableChams, toolTip = "Lets you see the nearest player through walls."},
                new ButtonInfo { buttonText = "Farthest Chams", method = Visuals.FarthestChams, disableMethod = Visuals.DisableChams, toolTip = "Lets you see the farthest player through walls."},
                ...
                new ButtonInfo { buttonText = "Nearest Beacons", method = Visuals.NearestBeacons, disableMethod =() => Visuals.isLineRenderQueued = true, toolTip = "Puts a beacon above the nearest player."},
                new ButtonInfo { buttonText = "Farthest Beacons", method = Visuals.FarthestBeacons, disableMethod =() => Visuals.isLineRenderQueued = true, toolTip = "Puts a beacon above the farthest player."},
                ...
                new ButtonInfo { buttonText = "Nearest Distance ESP", method = Visuals.NearestDistanceESP, disableMethod =() => Visuals.isNameTagQueued = true, toolTip = "Shows your distance from the nearest player."},
                new ButtonInfo { buttonText = "Farthest Distance ESP", method = Visuals.FarthestDistanceESP, disableMethod =() => Visuals.isNameTagQueued = true, toolTip = "Shows your distance from the farthest player."},

                new ButtonInfo { buttonText = "Time Warp", overlapText = "Time Warp <color=grey>[</color><color=green>30%</color><color=grey>]</color>", method = CoolMods.TimeWarp, enableMethod = CoolMods.EnableTimeWarp, disableMethod = CoolMods.DisableTimeWarp, toolTip = "Slows down time."},
                new ButtonInfo { buttonText = "Change Time Warp Speed", overlapText = "Change Time Warp Speed <color=grey>[</color><color=green>30%</color><color=grey>]</color>", method =() => CoolMods.ChangeTimeWarpSpeed(), enableMethod =() => CoolMods.ChangeTimeWarpSpeed(), disableMethod =() => CoolMods.ChangeTimeWarpSpeed(false), incremental = true, isTogglable = false, toolTip = "Changes the time warp speed percentage."},
                new ButtonInfo { buttonText = "Magnetic Pull", method = CoolMods.MagneticPull, enableMethod = CoolMods.EnableMagneticPull, toolTip = "Hold <color=green>G</color> to pull objects toward your hand."},
                new ButtonInfo { buttonText = "Shockwave", method = CoolMods.Shockwave, enableMethod = CoolMods.EnableShockwave, toolTip = "Press <color=green>G</color> to unleash a shockwave that pushes everything away."},
                new ButtonInfo { buttonText = "Grapple Hook", method = CoolMods.Grapple, enableMethod = CoolMods.EnableGrapple, disableMethod = CoolMods.DisableGrapple, toolTip = "Point and hold <color=green>G</color> to grapple toward surfaces."},
                new ButtonInfo { buttonText = "Air Jump", overlapText = "Air Jump <color=grey>[</color><color=green>10</color><color=grey>]</color>", method = CoolMods.AirJump, enableMethod = CoolMods.EnableAirJump, toolTip = "Touch a wall to gain a charge, then press <color=green>A</color> to launch where you're looking."},
                new ButtonInfo { buttonText = "Change Air Jump Boost", overlapText = "Change Air Jump Boost <color=grey>[</color><color=green>10</color><color=grey>]</color>", method =() => CoolMods.ChangeAirJumpBoost(), enableMethod =() => CoolMods.ChangeAirJumpBoost(), disableMethod =() => CoolMods.ChangeAirJumpBoost(false), incremental = true, isTogglable = false, toolTip = "Changes the boost strength of the air jump mod."},
                new ButtonInfo { buttonText = "Auto Juke", method = CoolMods.AutoJuke, enableMethod = CoolMods.EnableAutoJuke, toolTip = "Automatically dodges away from infected players in infection modes."},
                new ButtonInfo { buttonText = "Ground Slam", method = CoolMods.GroundSlam, enableMethod = CoolMods.EnableGroundSlam, toolTip = "Press <color=green>B</color> to slam into the ground with extreme force."},
                
                new ButtonInfo { buttonText = "Custom Build Mode", aliases = new[] { "Developer Mode" }, enableMethod =() => { File.WriteAllText($"{PluginInfo.BaseDirectory}/.custom-build", ""); Console.SendNotification("Custom build mode enabled. Updates will be skipped to preserve changes.", 3000); }, disableMethod =() => { if (File.Exists($"{PluginInfo.BaseDirectory}/.custom-build")) File.Delete($"{PluginInfo.BaseDirectory}/.custom-build"); Console.SendNotification("Custom build mode disabled. Updates will proceed normally.", 3000); }, toolTip = "When enabled, the in-game updater will skip itself so your local changes are preserved across builds. Disable to allow normal updates."},
                ...
                new ButtonInfo { buttonText = "Player info gun", method = Visuals.playerinfogun, toolTip = "Shows the info mods on their head where the pointer disures."},
                new ButtonInfo { buttonText = "Player info head gun", method = Visuals.playerinfohandgun, toolTip = "Shows the info mods on your hand where the pointer disures."},
                new ButtonInfo { buttonText = "Player info hand gun", method = Visuals.playerinfohandgunV2, toolTip = "Shows the info mods on your hand where the pointer disures."},
                new ButtonInfo { buttonText = "Player info hand gun <color=grey>[</color><color=green>V2</color><color=grey>]</color>", method = Visuals.playerinfohandgunV3, toolTip = "Shows the info mods on your hand where the pointer disures."},
                new ButtonInfo { buttonText = "Player info hand line", method = Visuals.playerinfoline, toolTip = "Shows the info mods on your hand where the pointer disures hit A to close the info mods ."},
                new ButtonInfo { buttonText = "Player info hand line typewriter", method = Visuals.playerinfolineV2, toolTip = "Shows info mods on your hand with a typewriter effect. Hit A to close."},
                new ButtonInfo { buttonText = "Player info aura", method = Visuals.PlayerInfoAuraV5, toolTip = "Shows player info on your hand for the closest player within a 4m radius circle. Press A to toggle on/off."},
                new ButtonInfo { buttonText = "Player info closest", enableMethod =() => Visuals.InfoPlayerModEnabled = true, method = Visuals.PlayerInfoClosestPlayer, disableMethod =() => { Visuals.InfoPlayerModEnabled = false; Visuals.CleanupAllVisualsV4(); }, toolTip = "Shows player info on your hand for the closest player within 5m with a tracer line. Press GRIP to scan details."},
                new ButtonInfo { buttonText = "Cool Chams", enableMethod = Visuals.ApplyChams, disableMethod = Visuals.RestoreChams, toolTip = "Shows people that are highlited through walls"},
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Screenshot Mode", method = Important.ScreenshotMode, isTogglable = false, toolTip = "Hides the menu and notifications, takes a screenshot, then restores everything."},

                new ButtonInfo { buttonText = "Auto Emote", method = Fun.AutoEmote, disableMethod = Fun.AutoEmoteReset, toolTip = "Plays rhythmic hand tap sounds in a pattern, making it look like you're emoting."},
                new ButtonInfo { buttonText = "Touch Fling", method = Fun.TouchFling, disableMethod = Fun.TouchFlingReset, toolTip = "Touch someone to fling them, or use GunLib to grab and trigger-fling them away."},
                ...
                new ButtonInfo { buttonText = "Random Head", method = Fun.RandomHead, disableMethod = Fun.FixHead, toolTip = "Randomly switches your head rotation while enabled."},
                ...
                new ButtonInfo { buttonText = "Rainbow Trail", method = Fun.RainbowTrail, disableMethod = Fun.FixRainbowTrail, toolTip = "Leaves a rainbow-colored trail behind you as you move."},
                new ButtonInfo { buttonText = "Red Trail", method = Fun.RedTrail, disableMethod = Fun.FixRedTrail, toolTip = "Leaves a red trail behind you as you move."},
                new ButtonInfo { buttonText = "Blue Trail", method = Fun.BlueTrail, disableMethod = Fun.FixBlueTrail, toolTip = "Leaves a blue trail behind you as you move."},
                new ButtonInfo { buttonText = "Green Trail", method = Fun.GreenTrail, disableMethod = Fun.FixGreenTrail, toolTip = "Leaves a green trail behind you as you move."},
                new ButtonInfo { buttonText = "Yellow Trail", method = Fun.YellowTrail, disableMethod = Fun.FixYellowTrail, toolTip = "Leaves a yellow trail behind you as you move."},
                new ButtonInfo { buttonText = "Purple Trail", method = Fun.PurpleTrail, disableMethod = Fun.FixPurpleTrail, toolTip = "Leaves a purple trail behind you as you move."},
                new ButtonInfo { buttonText = "Orange Trail", method = Fun.OrangeTrail, disableMethod = Fun.FixOrangeTrail, toolTip = "Leaves an orange trail behind you as you move."},
                new ButtonInfo { buttonText = "Pink Trail", method = Fun.PinkTrail, disableMethod = Fun.FixPinkTrail, toolTip = "Leaves a pink trail behind you as you move."},
                new ButtonInfo { buttonText = "Cyan Trail", method = Fun.CyanTrail, disableMethod = Fun.FixCyanTrail, toolTip = "Leaves a cyan trail behind you as you move."},
                new ButtonInfo { buttonText = "White Trail", method = Fun.WhiteTrail, disableMethod = Fun.FixWhiteTrail, toolTip = "Leaves a white trail behind you as you move."},

                new ButtonInfo { buttonText = "Jelly Physics", method = JellyPhysics.Enable, disableMethod = JellyPhysics.Disable, toolTip = "Makes your body jiggly like jello."},

                new ButtonInfo { buttonText = "Orbitz", method = Fun.Orbitz, disableMethod = Fun.FixOrbitz, toolTip = "Colorful spheres orbit around your body like a planetary system."},
                new ButtonInfo { buttonText = "Orbitz <color=grey>[</color><color=green>V2</color><color=grey>]</color>", method = Fun.OrbitzV2, disableMethod = Fun.FixOrbitzV2, toolTip = "Colorful spheres float on the left and right sides of your body."},
                new ButtonInfo { buttonText = "Orbitz Cubes", method = Fun.OrbitzCubes, disableMethod = Fun.FixOrbitzCubes, toolTip = "Colorful cubes orbit around your body like a planetary system."},
                new ButtonInfo { buttonText = "Orbitz Cubes <color=grey>[</color><color=green>V2</color><color=grey>]</color>", method = Fun.OrbitzCubesV2, disableMethod = Fun.FixOrbitzCubesV2, toolTip = "Colorful cubes float on the left and right sides of your body."},
                ...
                new ButtonInfo { buttonText = "Water Splash On Touch", method = Fun.WaterSplashOnTouch, toolTip = "Splashes water on players you touch."},
                ...
                new ButtonInfo { buttonText = "Surprise Me", enableMethod = Fun.PreloadJumpscareData, method = Fun.SurpriseMe, isTogglable = false, toolTip = "Triggers a random VR surprise on yourself."},
                new ButtonInfo { buttonText = "Enable Random Mod", method = Main.EnableRandomMod, isTogglable = false, toolTip = "Enables one random disabled mod."},
                ...
                new ButtonInfo { buttonText = "Legacy Microphone", enableMethod =() => { RecorderPatch.enabled = false; Fun.ReloadMicrophone();  }, disableMethod =() => { RecorderPatch.enabled = true; Fun.ReloadMicrophone(); }, toolTip = "Reverts the microphone system into using the legacy input switcher. This is generally not recommended.", legal = true},
                ...
                new ButtonInfo { buttonText = "Set Quest Score <color=grey>[</color><color=green>100</color><color=grey>]</color>", method =() => Fun.SetQuestScore(100), isTogglable = false, toolTip = "Sets your quest score to 100."},
                new ButtonInfo { buttonText = "Set Quest Score", method =() => PromptText("Enter desired quest score:", () => { if (int.TryParse(keyboardInput, out int score)) Fun.SetQuestScore(score); }, null, "Done", "Cancel"), isTogglable = false, toolTip = "Sets your custom quest score to the number you type."},
                ...
                new ButtonInfo { buttonText = "GunLib Checkpoint <color=grey>[</color><color=green>RG+T</color><color=grey>]</color><color=grey>[</color><color=green>A</color><color=grey>]</color>", method = Fun.GunLibCheckpoint, disableMethod = Fun.DisableGunLibCheckpoint, toolTip = "Point with right grip, press trigger to place a checkpoint sphere, press A to teleport to it." },
                ...
                new ButtonInfo { buttonText = "Set Name to \"JesusisKing\"", method =() => ChangeName("Jesusisking"), isTogglable = false, toolTip = "Sets your name to \"JesusisKing\"." }, 
                new ButtonInfo { buttonText = "Set Name to \"SERALYTHONTOP\"", method =() => ChangeName("SERALYTHONTOP"), isTogglable = false, toolTip = "Sets your name to \"SERALYTHONTOP\"." },
                new ButtonInfo { buttonText = "Set Name to \"SERALYTHONTOP1\"", method =() => ChangeName("SERALYTHONTOP1"), isTogglable = false, toolTip = "Sets your name to \"SERALYTHONTOP1\"." },
                new ButtonInfo { buttonText = "Set Name to \"discord.gg/hXeyjkFx97\"", method =() => ChangeName("discord.gg/hXeyjkFx97"), isTogglable = false, toolTip = "Sets your name to \"discord.gg/hXeyjkFx97\"." },
              

                new ButtonInfo { buttonText = "Change Name", method =() => PromptText("What name would you like", () => Main.ChangeName(keyboardInput), null, "Done", "Cancel"), isTogglable = false, toolTip = "Sets your name what you type in." },
                ...
                new ButtonInfo { buttonText = "Become \"1X1X1X1VR12\"", method =() => Fun.BecomePlayer("1X1X1X1VR12", Color.green), isTogglable = false, toolTip = "Sets your name to \"1X1X1X1VR12\" and color to black." },
                ...
                new ButtonInfo { buttonText = "Unmute Gun", method = Fun.UnmuteGun, toolTip = "Unmutes the player when you muted them as the pointer disires." },
                new ButtonInfo { buttonText = "Unmute All", method = Fun.UnmuteAll, isTogglable = false, toolTip = "Unmutes everyone." },
                new ButtonInfo { buttonText = "Self Tracker", method =() => Fun.DiscordLobbyLogger(), toolTip = "Sends lobby code to Discord when you join a new one."},
               


                new ButtonInfo { buttonText = "Robux", method =() => Fun.RobuxSpam(), toolTip = "Spawns Robux using Right Grip."},
                new ButtonInfo { buttonText = "Robux Gun", method =() => Fun.RobuxGun(), toolTip = "Spawns Robux using Right Grip."},
                new ButtonInfo { buttonText = "Thin Robux Gun", method =() => Fun.ThinRobuxGun(), toolTip = "Spawns Robux using Right Grip."},
                new ButtonInfo { buttonText = "Orb Gun", method =() => Fun.OrbGun(), toolTip = "Spawn orbs where the gun disires."},
                new ButtonInfo { buttonText = "Orb Gun <color=grey>[</color><color=green>V2</color><color=grey>]</color>", method =() => Fun.OrbGunV2(), toolTip = "Spawn orbs where the gun disires."},
                new ButtonInfo { buttonText = "Orb Spam <color=grey>[</color><color=green>RG</color><color=grey>]</color>", method =() => Fun.OrbSpam(), toolTip = "Spawn orbs with right grip."},
                new ButtonInfo { buttonText = "Orb Spam <color=grey>[</color><color=green>V2</color><color=grey>]</color>", method =() => Fun.OrbSpamV2(), toolTip = "Spawn orbs with right grip and gives you count down."},

                new ButtonInfo { buttonText = "Monke Clicker <color=grey>[</color><color=green>G/T</color><color=grey>]</color>", enableMethod = MonkeClicker.Enable, method = MonkeClicker.Run, disableMethod = MonkeClicker.Disable, toolTip = "Hold <color=green>grip</color> to show a line, press <color=green>trigger</color> to click anything the line hits through walls."},
                new ButtonInfo { buttonText = "Boombox <color=grey>[</color><color=green>Non Admin</color><color=grey>]</color>", method = () => Boombox.BoomboxUpdate(), disableMethod =() => Boombox.DisableBoombox(), toolTip = "Spawns a boombox sign that follows you."},

                new ButtonInfo { buttonText = "Music Player", method = () => MediaPlayer.PlayMusic(), disableMethod =() => MediaPlayer.StopMusic(), toolTip = "Plays music from your Music folder."},
                new ButtonInfo { buttonText = "Music Player File:", overlapText = "Music Player File: <color=grey>[</color><color=green>None</color><color=grey>]</color>", method = () => MediaPlayer.NextMusic(), enableMethod = () => MediaPlayer.NextMusic(), disableMethod = () => MediaPlayer.PrevMusic(), incremental = true, isTogglable = false, toolTip = "Changes the music file."},
            },
            ...
            new[] { // Projectile Spam Mods [15]
                ...
                new ButtonInfo { buttonText = "Snowball Safety Bubble", aliases = new[] { "Snowball Fling Aura" }, method = Overpowered.SnowballSafetyBubble, toolTip = "Anyone who gets too close to you will be launched away."},
                ...
                new ButtonInfo { buttonText = "GunLib Fling Gun", method = Fun.GunLibFlingGun, toolTip = "Flings whoever your hand desires using GunLib."},
                new ButtonInfo { buttonText = "GunLib Fling Gun V2", method = Fun.GunLibFlingGunV2, toolTip = "Flings whoever your hand desires using RPC instead of snowballs."},
            ...
            new[] { // Master Mods [16]
                ...
                new ButtonInfo { buttonText = "Copy Name Self", method = CopyName.Self, isTogglable = false, toolTip = "Copies your name to your clipboard."},
                new ButtonInfo { buttonText = "Copy Name Gun", method = CopyName.Gun, toolTip = "Copies the name of whoever your hand desires to your clipboard."},
                new ButtonInfo { buttonText = "Copy Name All", method = CopyName.All, isTogglable = false, toolTip = "Copies everyone in the room's name to your clipboard."},
            ...
            new[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Crash on Grab", method =() => Overpowered.DirectionOnGrab(Vector3.one), toolTip = "Crashes the player when they grab you. f" },
                ...
                new ButtonInfo { buttonText = "BloodRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.BloodRain, toolTip = "Creates Bloodrain." },
                new ButtonInfo { buttonText = "GreenRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.GreenRain, toolTip = "Creates Greenrain." },
                new ButtonInfo { buttonText = "BlueRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.blueRain, toolTip = "Creates Bluerain." },
                new ButtonInfo { buttonText = "PinkRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.pinkRain, toolTip = "Creates Pinkrain." },
                new ButtonInfo { buttonText = "PurpleRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.PurpleRain, toolTip = "Creates Purplerain." },
                new ButtonInfo { buttonText = "CyanRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.CyanRain, toolTip = "Creates Cyanrain." },
                new ButtonInfo { buttonText = "YellowRain <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.YellowRain, toolTip = "Creates Yellowrain." },
            ...
            new[] { // Favorite Settings [20]
                new ButtonInfo { buttonText = "Exit Favorite Settings", method =() => CurrentCategoryName = "Settings", isTogglable = false, toolTip = "Returns you back to the settings menu."},

                new ButtonInfo { buttonText = "Favorite All Mods", method =() => FavoriteAllMods(), isTogglable = false, toolTip = "Adds all mods to your favorites."},
                new ButtonInfo { buttonText = "Clear All Favorites", method =() => ClearAllFavorites(), isTogglable = false, toolTip = "Removes all mods from your favorites."}
            },
            ...
            new[] { // Console Assets [24]
                ...
                new ButtonInfo { buttonText = "Big Console Assets", enableMethod =() => Experimental.BigAssets(), disableMethod =() => Experimental.NoBigAssets(), isTogglable = true, toolTip = "Makes most assets bigger."},
                new ButtonInfo { buttonText = "Forsaken", enableMethod =() => Experimental.Forsaken(), disableMethod =() => Experimental.UForsaken(), toolTip = "Spawns the Forsaken asset frozen in place."},
                new ButtonInfo { buttonText = "Travis Scott Event Forest", enableMethod =() => Experimental.TSEF(), disableMethod =() => Experimental.UTSEF(), toolTip = "credits to obj he gave me this"}, 
                new ButtonInfo { buttonText = "Mini Travis Scott", enableMethod = Experimental.MiniTravis, disableMethod = Experimental.UMiniTravis, toolTip = "Spawns a mini Travis Scott in your hand."},
                new ButtonInfo { buttonText = "Rainbow Sword", method =() => Experimental.RSword(), disableMethod =() => Experimental.URSword()},
                new ButtonInfo { buttonText = "Twerking Carti", enableMethod =() => Experimental.TwerkingCarti(), disableMethod =() => Experimental.NoCarti()},
                new ButtonInfo { buttonText = "Coin Flip", method = () => Experimental.CoinFlip(), disableMethod =() => Experimental.NoCarti()},
                new ButtonInfo { buttonText = "Ban Hammer", method = () => Experimental.BanHammer(), disableMethod =() => Experimental.UBanHammer()},
                new ButtonInfo { buttonText = "Axe", method = () => Experimental.Axe(), disableMethod =() => Experimental.UAxe()},
                new ButtonInfo { buttonText = "Nuke", method = () => Experimental.Nuke(), disableMethod =() => Experimental.UNuke()},
                new ButtonInfo { buttonText = "Physics Gun", method = () => Experimental.PhysicsGun(), disableMethod =() => Experimental.UPhysicsGun()},
                new ButtonInfo { buttonText = "Pistol", method =() => Experimental.Pistol(), disableMethod =() => Experimental.UPistol()},
                new ButtonInfo { buttonText = "Diamond Sword", method = () => Experimental.DiamondSword(), disableMethod =() => Experimental.destroysomethingidk()},
                new ButtonInfo { buttonText = "Concert", method = () => Experimental.Concert(), disableMethod =() => Experimental.UConcert()},
                new ButtonInfo { buttonText = "Concert Video: ", method =() => Experimental.ChangeConcertVideo(), enableMethod =() => Experimental.ChangeConcertVideo(), disableMethod =() => Experimental.ChangeConcertVideo(false), incremental = true, isTogglable = false, toolTip = "Changes the song that plays on the concert stage."},
                new ButtonInfo { buttonText = "Mod Menu", method = () => Experimental.ModMenu(), disableMethod =() => Experimental.UModMenu()},
                new ButtonInfo { buttonText = "Boombox", method = () => Experimental.Boombox(), disableMethod =() => Experimental.UBoombox()},
                new ButtonInfo { buttonText = "Donation Nuke", method = () => Experimental.DonationNuke(), disableMethod =() => Experimental.UDonationNuke()},
                new ButtonInfo { buttonText = "WiiRemote", method = () => Experimental.WiiRemote(), disableMethod =() => Experimental.UWiiRemote()},
                new ButtonInfo { buttonText = "Roblox Sword", method = () => Experimental.MySword(), disableMethod =() => Experimental.UMySword()},
                new ButtonInfo { buttonText = "Shreksophone", method = () => Experimental.Shrek(), disableMethod =() => Experimental.UShrek()},
                new ButtonInfo { buttonText = "Video Player", enableMethod =() => Experimental.VideoPlayer(), disableMethod =() => Experimental.UVideoPlayer()},
                new ButtonInfo { buttonText = "Video Player Video: ", method =() => Experimental.ChangeVideo(), enableMethod =() => Experimental.ChangeVideo(), disableMethod =() => Experimental.ChangeVideo(false), incremental = true, isTogglable = false, toolTip = "Changes the video that plays on the video player."},
                new ButtonInfo { buttonText = "Samsung Phone", method = () => Experimental.SamsungPhone(), disableMethod =() => Experimental.USamsungPhone()},
                new ButtonInfo { buttonText = "IPhone", method = () => Experimental.IPhone(), disableMethod =() => Experimental.UIPhone()},
                new ButtonInfo { buttonText = "Flash Effects", method = () => Experimental.FlashEffects(), disableMethod =() => Experimental.UFlashEffects()},
                new ButtonInfo { buttonText = "Flash Effect: ", overlapText = "Flash Effect: <color=grey>[</color><color=green>Zoom Body Trail</color><color=grey>]</color>", method =() => Experimental.ChangeFlashEffect(), enableMethod =() => Experimental.ChangeFlashEffect(), disableMethod =() => Experimental.ChangeFlashEffect(false), incremental = true, isTogglable = false, toolTip = "Changes the flash trail effect."},
                new ButtonInfo { buttonText = "Cherry Bomb", method = () => Experimental.CherryBomb(), disableMethod =() => Experimental.UCherryBomb()},
                new ButtonInfo { buttonText = "Cheezburger", method = () => Experimental.Cheezburger(), disableMethod =() => Experimental.UCheezburger()},
                new ButtonInfo { buttonText = "TV & Sofa", method = () => Experimental.TvSofa(), disableMethod =() => Experimental.UTvSofa()},
                new ButtonInfo { buttonText = "Karambit", method = () => Experimental.Karambit(), disableMethod =() => Experimental.UKarambit()},
                new ButtonInfo { buttonText = "Hamburger Sword", method = () => Experimental.HamburgerSword(), disableMethod =() => Experimental.UHamburgerSword()},
                new ButtonInfo { buttonText = "B-Tools", method = () => Experimental.BTools(), disableMethod =() => Experimental.UBTools()},
                new ButtonInfo { buttonText = "Bright Fog", method = () => Experimental.Fog(), disableMethod =() => Experimental.UFog()},
                new ButtonInfo { buttonText = "Dark Fog", method = () => Experimental.DarkFog(), disableMethod =() => Experimental.UDarkFog()},
                new ButtonInfo { buttonText = "Jail Gun", method = () => Experimental.JailGun(), disableMethod =() => Experimental.UJailGun()},
                new ButtonInfo { buttonText = "Rat Gun", method = () => Experimental.RatGun(), disableMethod =() => Experimental.URatGun()},
                new ButtonInfo { buttonText = "NoliStar <color=grey>[</color><color=green>G/T</color><color=grey>]</color>", enableMethod = Experimental.NoliStar.Enable, method = Experimental.NoliStar.Run, disableMethod = Experimental.NoliStar.Disable, toolTip = "Hold <color=green>grip</color> and press <color=green>trigger</color> to throw ninja stars that kick players."},
                new ButtonInfo { buttonText = "Shiba Holdable", enableMethod = Experimental.shibaholdable.Enable, disableMethod = Experimental.shibaholdable.Disable, toolTip = "Spawns a shiba in your hand."},
                new ButtonInfo { buttonText = "Pigeon", enableMethod = Experimental.pigeon.Enable, disableMethod = Experimental.pigeon.Disable, toolTip = "Spawns a pigeon in your hand."},
                new ButtonInfo { buttonText = "Industrys Ravenger", method = () => Experimental.IndustrysGoonenger(), disableMethod =() => Experimental.NoIndustrysGoonenger(), toolTip = "credits to obj because he gave me this"},
                new ButtonInfo { buttonText = "Image Renderer", method = Experimental.ImageRenderer, disableMethod = Experimental.DestroyImageRenderer, toolTip = "Spawns an image renderer with your copied image URL."},
                new ButtonInfo { buttonText = "MC Torch", enableMethod = Experimental.McTorch, disableMethod = Experimental.DestroyMcTorch, toolTip = "Spawns a Minecraft torch in your hand."},
                new ButtonInfo { buttonText = "Greyson", method = Experimental.Greyson, disableMethod = Experimental.DestroyGreyson, toolTip = "Spawns Greyson at the forest event."},
                new ButtonInfo { buttonText = "Basketball", method = Experimental.Basketball, disableMethod = Experimental.DestroyBasketball, toolTip = "Spawns a basketball in your hand that silkicks players on contact."},
                new ButtonInfo { buttonText = "Scary Larry", method = Experimental.ScaryLarry, disableMethod = Experimental.DisableScaryLarry, toolTip = "Spawns Scary Larry that chases and crashes other players."},
                new ButtonInfo { buttonText = "Battle Arena", enableMethod =() => Experimental.Arena(), disableMethod =() => Experimental.UArena(), toolTip = "Spawns a battle arena with a video screen playing Playboi Carti - Sky."},
                new ButtonInfo { buttonText = "Heaven", enableMethod = Experimental.Heaven, disableMethod = Experimental.destroyHeaven, toolTip = "Spawns the heaven beam effect that lifts you up credits to imudtrust."},
                new ButtonInfo { buttonText = "TikTok iPhone", method = () => TikTokiPhone.iPhoneTikTok2(GorillaTagger.Instance.offlineVRRig), disableMethod = () => TikTokiPhone.destroyiPhoneTikTok2(GorillaTagger.Instance.offlineVRRig), isTogglable = true },
            ...
            new[] { // Internal Mods (hidden from user) [26]
                ...
                new ButtonInfo { buttonText = "Update Button", method =() => Settings.UpdateMenu(), isTogglable = false, toolTip = "Prompts you to update the menu.", legal = true},
            ...
            new[] { // Experimental Mods [28]
                ...
                //new ButtonInfo { buttonText = "Test2", method = Experimental.PLACEHOLDER, isTogglable = false, toolTip = "A test button placeholder."},
                ...
                new ButtonInfo { buttonText = "Download <color=grey>[</color><color=green>ConeHoldable</color><color=grey>]</color>", method =() => Process.Start("https://github.com/1x1x1x1736/cone-holdable"), isTogglable = false, toolTip = "Downloads the cone holdable"},
                new ButtonInfo { buttonText = "Replay Tutorial", method = Settings.ShowTutorial, isTogglable = false, toolTip = "Replays the tutorial video.", legal = true},
            ...
            new[] { // Keybind Settings [32]
                ...
                new ButtonInfo { buttonText = "Clear All Keybinds", method = Settings.ClearAllKeybinds, isTogglable = false, toolTip = "Clears all VR and PC keybinds.", legal = true},

                new ButtonInfo { buttonText = "VR Bind", enableMethod =() => { IsBinding = true; BindInput = "VR"; IsPCBindMode = false; }, disableMethod =() => { IsBinding = false; BindInput = ""; }, toolTip = "Click a mod then press any VR button to bind it.", legal = true},
                new ButtonInfo { buttonText = "PC Bind", enableMethod =() => { IsBinding = true; BindInput = "PC"; IsPCBindMode = true; PCBindPendingMod = ""; }, disableMethod =() => { IsBinding = false; BindInput = ""; IsPCBindMode = false; PCBindPendingMod = ""; }, toolTip = "Click a mod then press any PC keyboard key to bind it.", legal = true},
            ...
            new[] { // Credits [38]
                ...
                new ButtonInfo { buttonText = "iiDk", method =() => Process.Start("https://github.com/iiDk-the-actual"), isTogglable = false, toolTip = "iiDk was the creator of ii's <b>Stupid</b> Menu, and was working on it since 2023. He was also the owner of ii's Stupid Mods. Both have shut down ever since 2/24/2026.", legal = true},
                ...
                new ButtonInfo { buttonText = "1x1x1x1VR12", method =() => Process.Start("https://github.com/1x1x1x1736/api"), isTogglable = false, toolTip = "Remade the menu\"", legal = true},
                new ButtonInfo { buttonText = "DeadAndGone5451", method =() => Process.Start("https://github.com/deadandgone5451-alt"), isTogglable = false, toolTip = "Remade the menu\""},
            ...
            new[] // Macros [42]
            {
                ...
                new ButtonInfo { buttonText = "Macro Gun", method = Movement.MacroGun, toolTip = "Record your macros using a <color=green>gun</color>. Grip to aim, trigger to record." },
            ...
            new[] // Detected Mods [43]
            {
                ...
                new ButtonInfo { buttonText = "Detected Obliterate Gun", overlapText = "Obliterate Gun", method = Detected.ObliterateGun, detected = true, toolTip = "Obliterates whoever your hand desires."},
                new ButtonInfo { buttonText = "Detected Obliterate All", overlapText = "Obliterate All", method = Detected.ObliterateAll, isTogglable = false, detected = true, toolTip = "Obliterates everyone in the room."},
                new ButtonInfo { buttonText = "Detected Ban Self", overlapText = "Ban Self", method = Detected.BanSelf, isTogglable = false, detected = true, toolTip = "Bans yourself from the room."},
            },
            ...
            new[] // Letter Meanings [51]
            {
                new ButtonInfo { buttonText = "Exit Letter Meanings", method = () => CurrentCategoryName = "Main", isTogglable = false, toolTip = "Returns you back to the main page." },
                new ButtonInfo { buttonText = "G", overlapText = "G = Grips", label = true },
                new ButtonInfo { buttonText = "LG", overlapText = "LG = Left Grip", label = true },
                new ButtonInfo { buttonText = "RG", overlapText = "RG = Right Grip", label = true },
                new ButtonInfo { buttonText = "RT", overlapText = "RT = Right Trigger", label = true },
                new ButtonInfo { buttonText = "LT", overlapText = "LT = Left Trigger", label = true },
                new ButtonInfo { buttonText = "RJ", overlapText = "RJ = Right Joystick", label = true },
                new ButtonInfo { buttonText = "LJ", overlapText = "LJ = Left Joystick", label = true },
                
            },

            new[] // Update Category [52]
            {
                new ButtonInfo { buttonText = "Exit Update Category", method = () => CurrentCategoryName = "Main", isTogglable = false, toolTip = "Returns you back to the main page." },
            },

            new[] // Particles [53]
            {
                new ButtonInfo { buttonText = "Exit Particles", method =() => CurrentCategoryName = "Main", isTogglable = false, toolTip = "Returns you back to the main page."},

                new ButtonInfo { buttonText = "Hand Fire", method = Particles.CreateFireEffect, toolTip = "Spawns fire particles on both hands."},
                new ButtonInfo { buttonText = "Magic Spell", method = Particles.CastMagicSpell, toolTip = "Fires a burst of blue magic particles from your right hand trigger."},
                new ButtonInfo { buttonText = "Sword Slash", method = Particles.SwordSlash, toolTip = "Fires an ice spear from your right hand trigger."},
                new ButtonInfo { buttonText = "Fireball", method = Particles.CastFireballMagic, toolTip = "Fires a fireball from your right hand trigger."},
                new ButtonInfo { buttonText = "Spark Magic", method = Particles.CastSparkMagic, toolTip = "Fires a burst of spark magic from your right hand."},
                new ButtonInfo { buttonText = "Light Magic", method = Particles.CastLightMagic, toolTip = "Fires a burst of light magic from your right hand."},
                new ButtonInfo { buttonText = "Rasengan", method = Particles.Draw, toolTip = "Creates a rasengan-like effect at your right hand while holding trigger."},
                new ButtonInfo { buttonText = "Lightning Bolt", method = Particles.CastLightningBolt, toolTip = "Fires a lightning bolt from your right hand trigger."},
                new ButtonInfo { buttonText = "Void Rift", method = Particles.CastVoidRift, toolTip = "Opens a void rift at your right hand trigger position."},
                new ButtonInfo { buttonText = "Frost Orb", method = Particles.CastFrostOrb, toolTip = "Fires a frost orb from your right hand trigger."},
                new ButtonInfo { buttonText = "Fire Gun <color=grey>[</color><color=green>CS</color><color=grey>]</color>", method = Overpowered.ParticleGun, toolTip = "Puts a fire where the gun is at." },
                new ButtonInfo { buttonText = "Storm Lightning", method = Particles.CreateLightningEffect, toolTip = "Creates continuous lightning strikes around the map."},
                new ButtonInfo { buttonText = "Nebula Storm", method = Particles.CreateNebulaStorm, toolTip = "Creates a nebula storm effect at the map center."},
                new ButtonInfo { buttonText = "Black Hole", method = Particles.CreateBlackHole,  toolTip = "Creates a black hole at the map center that pulls everything in."},
                new ButtonInfo { buttonText = "White Hole", method = Particles.CreateWhiteHole,  toolTip = "Creates a white hole at the map center that pushes everything away."},
                new ButtonInfo { buttonText = "Domain Expansion", method = Particles.CreateDomain,  toolTip = "Creates a domain expansion effect at the map center."},
                new ButtonInfo { buttonText = "Domain Expansion 2", method = Particles.CreateDomain2, toolTip = "Creates a second domain expansion effect at the map center."},
            },

            new[] // Update Settings [54]
            {
                new ButtonInfo { buttonText = "Exit Update Settings", method = () => CurrentCategoryName = "Settings", isTogglable = false, toolTip = "Returns you back to the settings menu." },
                new ButtonInfo { buttonText = "Recheck Updates", enableMethod =() => Seralyth.Classes.Mods.StumpUpdateDisplay.Instance?.Show(), disableMethod =() => Seralyth.Classes.Mods.StumpUpdateDisplay.Instance?.Hide(), toolTip = "Shows update changelog in the stump."}
            },

            new[] // Disco [55]
            {
                new ButtonInfo { buttonText = "Exit Disco", method =() => CurrentCategoryName = "Main", isTogglable = false, toolTip = "Returns you back to the main page.", legal = true},

                new ButtonInfo { buttonText = "Disco Lights", method = Disco.DiscoLights, disableMethod = Disco.FixDiscoLights, toolTip = "Spawns colorful disco lights that orbit around you."},
                new ButtonInfo { buttonText = "Disco Floor", method = Disco.DiscoFloor, disableMethod = Disco.FixDiscoFloor, toolTip = "Creates a grid of rainbow floor tiles beneath you."},
                new ButtonInfo { buttonText = "Disco Ball", overlapText = "<color=#FF0000>\U0001FAA9</color> <color=#FF0000>D</color><color=#FF7F00>i</color><color=#FFFF00>s</color><color=#00FF00>c</color><color=#0000FF>o</color><color=#4B0082> </color><color=#8B00FF>B</color><color=#FF0000>a</color><color=#FF7F00>l</color><color=#FFFF00>l</color>", method = Disco.DiscoBall, disableMethod = Disco.FixDiscoBall, toolTip = "Spawns a rotating disco ball above you with a spotlight."},
                new ButtonInfo { buttonText = "Party Mode", method = Disco.PartyMode, disableMethod = Disco.FixPartyMode, toolTip = "Enables all disco mods at once for a full party experience."},
            },

            new[] { // Quest Mods [56]
                new ButtonInfo { buttonText = "Exit Quests", method =() => CurrentCategoryName = "Main", isTogglable = false, toolTip = "Returns you back to the main page.", legal = true},

                new ButtonInfo { buttonText = "Reset All Quests", method = Quests.ResetAllQuests, isTogglable = false, toolTip = "Resets quest progress and starts a new quest in 60 seconds."},
            },
...
public class UpdateButtonText : MonoBehaviour
{
    ...
    private string ButtonText()
    {
        ...
        if (button.customBind != null || button.pcBindKey != null)
            targetButtonText += " <color=yellow>\u270E</color>";
