...
namespace Seralyth.Mods
{
    public static class Fun
    {
        ...
        {
            if (Time.time < emoteTimer) return;
        ...
        {
            if (Time.time < touchFlingCooldown) return;

            if (GetGunInput(false))
            {
                var GunData = RenderGun();
                if (GetGunInput(true) && !touchFlingTriggered)
                {
                    VRRig rig = GunData.Ray.collider?.GetComponentInParent<VRRig>();
                    if (rig != null && !rig.IsLocal())
                    {
                        Vector3 flingDir = (rig.transform.position - VRRig.LocalRig.transform.position).normalized + Vector3.up * 3f;
                        rig.GetNetView().SendRPC("GrabbedByPlayer", GetPlayerFromVRRig(rig), true, false, false);
                        rig.GetNetView().SendRPC("DroppedByPlayer", GetPlayerFromVRRig(rig), flingDir * 25f);
                        RPCProtection();
                        touchFlingCooldown = Time.time + 0.3f;
                    }
                }
                touchFlingTriggered = GetGunInput(true);
            }

            Vector3 handPos = GorillaTagger.Instance.rightHandTransform.position;
            Collider[] hits = Physics.OverlapSphere(handPos, 0.3f);

            foreach (var hit2 in hits)
            {
                VRRig rig = hit2.GetComponentInParent<VRRig>();
                if (rig != null && !rig.IsLocal())
                {
                    Vector3 dir = (rig.transform.position - VRRig.LocalRig.transform.position).normalized + Vector3.up * 3f;
                    rig.GetNetView().SendRPC("GrabbedByPlayer", GetPlayerFromVRRig(rig), true, false, false);
                    rig.GetNetView().SendRPC("DroppedByPlayer", GetPlayerFromVRRig(rig), dir * 25f);
                    RPCProtection();
                    touchFlingCooldown = Time.time + 0.3f;
                    return;
                }
            ...
            Collider[] leftHits = Physics.OverlapSphere(leftPos, 0.3f);

            foreach (var hit3 in leftHits)
            {
                VRRig rig = hit3.GetComponentInParent<VRRig>();
                if (rig != null && !rig.IsLocal())
                {
                    Vector3 dir = (rig.transform.position - VRRig.LocalRig.transform.position).normalized + Vector3.up * 3f;
                    rig.GetNetView().SendRPC("GrabbedByPlayer", GetPlayerFromVRRig(rig), true, false, false);
        ...
        public static void RainbowTrail()
        {
            ...
            trailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        {
            if (redTrailObject == null)
            {
                redTrailObject = new GameObject("Seralyth_RedTrail");
                TrailRenderer tr = redTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            redTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        {
            if (blueTrailObject == null)
            {
                blueTrailObject = new GameObject("Seralyth_BlueTrail");
                TrailRenderer tr = blueTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            blueTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixBlueTrail()
        {
            if (blueTrailObject != null)
            {
                Object.Destroy(blueTrailObject);
        ...
        {
            if (greenTrailObject == null)
            {
                greenTrailObject = new GameObject("Seralyth_GreenTrail");
                TrailRenderer tr = greenTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            greenTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixGreenTrail()
        {
            if (greenTrailObject != null)
            {
                Object.Destroy(greenTrailObject);
        ...
        {
            if (yellowTrailObject == null)
            {
                yellowTrailObject = new GameObject("Seralyth_YellowTrail");
                TrailRenderer tr = yellowTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            yellowTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixYellowTrail()
        {
            if (yellowTrailObject != null)
            {
                Object.Destroy(yellowTrailObject);
        ...
        {
            if (purpleTrailObject == null)
            {
                purpleTrailObject = new GameObject("Seralyth_PurpleTrail");
                TrailRenderer tr = purpleTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            purpleTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixPurpleTrail()
        {
            if (purpleTrailObject != null)
            {
                Object.Destroy(purpleTrailObject);
        ...
        {
            if (orangeTrailObject == null)
            {
                orangeTrailObject = new GameObject("Seralyth_OrangeTrail");
                TrailRenderer tr = orangeTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            orangeTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixOrangeTrail()
        {
            if (orangeTrailObject != null)
            {
                Object.Destroy(orangeTrailObject);
        ...
        {
            if (pinkTrailObject == null)
            {
                pinkTrailObject = new GameObject("Seralyth_PinkTrail");
                TrailRenderer tr = pinkTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            pinkTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixPinkTrail()
        {
            if (pinkTrailObject != null)
            {
                Object.Destroy(pinkTrailObject);
        ...
        {
            if (cyanTrailObject == null)
            {
                cyanTrailObject = new GameObject("Seralyth_CyanTrail");
                TrailRenderer tr = cyanTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            cyanTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixCyanTrail()
        {
            if (cyanTrailObject != null)
            {
                Object.Destroy(cyanTrailObject);
        ...
        {
            if (whiteTrailObject == null)
            {
                whiteTrailObject = new GameObject("Seralyth_WhiteTrail");
                TrailRenderer tr = whiteTrailObject.AddComponent<TrailRenderer>();
                tr.time = 1.5f;
                tr.startWidth = 0.15f;
                tr.endWidth = 0f;
                tr.material = new Material(Shader.Find("Sprites/Default"));
            ...
            whiteTrailObject.transform.position = GorillaTagger.Instance.bodyCollider.transform.position;
        }
        ...
        public static void FixWhiteTrail()
        {
            if (whiteTrailObject != null)
            {
                Object.Destroy(whiteTrailObject);
        ...
        public static void Orbitz()
        {
            if (orbitzSpheres == null)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    sphere.name = "Seralyth_Orbitz";
                    sphere.transform.localScale = Vector3.one * (0.1f + i * 0.03f);
                    Object.Destroy(sphere.GetComponent<Collider>());
                    orbitzSpheres.Add(sphere);
                }
            }

            float hue = Time.time * 0.08f % 1f;
            Vector3 pos = GorillaTagger.Instance.headCollider.transform.position;
            for (int i = 0; i < orbitzSpheres.Count; i++)
            {
                float angle = Time.time * (50f + i * 25f) + i * 1.047f;
                float height = Mathf.Sin(Time.time * (0.8f + i * 0.2f) + i) * 0.6f;
                float radius = 0.7f + i * 0.12f;
                orbitzSpheres[i].transform.position = pos + new Vector3(Mathf.Sin(angle * Mathf.Deg2Rad) * radius,
                    height, Mathf.Cos(angle * Mathf.Deg2Rad) * radius);
                orbitzSpheres[i].GetComponent<Renderer>().material.color =
                    Color.HSVToRGB((hue + i * 0.15f) % 1f, 1f, 1f);
            }
        }
        ...
        public static void FixOrbitz()
        {
            if (orbitzSpheres != null)
            {
                foreach (var s in orbitzSpheres)
                    Object.Destroy(s);
                orbitzSpheres = null;
            }
        }
        ...
        public static void OrbitzV2()
        {
            if (orbitzV2Spheres == null)
            {
                ...
                {
                    var sphere = GameObject.CreatePrimitive(PrimitiveType.Sphere);
                    sphere.name = "Seralyth_OrbitzV2";
                    sphere.transform.localScale = Vector3.one * (0.1f + i * 0.03f);
                    Object.Destroy(sphere.GetComponent<Collider>());
                    orbitzV2Spheres.Add(sphere);
                }
            }

            float hue = Time.time * 0.08f % 1f;
            Vector3 pos = GorillaTagger.Instance.headCollider.transform.position;
            for (int i = 0; i < orbitzV2Spheres.Count; i++)
            {
                float angle = Time.time * (50f + i * 25f) + i * 1.047f;
                float height = Mathf.Sin(Time.time * (0.8f + i * 0.2f) + i) * 0.6f;
                float radius = 0.7f + i * 0.12f;
                orbitzV2Spheres[i].transform.position = pos + new Vector3(Mathf.Sin(angle * Mathf.Deg2Rad) * radius,
                    height, Mathf.Cos(angle * Mathf.Deg2Rad) * radius);
                orbitzV2Spheres[i].GetComponent<Renderer>().material.color =
                    Color.HSVToRGB((hue + i * 0.15f) % 1f, 1f, 1f);
            }
        }
        ...
        public static void FixOrbitzV2()
        {
            if (orbitzV2Spheres != null)
            {
                foreach (var s in orbitzV2Spheres)
                    Object.Destroy(s);
        ...
        public static void OrbitzCubes()
        {
            if (orbitzCubes == null)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    cube.name = "Seralyth_OrbitzCubes";
                    cube.transform.localScale = Vector3.one * (0.1f + i * 0.03f);
                    Object.Destroy(cube.GetComponent<Collider>());
                    orbitzCubes.Add(cube);
                }
            }

            float hue = Time.time * 0.08f % 1f;
            Vector3 pos = GorillaTagger.Instance.headCollider.transform.position;
            for (int i = 0; i < orbitzCubes.Count; i++)
            {
                float angle = Time.time * (50f + i * 25f) + i * 1.047f;
                float height = Mathf.Sin(Time.time * (0.8f + i * 0.2f) + i) * 0.6f;
                float radius = 0.7f + i * 0.12f;
                orbitzCubes[i].transform.position = pos + new Vector3(Mathf.Sin(angle * Mathf.Deg2Rad) * radius, height,
                    Mathf.Cos(angle * Mathf.Deg2Rad) * radius);
                orbitzCubes[i].GetComponent<Renderer>().material.color = Color.HSVToRGB((hue + i * 0.15f) % 1f, 1f, 1f);
            }
        }
        ...
        public static void OrbitzCubesV2()
        {
            if (orbitzCubesV2 == null)
            {
                ...
                {
                    var cube = GameObject.CreatePrimitive(PrimitiveType.Cube);
                    cube.name = "Seralyth_OrbitzCubesV2";
                    cube.transform.localScale = Vector3.one * (0.1f + i * 0.03f);
                    Object.Destroy(cube.GetComponent<Collider>());
                    orbitzCubesV2.Add(cube);
                }
            }

            float hue = Time.time * 0.08f % 1f;
            Vector3 pos = GorillaTagger.Instance.headCollider.transform.position;
            for (int i = 0; i < orbitzCubesV2.Count; i++)
            {
                float angle = Time.time * (50f + i * 25f) + i * 1.047f;
                float height = Mathf.Sin(Time.time * (0.8f + i * 0.2f) + i) * 0.6f;
                float radius = 0.7f + i * 0.12f;
                orbitzCubesV2[i].transform.position = pos + new Vector3(Mathf.Sin(angle * Mathf.Deg2Rad) * radius,
                    height, Mathf.Cos(angle * Mathf.Deg2Rad) * radius);
                orbitzCubesV2[i].GetComponent<Renderer>().material.color =
                    Color.HSVToRGB((hue + i * 0.15f) % 1f, 1f, 1f);
            }
        }
        ...
        public static void FixOrbitzCubesV2()
        {
            if (orbitzCubesV2 != null)
            {
                foreach (var c in orbitzCubesV2)
                    Object.Destroy(c);
                orbitzCubesV2 = null;
            }
        }
        ...
        public static void HeadBang()
        {
            if (Time.time > lastBangTime)
            {
                ...
                VRRig.LocalRig.head.trackingRotationOffset.x =
                    Mathf.Lerp(VRRig.LocalRig.head.trackingRotationOffset.x, 0f, 0.1f);
        }
        ...
        public static void ChangeSoundboardVolume(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Soundboard Volume").overlapText =
                "Change Default Soundboard Volume <color=grey>[</color><color=green>" + soundboardVolumeIndex +
        ...
        public static void ChangeSoundboardSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Soundboard Speed").overlapText =
                "Change Default Soundboard Speed <color=grey>[</color><color=green>" + soundboardSpeedIndex +
                "</color><color=grey>]</color>";
        }
        ...
        public static void ChangeHeadSpinSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Head Spin Speed").overlapText =
                "Change Head Spin Speed <color=grey>[</color><color=green>" + speedNames[headSpinIndex] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void SpinHead(string axis)
        {
            ...
            else
            {
                ...
                {
                    case "x":
                        VRRig.LocalRig.head.rigTarget.transform.rotation = Quaternion.Euler(
                            VRRig.LocalRig.head.rigTarget.transform.rotation.eulerAngles +
                            new Vector3(headSpinSpeed, 0f, 0f));
                        break;
                    case "y":
                        VRRig.LocalRig.head.rigTarget.transform.rotation = Quaternion.Euler(
                            VRRig.LocalRig.head.rigTarget.transform.rotation.eulerAngles +
                            new Vector3(0f, headSpinSpeed, 0f));
                        break;
                    case "z":
                        VRRig.LocalRig.head.rigTarget.transform.rotation = Quaternion.Euler(
                            VRRig.LocalRig.head.rigTarget.transform.rotation.eulerAngles +
                            new Vector3(0f, 0f, headSpinSpeed));
                        break;
                    default:
                        return;
                }
        ...
        public static void InstantParty()
        {
            if (Time.time > instantPartyDelay)
            {
                ...
                if (provisionalMembers.Count > 0)
                {
                    ...
                    members.AddRange(from player in PhotonNetwork.PlayerListOthers
                        where FriendshipGroupDetection.Instance.IsInMyGroup(player.UserId) ||
                              provisionalMembers.Contains(player.ActorNumber)
                        select player.ActorNumber);
                    FriendshipGroupDetection.Instance.SendPartyFormedRPC(
                        FriendshipGroupDetection.PackColor(targetColor), members.ToArray(), false);
                    RPCProtection();
                }
            }
        }
        ...
        public static void BetaWaterSplash(Vector3 splashPosition, Quaternion splashRotation, float splashScale,
            float boundingRadius, bool bigSplash, bool enteringWater, object general = null)
        {
            ...
            try
            {
                switch (general)
                {
                    case NetPlayer player:
                        GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlaySplashEffect", NetPlayerToPlayer(player),
                            parameters);
                        break;
                    case RpcTarget target:
                    {
                        ...
                        {
                            ObjectPools.instance.Instantiate(GTPlayer.Instance.waterParams.rippleEffect, splashPosition,
                                splashRotation, GTPlayer.Instance.waterParams.rippleEffectScale * boundingRadius * 2f);
                            ObjectPools.instance
                                .Instantiate(GTPlayer.Instance.waterParams.splashEffect, splashPosition, splashRotation,
                                    splashScale).GetComponent<WaterSplashEffect>()
                    ...
                    case int[] targets:
                    {
                        ...
                        VRRig.LocalRig.GetPhotonView().RPC("RPC_PlaySplashEffect",
                            new RaiseEventOptions { TargetActors = targets }, parameters);
                        break;
                    }
                }
            }
            ...
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    if (lockTarget.rightMiddle.calcT > 0.5f || lockTarget.leftMiddle.calcT > 0.5f)
                    {
                        ...
                        {
                            Vector3 splashPosition = lockTarget.rightMiddle.calcT > 0.5f
                                ? lockTarget.rightHandTransform.position
                                : lockTarget.leftHandTransform.position;
                            Quaternion splashRotation = lockTarget.rightMiddle.calcT > 0.5f
                                ? lockTarget.rightHandTransform.rotation
                                : lockTarget.leftHandTransform.rotation;
        ...
        public static void WaterSplashAura()
        {
            if (Time.time > splashDel)
            {
                BetaWaterSplash(VRRig.LocalRig.transform.position + RandomVector3(2f), RandomQuaternion(), 4f, 100f,
                    true, false);
                splashDel = Time.time + 0.1f;
            }
        }
        ...
        public static void OrbitWaterSplash()
        {
            if (Time.time > splashDel)
            {
                BetaWaterSplash(
                    ...
                    RandomQuaternion(), 4f, 100f, true, false);
                splashDel = Time.time + 0.1f;
            }
        }
        ...
        public static void WaterSplashWalk()
        {
            if (Time.time > splashDel)
            {
                if (GTPlayer.Instance.IsHandTouching(true))
                {
                    ...
                    BetaWaterSplash(GorillaTagger.Instance.leftHandTransform.position, Quaternion.Euler(ray.normal), 4f,
                        100f, true, false);
                    splashDel = Time.time + 0.1f;
                }
        ...
        public static void WaterSplashOnTouch()
        {
            foreach (VRRig rig in VRRigExtensions.ActiveRigs)
                if (!rig.IsLocal() && rig.IsBeingTouched())
                    BetaWaterSplash(rig.head.rigTarget.position, RandomQuaternion(), 4f, 100f, true, false);
        }
        ...
        public static void Boop(int sound = 84)
        {
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                if (!vrrig.isLocal)
                {
                    float D1 = Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position,
                        vrrig.headMesh.transform.position);
                    float D2 = Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position,
                        vrrig.headMesh.transform.position);
                        ...
                        if (Vector3.Distance(target.transform.position, keyboardTransform.position) < 3f)
                        {
                            ...
                            for (int i = 0; i < keyLogs.Count; i++)
                            {
                                ...
                                if ((VRRig)keyLog[0] == target)
                                {
                                    ...
                                    keyLogs[i][1] = closestKey.Contains("Delete")
                                        ? currentText.Length == 0 ? currentText : currentText[..^1]
                                        : currentText + closestKey;
            ...
            if (keyLogs.Count > 0)
            {
                foreach (var keylog in keyLogs.Where(keylog => Time.time > (float)keylog[2]).ToList())
                {
                    NotificationManager.SendNotification(
                        "<color=grey>[</color><color=purple>KEYLOGS</color><color=grey>]</color> " + (string)keylog[1],
                        5000);
        ...
        public static void PreloadTagSounds()
        {
            ...
            foreach (string sound in sounds)
                LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/TagSounds/{sound}.ogg",
                    $"Audio/Mods/Fun/TagSounds/{sound}.ogg");
        }
        ...
        public static void Freecam()
        {
            ...
            Vector3 velocity = inputDirection.x * playerRight + inputDirection.y * Vector3.up +
        ...
        public static void ThirdPersonCamera()
        {
            ...
            FreeCamObject.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.TransformPoint(new Vector3(0f, 0.5f, -1.5f));
            FreeCamObject.transform.rotation = GorillaTagger.Instance.headCollider.transform.rotation;
        }
        ...
        public static void Nausea()
        {
            ...
            FreeCamObject.transform.position = GorillaTagger.Instance.headCollider.transform.position;
            FreeCamObject.transform.rotation = GorillaTagger.Instance.headCollider.transform.rotation *
                                               Quaternion.Euler(Mathf.Sin(Time.time) * intensity,
                                                   Mathf.Cos(Time.time * 0.7f) * intensity,
                                                   Mathf.Sin(Time.time * 1.3f) * intensity);
        }
        ...
        {
            LoadTextureFromURL($"{PluginInfo.ServerResourcePath}/Images/Mods/Fun/jumpscare.png",
                "Images/Mods/Fun/jumpscare.png");
            LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/jumpscare.ogg",
                "Audio/Mods/Fun/jumpscare.ogg");
        }
        ...
        {
            LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/jumpscare.ogg",
                "Audio/Mods/Fun/jumpscare.ogg", clip => clip.Play());
            ...
            jumpscareObject.GetComponent<Renderer>().material.mainTexture = LoadTextureFromURL(
                $"{PluginInfo.ServerResourcePath}/Images/Mods/Fun/jumpscare.png", "Images/Mods/Fun/jumpscare.png");
        ...
        private static readonly string[] surpriseNarrations =
        {
            "boo",
            "turn around",
            "you asked for this",
        ...
        public static void SurpriseMe() =>
            CoroutineManager.instance.StartCoroutine(SurpriseMeCoroutine());
        ...
        private static IEnumerator SurpriseMeCoroutine()
        {
            switch (Random.Range(0, 6))
            {
                ...
                case 4:
                    for (int i = 0; i < 6; i++)
                    {
                        HueShift(i % 2 == 0 ? RandomColor() : Color.clear);
                ...
                default:
                    NarrateText(surpriseNarrations[Random.Range(0, surpriseNarrations.Length)]);
                    break;
            }
        }
        ...
        public static void SpectateGun()
        {
            if (GetGunInput(false))
            {
                if (gunLocked && lockTarget != null)
                {
                    ...
                    FreeCamObject.transform.position =
                        lockTarget.headMesh.transform.transform.TransformPoint(new Vector3(0f, 0.25f, 0.25f));
        ...
        public static void ChangeTargetFOV(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Target FOV").overlapText = "Change Target FOV <color=grey>[</color><color=green>" +
                                                                targetFOV + "</color><color=grey>]</color>";
        }
        ...
        public static void MuteGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > muteDelay)
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                        foreach (var line in GorillaScoreboardTotalUpdater.allScoreboardLines.Where(line =>
                                     line.linePlayer == GetPlayerFromVRRig(gunTarget)))
                        {
        ...
        {
            foreach (var line in
                     GorillaScoreboardTotalUpdater.allScoreboardLines.Where(line => line.muteButton.isAutoOn))
            {
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > muteDelay)
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                        ...
                        GorillaPlayerScoreboardLine.ReportPlayer(player.UserId,
                            GorillaPlayerLineButton.ButtonType.Cheating, player.NickName);
        ...
        public static void ReportAll()
        {
            foreach (NetPlayer player in NetworkSystem.Instance.PlayerListOthers)
                GorillaPlayerScoreboardLine.ReportPlayer(player.UserId, GorillaPlayerLineButton.ButtonType.Cheating,
                    player.NickName);
        }
        ...
        public static void TriggerAntiReportGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    try
                    {
                        foreach (var report in from line in GorillaScoreboardTotalUpdater.allScoreboardLines
                                 where line.linePlayer == GetPlayerFromVRRig(lockTarget) &&
                                       Vector3.Distance(line.reportButton.transform.position,
                                           GorillaTagger.Instance.bodyCollider.transform.position) < 50f
        ...
        public static void TriggerAntiReportAll()
        {
            ...
            try
            {
                ...
                foreach (var report in from line in GorillaScoreboardTotalUpdater.allScoreboardLines
                         where NetPlayerToPlayer(line.linePlayer) == triggerAntiReportTarget &&
                               Vector3.Distance(line.reportButton.transform.position,
                                   GorillaTagger.Instance.bodyCollider.transform.position) < 50f
                         select line.reportButton.gameObject.transform)
                {
            ...
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                try
                {
                    foreach (GorillaPlayerScoreboardLine line in GorillaScoreboardTotalUpdater.allScoreboardLines)
                    {
                        ...
                        float D1 = Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position,
                            report.position);
                ...
                if (GorillaTagger.Instance.myVRRig != null && isNearReportButton)
                {
                    ...
                    SendSerialize(VRRig.LocalRig.GetPhotonView(),
                        ...
                        {
                            TargetActors = PhotonNetwork.PlayerListOthers
                                .Where(player => !people.ToArray().Contains(player.ActorNumber))
                                .Select(player => player.ActorNumber).ToArray()
                        });
                    VRRig.LocalRig.leftHand.rigTarget.transform.position =
                        GorillaTagger.Instance.headCollider.transform.position -
                        (GorillaTagger.Instance.headCollider.transform.forward * 100f);
                    VRRig.LocalRig.rightHand.rigTarget.transform.position =
                        GorillaTagger.Instance.headCollider.transform.position -
                        (GorillaTagger.Instance.headCollider.transform.forward * 100f);

                    SendSerialize(VRRig.LocalRig.GetPhotonView(),
                        new RaiseEventOptions() { TargetActors = people.ToArray() });
        ...
        public static void CustomModSpoofer()
        {
            Prompt("Would you like to choose from a mod list or type the mod property?", () =>
            {
                List<ButtonInfo> modList = new List<ButtonInfo>
                {
                    new ButtonInfo
                    {
                        buttonText = "Exit Mod List", method = () => Buttons.CurrentCategoryName = "Main",
                        isTogglable = false, toolTip = "Returns you back to the main page."
                    }
                };
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    VRRig.LocalRig.transform.position = NewPointer.transform.position +
                                                        (Vector3.up * (Time.frameCount % 2 == 1 ? 10f : -10f));
                    SendSerialize(VRRig.LocalRig.GetPhotonView());

                    VRRig.LocalRig.transform.position = NewPointer.transform.position +
                                                        (Vector3.up * (Time.frameCount % 2 == 1 ? 10f : 0f));
                }
                else
                    VRRig.LocalRig.enabled = true;
            }
        ...
        public static void AutoStartMoles()
        {
            if (Time.time > moleMachineDelay)
            {
                ...
                foreach (WhackAMole moleMachine in GetAllType<WhackAMole>())
                {
                    if (moleMachine.currentState == WhackAMole.GameState.Off ||
                        moleMachine.currentState == WhackAMole.GameState.TimesUp)
                    {
                        moleMachine.GetView.RPC("WhackAMoleButtonPressed", RpcTarget.All);
                        RPCProtection();
                    }
        ...
        public static void ArcadeTeleporterEffectSpam()
        {
            if (Time.time > spamDelay)
            {
                ...
                GetObject(
                        "City_Pretty/CosmeticsScoreboardAnchor/Arcade_prefab/MainRoom/VRArea/ModIOArcadeTeleporter/NetObject_VRTeleporter")
                    .GetComponent<PhotonView>().RPC("ActivateTeleportVFX", RpcTarget.All, returnOrTeleport,
        ...
        public static void StumpTeleporterEffectSpam()
        {
            if (Time.time > spamDelay)
            {
                ...
                GetObject(
                        "Environment Objects/LocalObjects_Prefab/TreeRoom/StumpVRHeadset/VirtualStump_StumpTeleporter/NetObject_VRTeleporter")
                    .GetComponent<PhotonView>().RPC("ActivateTeleportVFX", RpcTarget.All, returnOrTeleport, (short)0);
                RPCProtection();
            }
        }
        ...
        public static void SetBasementDoorState(bool open)
        {
            if (Time.time > spamDelay)
            {
                ...
                GetObject("Environment Objects/LocalObjects_Prefab/CityToBasement/DungeonEntrance/DungeonDoor_Prefab")
                    .GetComponent<PhotonView>().RPC("ChangeDoorState", RpcTarget.AllViaServer,
                        open ? GTDoor.DoorState.Opening : GTDoor.DoorState.Closing);
                RPCProtection();
            }
        }
        ...
        public static void SetElevatorDoorState(bool open)
        {
            if (Time.time > spamDelay)
            {
                ...
                GRElevatorManager.ElevatorButtonPressed(open ? GRElevator.ButtonType.Open : GRElevator.ButtonType.Close,
        ...
        public static void BasementDoorSpam()
        {
            if (Time.time > spamDelay)
            {
                ...
                GetObject("Environment Objects/LocalObjects_Prefab/CityToBasement/DungeonEntrance/DungeonDoor_Prefab")
                    .GetComponent<PhotonView>().RPC("ChangeDoorState", RpcTarget.AllViaServer,
                        openOrClose ? GTDoor.DoorState.Opening : GTDoor.DoorState.Closing);
                RPCProtection();
            }
        }
        ...
        public static void ElevatorDoorSpam()
        {
            if (Time.time > spamDelay)
            {
                ...
                GRElevatorManager.ElevatorButtonPressed(
                    openOrClose ? GRElevator.ButtonType.Open : GRElevator.ButtonType.Close,
                    GRElevatorManager._instance.currentLocation);
                RPCProtection();
            }
        }
        ...
        public static void ChangeCustomQuestScore(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Custom Quest Score").overlapText =
                "Change Custom Quest Score <color=grey>[</color><color=green>" + targetQuestScore +
                "</color><color=grey>]</color>";
        }
        ...
        public static void GrabIDCard()
        {
            if (rightGrab)
            {
                foreach (var entity in GhostReactor.instance.employeeBadges.registeredBadges
                             .Select(grBadge => grBadge.gameEntity).Where(entity =>
                                 entity.onlyGrabActorNumber == PhotonNetwork.LocalPlayer.ActorNumber))
                {
                    VRRig.LocalRig.enabled = false;
                    VRRig.LocalRig.transform.position = entity.transform.position;

                    ManagerRegistry.GhostReactor.GameEntityManager.RequestGrabEntity(entity.id, false, Vector3.zero,
                        Quaternion.identity);
                }
            }
            else
        ...
        {
            bool prevGunHand = GunLib.rightGunHand;
            GunLib.rightGunHand = true;
            var data = GunLib.GunInstance();
            GunLib.rightGunHand = prevGunHand;
            if (data.IsGripping)
            {
                if (data.IsTriggered)
                {
                    if (gunLibCheckpoint == null)
                    {
                        gunLibCheckpoint = GameObject.CreatePrimitive(PrimitiveType.Sphere);
                        Object.Destroy(gunLibCheckpoint.GetComponent<SphereCollider>());
                    ...
                    gunLibCheckpoint.transform.position = data.HitPos + Vector3.up;
                    gunLibCheckpoint.GetComponent<Renderer>().material.color = Color.green;
                }
                else if (gunLibCheckpoint != null)
                    gunLibCheckpoint.GetComponent<Renderer>().material.color = Color.red;

                if (rightPrimary && !previousGunLibCheckpointPrimary && gunLibCheckpoint != null)
                {
                    Vector3 origin = GorillaTagger.Instance.bodyCollider.transform.position;
                    Vector3 target = gunLibCheckpoint.transform.position;
                    float distance = Vector3.Distance(origin, target);
                    Vector3 direction = (target - origin).normalized;
                    float speed = Mathf.Clamp(distance * 1.5f, 10f, 60f);
                    float arcHeight = Mathf.Clamp(distance * 0.15f, 1f, 10f);
                    GorillaTagger.Instance.rigidbody.linearVelocity = direction * speed + Vector3.up * arcHeight;
                }

                previousGunLibCheckpointPrimary = rightPrimary;
            }
            else
            {
                if (gunLibCheckpoint != null)
                    gunLibCheckpoint.GetComponent<Renderer>().material.color = backgroundColor.GetColor(0);
            }
        }
        ...
        public static void DisableGunLibCheckpoint()
        {
            if (gunLibCheckpoint != null)
            {
                Object.Destroy(gunLibCheckpoint);
        ...
        public static void GunLibFlingGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    Overpowered.FlingPlayer(lockTarget);
                }
        ...
        public static void GunLibFlingGunV2()
        {
            ...
            {
                GunLib.InitpObjs();
                GunLib.Default = backgroundColor.GetColor(0);
                GunLib.Selected = buttonColors[1].GetColor(0);
                gunLibFlingV2Initialized = true;
            }

            GunLib.GunInstance(false);

            if (GunLib.data.IsGripping && Time.time >= gunLibFlingV2Cooldown)
            {
                VRRig target = GunLib.data.Collider?.GetComponentInParent<VRRig>();
                if (target != null && !target.IsLocal())
                {
                    Vector3 flingDir = (target.transform.position - VRRig.LocalRig.transform.position).normalized + Vector3.up * 3f;
                    target.GetNetView().SendRPC("GrabbedByPlayer", GetPlayerFromVRRig(target), true, false, false);
                    target.GetNetView().SendRPC("DroppedByPlayer", GetPlayerFromVRRig(target), flingDir * 25f);
                    RPCProtection();
        ...
        public static void PurchaseAllToolStations()
        {
            ...
            {
                ManagerRegistry.GhostReactor.GhostReactorManager.ToolPurchaseStationRequest(
                    Random.Range(0,
                        ManagerRegistry.GhostReactor.GhostReactorManager.reactor.toolPurchasingStations.Count - 1),
        ...
        public static void Invincibility()
        {
            ...
            if (plr.State == GRPlayer.GRPlayerState.Ghost)
                ManagerRegistry.GhostReactor.GhostReactorManager.RequestPlayerStateChange(plr,
        ...
        public static void StartShift()
        {
            ...
            ManagerRegistry.GhostReactor.GhostReactorManager.RequestShiftStartAuthority(
                GhostReactor.instance.shiftManager.ShiftState ==
                GhostReactorShiftManager.State.WaitingForFirstShiftStart);
            RPCProtection();
        }
        ...
        public static void SetQuota()
        {
            ...
            GhostReactor.instance.shiftManager.shiftStats.SetShiftStat(GRShiftStatType.CoresCollected,
                GhostReactor.instance.shiftManager.coresRequiredToDelveDeeper);
            RPCProtection();
        }
        ...
        public static void GhostReactorFreezeGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                    Overpowered.CreateItem(lockTarget.GetPlayer(),
                        Overpowered.ObjectByName["GhostReactorEnergyCostGate"],
                        lockTarget.headMesh.transform.position + RandomVector3(), RandomQuaternion(), Vector3.zero,
                        Vector3.zero);
        ...
        public static void GhostReactorFreezeAll()
        {
            ...
            Overpowered.CreateItem(randomPlayer.GetPlayer(), Overpowered.ObjectByName["GhostReactorEnergyCostGate"],
                randomPlayer.headMesh.transform.position + RandomVector3(), RandomQuaternion(), Vector3.zero,
                Vector3.zero);
        }
        ...
        public static IEnumerator KillTarget(Player Target)
        {
            ...
            int netId = ManagerRegistry.GhostReactor.GameEntityManager.CreateTypeNetId(
                Overpowered.ObjectByName["GhostReactorEnemyChaserArmored"]);

            ManagerRegistry.GhostReactor.GameEntityManager.photonView.RPC("CreateItemRPC", Target, new[] { netId },
                new[] { (int)ManagerRegistry.GhostReactor.GameEntityManager.zone },
                new[] { Overpowered.ObjectByName["GhostReactorEnemyChaserArmored"] },
                new[] { BitPackUtils.PackWorldPosForNetwork(Rig.transform.position) },
                new[] { BitPackUtils.PackQuaternionForNetwork(Rig.transform.rotation) }, new[] { 0L }, new[] { 0 });

            ManagerRegistry.GhostReactor.GhostReactorManager.gameAgentManager.photonView.RPC("ApplyBehaviorRPC", Target,
                new[] { netId }, new byte[] { 6 });
        ...
        public static void SpazKillSelf()
        {
            if (Time.time > killDelay)
            {
                ...
                GRPlayer plr = GRPlayer.Get(PhotonNetwork.LocalPlayer.ActorNumber);
                SetPlayerState(PhotonNetwork.LocalPlayer,
                    plr.State == GRPlayer.GRPlayerState.Alive
        ...
        public static void SpazToolStations()
        {
            if (Time.time > purchaseDelay)
            {
                ManagerRegistry.GhostReactor.GhostReactorManager.ToolPurchaseStationRequest(
                    Random.Range(0,
                        ManagerRegistry.GhostReactor.GhostReactorManager.reactor.toolPurchasingStations.Count - 1),
                    (GhostReactorManager.ToolPurchaseStationAction)Random.Range(0, 2));
                purchaseDelay = Time.time + 0.1f;
            }
        }
        ...
        public static void EchoMicrophone(bool status)
        {
            ...
            {
                NotificationManager.SendNotification(
                    "<color=grey>[</color><color=red>ERROR</color><color=grey>]</color> You are using Legacy Microphone. This mod does not support using the old microphone system.");
        ...
        public static void SetDebugEchoMode(bool value)
        {
            ...
            if (NetworkSystem.Instance.VoiceConnection.PrimaryRecorder != null &&
                NetworkSystem.Instance.VoiceConnection.PrimaryRecorder.IsRecording)
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                        if (RecorderPatch.enabled)
                        {
                            ...
                            SpeakerPatch.targetSpeaker =
                                lockTarget.gameObject.GetComponent<GorillaSpeakerLoudness>().speaker;
                            if (!VoiceManager.Get().PostProcessors
                                    .ContainsKey("CopyVoice")) // this is so shit but i need to account for channels > 1
                            {
                                float readPos = 0f;
                                ...
                                VoiceManager.Get().PostProcessors["CopyVoice"] = buffer =>
                                {
                                    ...
                                    float sourceRate = (SpeakerPatch.targetSpeaker != null &&
                                    ...
                                    lock (SpeakerPatch.locked)
                                    {
                                        ...
                                        for (int i = 0; i < buffer.Length; i += channels)
                                        {
                                            ...
                                            if (idxB < SpeakerPatch.SampleQueue.Count)
                                            {
                                                ...
                                                float sample = Mathf.Lerp(SpeakerPatch.SampleQueue[idxA],
                                                    SpeakerPatch.SampleQueue[idxB], t);
                                        ...
                                        if (consumed > 0)
                                        {
                                            SpeakerPatch.SampleQueue.RemoveRange(0,
                                                Math.Min(consumed, SpeakerPatch.SampleQueue.Count));
                                            readPos -= consumed;
                                        }
                                    }
                                    }
                        ...
                        else
                        {
                            if (Time.time > copyVoiceGunDelay)
                            {
                                ...
                                NetworkSystem.Instance.VoiceConnection.PrimaryRecorder.SourceType =
        ...
        public static void SaveNarration(string text)
        {
            ...
            CoroutineManager.instance.StartCoroutine(TranscribeText(text,
                (audio) => { PromptSingleText("The narration has been saved in your Soundboard!"); }, text, path));
        }
        ...
        public static void MaskVoice()
        {
            ...
            drec.DictationComplete += (completionCause) => { drec.Start(); };
            drec.DictationError += (error, hresult) =>
            {
                ...
                if (error.Contains("Dictation support is not enabled on this device"))
                {
                    DisableMaskVoice();
                    NotificationManager.SendNotification(
                        $"<color=grey>[</color><color=red>ERROR</color><color=grey>]</color> Online Speech Recognition is not enabled on this device. Either open the menu to enable it, or check your internet connection.",
                        3000);
                    Prompt(
                        "Online Speech Recognition is not enabled on your device. Would you like to open the Settings page to enable it?",
                        () =>
                        {
                            Process.Start("ms-settings:privacy-speech");
                            PromptSingle("Once you enable Online Speech Recognition, turn this mod back on!",
                                () => mod.enabled = false);
                        },
                        () => PromptSingle(
                            "You will not be able to use this mod until you enable Online Speech Recognition.",
                            () => mod.enabled = false));
                }
            };
        ...
        public static void BetaDropBoard(Vector3 position, Quaternion rotation, Vector3 velocity, Vector3 avelocity,
            Color boardColor)
        {
        ...
        public static void HoverboardGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > hoverboardGunDelay)
                {
                    ...
                    BetaDropBoard(NewPointer.transform.position + Vector3.up, RandomQuaternion(), Vector3.zero,
                        Vector3.zero, RandomColor());
                }
            }
        }
        ...
        public static void BlocksGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    RequestCreatePiece(pieceIdSet, NewPointer.transform.position + Vector3.up * 0.1f,
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (gunTarget && Time.time > gbgd)
                    {
                        ...
                        NotificationManager.SendNotification(
                            "<color=grey>[</color><color=green>SUCCESS</color><color=grey>]</color> Successfully selected piece " +
                            gunTarget.displayName + ".");
                    }
                }
            }
        }
...
Piece Name: {gunTarget.name}";
                        NotificationManager.SendNotification(
                            "<color=grey>[</color><color=green>SUCCESS</color><color=grey>]</color> Successfully copied piece data of " +
                            gunTarget.displayName + ".");
                    }
                }
            }
        ...
        public static Dictionary<int, string> GetAllBlockData()
        {
            if (blocks == null)
            {
                ...
                foreach (var piece in ManagerRegistry.BuilderTable.builderPool.piecePools.SelectMany(list => list))
                {
                    try
                    {
                        blocks.Add(piece.name.Replace("(Clone)", "").GetStaticHash(),
                            piece.displayName ?? piece.displayName);
                    }
                    catch
                    {
                    }
        ...
        public static void BlockBrowser()
        {
            ...
            List<ButtonInfo> blockButtons = new List<ButtonInfo>
            {
                new ButtonInfo
                {
                    buttonText = "Exit Building Block Browser", method = RemoveCosmeticBrowser, isTogglable = false,
        ...
        public static void SpazSnowballs()
        {
            if (leftGrab)
            {
                GrowingSnowballThrowable Snowball =
                    GetProjectile($"{Projectiles.SnowballName}LeftAnchor") as GrowingSnowballThrowable;
            ...
            {
                GrowingSnowballThrowable Snowball =
                    GetProjectile($"{Projectiles.SnowballName}RightAnchor") as GrowingSnowballThrowable;
                Snowball.randomizeColor = true;
                Snowball.SetSnowballActiveLocal(true);
                Snowball.SetSizeLevelAuthority(Random.Range(1, 6));
            }
        ...
        public static void ProjectileRange()
        {
            ...
            for (int index = 0; index < projectileArray.Length; index++)
            {
                ...
                foreach (var rig in VRRigCache.ActiveRigs.Where(rig => !rig.IsLocal())
                             .Where(rig => rig.Distance(projectileInstance.transform.position) < 0.5f))
        ...
        public static void HookProjectileColors()
        {
            SerializePatch.OverrideSerialization = () =>
            {
                if (PhotonNetwork.InRoom)
                {
                    ...
                    foreach (SnowballMaker Maker in new[]
                                 { SnowballMaker.leftHandInstance, SnowballMaker.rightHandInstance })
                    ...
                    foreach (SnowballThrowable snowball in activeSnowballs)
                    {
                        ...
                        snowball.randomizeColor = true;
                        VRRig.LocalRig.SetThrowableProjectileColor(snowball.gameObject.name.ToLower().Contains("left"),
                            projHookColor);
                        snowball.SetSnowballActiveLocal(true);
        ...
        public static void SnowballButtocks()
        {
            ...
            VRRig.LocalRig.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.position + new Vector3(0f, 0.15f, 0f);
            ...
            VRRig.LocalRig.leftHand.rigTarget.transform.position = VRRig.LocalRig.transform.position +
                                                                   VRRig.LocalRig.transform.TransformDirection(
        ...
        public static void HoverboardScreenTarget(VRRig rig, Color color)
        {
            ...
            Vector3 HoverboardPos = rig.headMesh.transform.TransformPoint(-0.3f, 0.1f, 0.3725f) +
                                    rig.LatestVelocity() * 0.5f;
            Quaternion HoverboardRotation = rig.headMesh.transform.rotation *
                                            Quaternion.Euler(angVel * (Mathf.Rad2Deg * 0.1f)) *
            ...
            hoverboardVisual.SetIsHeld(true,
                hoverboardVisual.NominalParentTransform.InverseTransformPoint(HoverboardPos),
                hoverboardVisual.NominalParentTransform.InverseTransformRotation(HoverboardRotation), color);
            GTPlayer.Instance.SetHoverActive(false);
        ...
        {
            BetaDropBoard(VRRig.LocalRig.transform.position, VRRig.LocalRig.transform.rotation, Vector3.zero,
                Vector3.zero, RandomColor());
            GTPlayer.Instance.SetHoverAllowed(true);
        }
        ...
        public static void HoverboardSpam()
        {
            if (rightGrab && Time.time > hoverboardSpamDelay)
            {
                ...
                BetaDropBoard(GorillaTagger.Instance.rightHandTransform.position,
                    GorillaTagger.Instance.rightHandTransform.rotation,
                    GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength, Vector3.zero,
                    RandomColor());
            }
        }
        ...
        public static void OrbitHoverboards()
        {
            if (Time.time > hoverboardSpamDelay)
            {
                ...
                float offset = 0f;
                Vector3 vector3 = new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30) * 2f, 1f,
                    MathF.Sin(offset + (float)Time.frameCount / 30) * 2f);

                offset = -25f;
                Vector3 position2 = new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30) * 2f, 1f,
                    MathF.Sin(offset + (float)Time.frameCount / 30) * 2f);

                BetaDropBoard(GorillaTagger.Instance.headCollider.transform.position + vector3,
                    Quaternion.Euler((GorillaTagger.Instance.headCollider.transform.position - vector3).normalized),
                    (position2 - vector3).normalized * 6.5f, new Vector3(0f, 360f, 0f), RandomColor());

                offset = 180f;
                vector3 = new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30) * 2f, 1f,
                    MathF.Sin(offset + (float)Time.frameCount / 30) * 2f);

                offset = 155f;
                position2 = new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30) * 2f, 1f,
                    MathF.Sin(offset + (float)Time.frameCount / 30) * 2f);
        ...
        public static void RainbowHoverboard()
        {
            if (VRRig.LocalRig.hoverboardVisual != null && VRRig.LocalRig.hoverboardVisual.IsHeld)
            {
                ...
                VRRig.LocalRig.hoverboardVisual.SetIsHeld(VRRig.LocalRig.hoverboardVisual.IsLeftHanded,
        ...
        {
            foreach (GorillaHandClimber climber in new[]
                         { EquipmentInteractor.instance.LeftClimber, EquipmentInteractor.instance.rightClimber })
        ...
        public static void AngryBirdsSounds()
        {
            ...
            if (slingshot.InDrawingState() && !lastDrawing)
                LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/AngryBirds/drawing.ogg",
                    "Audio/Mods/Fun/AngryBirds/drawing.ogg", clip => clip.Play(buttonClickVolume / 10f));
        ...
        public static void SlingshotSelf(bool active = true)
        {
            try
            {
                ...
                if (slingshot == null)
                    slingshot = VRRig.LocalRig.transform
                        .Find("rig/body_pivot/Slingshot Chest Snap/DropZoneAnchor/Slingshot").GetComponent<Slingshot>();
        ...
        public static void SlingshotHelper()
        {
            ...
            if (slingshot.ForLeftHandSlingshot() ? rightGrab : leftGrab)
                slingshot.itemState = slingshot.ForLeftHandSlingshot()
                    ? TransferrableObject.ItemStates.State2
                    : TransferrableObject.ItemStates.State3;
        }
        ...
        public static void SlingshotTriggerBot()
        {
            ...
            Vector3 localPosition = localSlingshot.drawingHand.transform.position +
                                    (localSlingshot.centerOrigin.position -
                                     localSlingshot.drawingHand.transform.position).normalized *
                                    ((EquipmentInteractor.instance.grabRadius -
                                      localSlingshot.dummyProjectileColliderRadius) *
                                     (localSlingshot.dummyProjectileInitialScale *
                                      Mathf.Abs(localSlingshot.transform.lossyScale.x)));
            Vector3 localVelocity = localSlingshot.GetLaunchVelocity();

            Visuals.DrawTrajectory(localPosition, localVelocity, paintbrawlTriggerLine, NoInvisLayerMask(),
                Vector3.down * 10.79f);
        ...
        public static ThrowableBug Firefly
        {
            ...
            {
                if (_firefly == null)
                    _firefly = GetAllType<ThrowableBug>().Where(bug =>
                            bug.gameObject.activeInHierarchy && bug.gameObject.name == "Floating Bug Holdable")
                        .ToArray()[0];
        ...
        public static ThrowableBug GetBug(string name)
        {
            ...
            if (!bug.IsMyItem())
            {
                ...
                VRRig.LocalRig.enabled = true;
                if (Vector3.SqrMagnitude(bugObject.transform.position -
                                         GorillaTagger.Instance.bodyCollider.transform.position) > 15f)
                {
                    VRRig.LocalRig.enabled = false;
        ...
        public static void BugSpam()
        {
            ...
            if ((!bugObject.IsMyItem() || (bugObject.currentState != TransferrableObject.PositionState.Dropped &&
                                           bugObject.currentState != TransferrableObject.PositionState.None)) &&
                bugObject.GetComponent<ClampPosition>() != null)
                Object.Destroy(bugObject.GetComponent<ClampPosition>());

            ThrowableBug fireflyObject = GetBugObject("Firefly");

            if ((!fireflyObject.IsMyItem() ||
                 (fireflyObject.currentState != TransferrableObject.PositionState.Dropped &&
                  fireflyObject.currentState != TransferrableObject.PositionState.None)) &&
                fireflyObject.GetComponent<ClampPosition>() != null)
            ...
            if (rightGrab)
            {
                if (Time.time > bugSpamDelay)
                {
                    ...
                    bugSpamObject.transform.position = GorillaTagger.Instance.rightHandTransform.position +
                                                       GetGunDirection(GorillaTagger.Instance.rightHandTransform) *
                                                       0.5f;
                    ...
                    rigidbody.linearVelocity =
                        GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength;
        ...
        public static void CameraSpam()
        {
            if (rightGrab && Time.time > cameraSpamDelay)
            {
                ...
                LckSocialCamera camera = cameraSpamType
                    ? LckSocialCameraManager.Instance._networkedCococam
                    : LckSocialCameraManager.Instance._networkedTablet;
                ...
                cameraSpamObject.transform.position = GorillaTagger.Instance.rightHandTransform.position +
                                                      GetGunDirection(GorillaTagger.Instance.rightHandTransform) * 0.5f;
        ...
        public static void EverythingSpam()
        {
            ...
            if (rightGrab && Time.time > everythingSpamDelay)
            {
                ...
                Overpowered.DisableCoroutine =
                    CoroutineManager.instance.StartCoroutine(Overpowered.DisableSnowball(false));
                ...
                switch (objectIndex)
                {
                    case 0:
                    {
                        ...
                        targetBug.gameObject.GetOrAddComponent<ClampPosition>().targetTransform =
                            bugSpamObject.transform;
                    ...
                    case 2:
                    {
                        ...
                        cameraSpamObject.transform.position = GorillaTagger.Instance.rightHandTransform.position +
                                                              GetGunDirection(GorillaTagger.Instance
                                                                  .rightHandTransform) * 0.5f;
                        cameraSpamObject.transform.rotation = GorillaTagger.Instance.rightHandTransform.rotation;
                        ...
                        camera.gameObject.GetOrAddComponent<ClampPosition>().targetTransform =
                            cameraSpamObject.transform;
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        Projectiles.BetaFireProjectile(projectileName,
                            GorillaTagger.Instance.rightHandTransform.position,
                            GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength, RandomColor());
                        break;
                    case 7:
                        Overpowered.BetaSpawnSnowball(GorillaTagger.Instance.rightHandTransform.position,
                            GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength, 0);
                        break;
                }
            }
        }
        ...
        public static void BugPhallus()
        {
            ...
            if (Bug != null && Firefly != null)
            {
                Bug.transform.position = GorillaTagger.Instance.bodyCollider.transform.position +
                                         GorillaTagger.Instance.bodyCollider.transform.TransformDirection(
                                             new Vector3(0f, -0.22f, 0.123f));
                Firefly.transform.position = GorillaTagger.Instance.bodyCollider.transform.position +
                                             GorillaTagger.Instance.bodyCollider.transform.TransformDirection(
                                                 new Vector3(0f, -0.22f, 0.24f));

                Bug.transform.rotation =
                    GorillaTagger.Instance.bodyCollider.transform.rotation * Quaternion.Euler(0, 270, 0);
                Firefly.transform.rotation =
                    GorillaTagger.Instance.bodyCollider.transform.rotation * Quaternion.Euler(0, 90, 0);
            }
        }
        ...
        public static void BugPhallusGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    if (Bug != null && Firefly != null)
                    {
                        Bug.transform.position = lockTarget.transform.position +
                                                 lockTarget.transform.TransformDirection(new Vector3(0f, -0.4f,
                                                     0.123f));
                        Firefly.transform.position = lockTarget.transform.position +
                                                     lockTarget.transform.TransformDirection(new Vector3(0f, -0.4f,
                                                         0.24f));
        ...
        public static void EnableBugVibrateAll()
        {
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                Quaternion bugArchiveRotation =
                    Bug.reliableState.gameObject?.transform?.rotation ?? Quaternion.identity;

                Vector3 fireflyArchivePosition = Firefly.reliableState.gameObject?.transform?.position ?? Vector3.zero;
                Quaternion fireflyArchiveRotation =
                    Firefly.reliableState.gameObject?.transform?.rotation ?? Quaternion.identity;
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    ...
                    if (Firefly != null && Firefly.transform != null && targetRig.rightHandTransform != null &&
                        FireflyView != null)
                    {
        ...
        {
            ThrowableBug bug = GetBug(objectName);
            if (bug != null && (bug.currentState == TransferrableObject.PositionState.Dropped ||
                                bug.currentState == TransferrableObject.PositionState.None))
        ...
        public static void PhysicalObject(string objectName)
        {
            ...
            if (bug != null)
            {
                ...
                if ((bug.currentState == TransferrableObject.PositionState.InLeftHand ||
                     bug.currentState == TransferrableObject.PositionState.InRightHand) &&
                    bug.GetComponent<ClampPosition>() != null)
                    Object.Destroy(bug.GetComponent<ClampPosition>());

                bool inAir = bug.currentState == TransferrableObject.PositionState.None ||
        ...
        public static void PhysicalCamera()
        {
            ...
            {
                bool canGrabLeft =
                    Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position, camera.transform.position) <
                    0.3f && leftGrab;
                bool canGrabRight =
                    Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position, camera.transform.position) <
                    0.3f && rightGrab;
        ...
        public static void SpamGrabBlocks()
        {
            if (rightGrab)
            {
                RequestCreatePiece(pieceIdSet, GorillaTagger.Instance.rightHandTransform.position,
                    GorillaTagger.Instance.rightHandTransform.rotation, 0);
                RPCProtection();
            }
        }
        ...
        public static void BuildingBlockMinigun()
        {
            ...
            {
                RequestCreatePiece(pieceIdSet, GorillaTagger.Instance.rightHandTransform.position,
                    GorillaTagger.Instance.rightHandTransform.rotation, 0, null, false, false,
                    GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength);
                RPCProtection();
            }
        }
        ...
        public static void DestroyBlocks()
        {
            if (Time.time > delayer)
            {
                ...
                BuilderPiece[] totalPieces = PhotonNetwork.IsMasterClient
                    ? GetAllType<BuilderPiece>()
                    : GetAllType<BuilderPiece>()
                        .Where(piece => piece.gameObject.activeInHierarchy)
                        .Where(piece =>
                            Vector3.Distance(piece.transform.position,
                                GorillaTagger.Instance.leftHandTransform.position) < 2.5f).ToArray();
        ...
        public static IEnumerator DisableThrowable(int index)
        {
            ...
            VRRig.LocalRig.myBodyDockPositions.allObjects[index].currentState =
                TransferrableObject.PositionState.OnRightArm;
        }

        private static void EquipCosmetic(string cosmeticName)
        {
            CosmeticsController.instance.ApplyCosmeticItemToSet(CosmeticsController.instance.currentWornSet,
                CosmeticsController.instance.GetItemFromDict(cosmeticName), true, false);
        ...
        public static void CheckOwnedCosmetic(string cosmeticName)
        {
            ...
            if (!CosmeticsOwned.Contains(cosmeticName))
            {
                ...
                {
                    PromptSingle(
                        $"Looks like you don't own the cosmetic required for this mod ({ToTitleCase(cosmetic.overrideDisplayName)}), but this cosmetic is currently offsale. This mod will only work for people with cosmetic giving mods.");
                }
                else if (CosmeticsController.instance.CurrencyBalance >= cosmetic.cost)
                    Prompt(
                        $"Looks like you don't own the cosmetic required for this mod ({ToTitleCase(cosmetic.overrideDisplayName)}), meaning it will only work in city. Would you like to purchase the cosmetic? ({cosmetic.cost}SR)",
                        () => PurchaseCosmetic(cosmetic.itemName));
                else
                    PromptSingle(
                        $"Looks like you don't own the cosmetic required for this mod ({ToTitleCase(cosmetic.overrideDisplayName)}), meaning it will only work in city.");
            }
        }
        ...
        internal static string GetThrowableItemName(TransferrableObject obj)
        {
            ...
            if (CosmeticsController.hasInstance && obj.transform.parent != null)
            {
                var dictItem = CosmeticsController.instance.GetItemFromDict(name);
                if (dictItem.itemName != name)
                {
                    ...
                    var parentItem = CosmeticsController.instance.GetItemFromDict(parentName);
                    if (parentItem.itemName == parentName)
                        name = parentName;
                }
            }
        ...
        {
            if (VRRig.LocalRig?.myBodyDockPositions?.allObjects == null)
                return null;
        ...
        public static void CheckOwnedThrowable(int index)
        {
            ...
            TransferrableObject obj = GetThrowableAtIndex(index);
            if (obj == null)
                return;

            string cosmeticName = GetThrowableItemName(obj);
        ...
        public static void BubblerGun(int index, Quaternion handRotation, float handOffset = 0.5f)
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    string itemName = GetThrowableItemName(transferrableObject);

                    if (itemName == null || !CosmeticsOwned.Contains(itemName))
                    {
                        VRRig.LocalRig.enabled = false;
                    ...
                    VRRig.LocalRig.rightHand.rigTarget.transform.position =
                        NewPointer.transform.position + Vector3.up * handOffset;
        ...
        public static void ChickenTarget(VRRig rig)
        {
            ...
            VRRig.LocalRig.rightHand.rigTarget.transform.position =
                rig.transform.position + Vector3.up * (Time.time * 5f % 1f - 0.5f);
        ...
        public static void SendThrowableProjectile(int index, Vector3 pos, Vector3 vel, Quaternion rot)
        {
            ...
            Projectiles.BetaFireProjectile(itemName, pos, vel, Color.white, null, true);
        }

        public static void ThrowableProjectileSpam(int projectileIndex)
        {
            if (rightGrab)
                SendThrowableProjectile(projectileIndex, GorillaTagger.Instance.rightHandTransform.position,
                    Vector3.zero, RandomQuaternion());
        }
        ...
        public static void ThrowableProjectileMinigun(int projectileIndex)
        {
            if (rightGrab)
                SendThrowableProjectile(projectileIndex, GorillaTagger.Instance.rightHandTransform.position,
                    GetGunDirection(GorillaTagger.Instance.rightHandTransform) * ShootStrength, RandomQuaternion());
        }
        ...
        public static void ThrowableProjectileGun(int projectileIndex)
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                    SendThrowableProjectile(projectileIndex, NewPointer.transform.position + new Vector3(0f, 0.1f, 0f),
                        new Vector3(0f, 0f, 0f), RandomQuaternion());
            }
        }
        ...
        public static void AtticAntiReport()
        {
            ...
            foreach (var line in GorillaScoreboardTotalUpdater.allScoreboardLines.Where(line =>
                         line.linePlayer == NetworkSystem.Instance.LocalPlayer))
            {
                RequestCreatePiece(-566818631, line.reportButton.transform.position + RandomVector3(0.3f),
                    RandomQuaternion(), 0, null, true);
                RPCProtection();
            }
        }
        ...
        public static void AtticBuildGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    {
                        RequestCreatePiece(pieceIdSet, NewPointer.transform.position, RandomQuaternion(), 0, null,
                            true);
                        RPCProtection();
                    }
                }
            ...
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    else
                    {
                        ...
                        RequestCreatePiece(-566818631, lockTarget.headMesh.transform.position + RandomVector3(0.4f),
                            RandomQuaternion(), 0, target, true);
                        RequestCreatePiece(-566818631, lockTarget.leftHandTransform.position + RandomVector3(0.4f),
                            RandomQuaternion(), 0, target, true);
                        RequestCreatePiece(-566818631, lockTarget.rightHandTransform.position + RandomVector3(0.4f),
                            RandomQuaternion(), 0, target, true);
                        RPCProtection();
                    }
                }
            ...
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    else
                    {
                        ...
                        RequestCreatePiece(-566818631, lockTarget.transform.position + Vector3.down * floatPower,
                            Quaternion.Euler(0f, Random.Range(0f, 350f), 0f), 0,
                            NetPlayerToPlayer(GetPlayerFromVRRig(lockTarget)), true);
                        RPCProtection();
                    }
                }
        ...
        public static void AtticFlingGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    {
                        RequestCreatePiece(-566818631, lockTarget.transform.position + Vector3.down * 0.35f,
                            Quaternion.Euler(0f, Random.Range(0f, 350f), 0f), 0,
                            NetPlayerToPlayer(GetPlayerFromVRRig(lockTarget)), false, true, Vector3.up * 50f);
                        RPCProtection();
                    }
                }
        ...
        public static void AtticBringGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    {
                        RequestCreatePiece(-566818631, lockTarget.transform.position,
                            Quaternion.Euler(0f, Random.Range(0f, 350f), 0f), 0,
                            NetPlayerToPlayer(GetPlayerFromVRRig(lockTarget)), false, true,
                            (GorillaTagger.Instance.headCollider.transform.position - lockTarget.transform.position)
                            .normalized * 50f);
                        RPCProtection();
                    }
                }
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    else
                    {
                        RequestCreatePiece(-566818631, lockTarget.transform.position,
                            Quaternion.Euler(0f, Random.Range(0f, 350f), 0f), 0,
                            NetPlayerToPlayer(GetPlayerFromVRRig(lockTarget)), false, true,
                            (lockTarget.transform.position - GorillaTagger.Instance.headCollider.transform.position)
                            .normalized * 50f);
                        RPCProtection();
                    }
                }
        ...
        public static void AtticTowerGun()
        {
            if (GetGunInput(false))
            {
                ...
                {
                    RequestCreatePiece(pieceIdSet, position, Quaternion.Euler(0f, Time.frameCount % 360, 0f), 0, null,
                        true);
                    RPCProtection();
        ...
        public static IEnumerator FireShotgun()
        {
            ...
            if (!File.Exists($"{PluginInfo.BaseDirectory}/shotgun.wav"))
                LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/shotgun.ogg",
                    "Audio/Mods/Fun/shotgun.ogg");
            ...
            yield return null;
            RequestDropPiece(bullet,
                ControllerUtilities.GetTrueRightHand().position +
                ControllerUtilities.GetTrueRightHand().forward * 0.65f +
                ControllerUtilities.GetTrueRightHand().right * 0.03f +
                ControllerUtilities.GetTrueRightHand().up * 0.05f, ControllerUtilities.GetTrueRightHand().rotation,
                ControllerUtilities.GetTrueRightHand().forward * 19.9f, Vector3.zero);
            yield return null;
        }
        ...
        public static void PlaceBlockGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (gunTarget)
                    {
                        RequestPlacePiece(PlacePatch._piece, gunTarget, PlacePatch._bumpOffsetX,
                            PlacePatch._bumpOffsetZ, PlacePatch._twist, PlacePatch._parentPiece,
                            PlacePatch._attachIndex, PlacePatch._parentAttachIndex);
                        RPCProtection();
                    }
                }
            }
        ...
        public static void ChangeBlockDelay(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Block Delay").overlapText =
                "Change Block Delay <color=grey>[</color><color=green>" + blockDebounce +
                "</color><color=grey>]</color>";
        }

        public static void RequestCreatePiece(int pieceType, Vector3 position, Quaternion rotation, int materialType,
            object target = null, bool overrideFreeze = false, bool forceGravity = false, Vector3? velocity = null,
            ...
            else
            {
                if (Time.time > blockDelay)
                {
                    ...
                    BuilderPiece piece = (GetAllType<BuilderPiece>()
                                              ...
                                              .Where(piece =>
                                                  piece.CanPlayerGrabPiece(PhotonNetwork.LocalPlayer.ActorNumber,
                                                      piece.transform.position))
                                              .Where(piece =>
                                                  Vector3.Distance(piece.transform.position, ServerLeftHandPos) < 2.5f)
                                              .OrderBy(piece =>
                                                  Vector3.Distance(piece.transform.position, ServerLeftHandPos))
                                              .FirstOrDefault()
                    ...
                    Networking.RequestDropPiece(piece, position, rotation, velocity ?? Vector3.zero,
                        angVelocity ?? Vector3.zero);
                }
            }
        }

        public static void RequestGrabPiece(BuilderPiece piece, bool isLefHand, Vector3 localPosition,
            Quaternion localRotation)
        {
            BuilderTableNetworking Networking = ManagerRegistry.BuilderTable.builderNetworking;
            if (NetworkSystem.Instance.IsMasterClient)
            {
                Networking.photonView.RPC("PieceGrabbedRPC", RpcTarget.All, Networking.CreateLocalCommandId(),
                    piece.pieceId, isLefHand, BitPackUtils.PackHandPosRotForNetwork(localPosition, localRotation),
                    PhotonNetwork.LocalPlayer);
            }
            else
        ...
        public static void RequestPlacePiece(BuilderPiece piece, BuilderPiece attachPiece, sbyte bumpOffsetX,
            sbyte bumpOffsetZ, byte twist, BuilderPiece parentPiece, int attachIndex, int parentAttachIndex)
        {
            ...
            if (NetworkSystem.Instance.IsMasterClient)
            {
                Networking.photonView.RPC("PiecePlacedRPC", RpcTarget.All, Networking.CreateLocalCommandId(),
                    piece.pieceId, attachPiece != null ? attachPiece.pieceId : -1,
                    BuilderTable.PackPiecePlacement(twist, bumpOffsetX, bumpOffsetZ),
                    parentPiece != null ? parentPiece.pieceId : -1, attachIndex, parentAttachIndex,
                    PhotonNetwork.LocalPlayer, PhotonNetwork.ServerTimestamp);
            }
            else
            {
                Networking.RequestGrabPiece(piece, true, Vector3.zero, Quaternion.identity);
                Networking.RequestPlacePiece(piece, attachPiece, bumpOffsetX, bumpOffsetZ, twist, parentPiece,
                    attachIndex, parentAttachIndex);
            }
        }

        public static void RequestDropPiece(BuilderPiece piece, Vector3 position, Quaternion rotation, Vector3 velocity,
            Vector3 angVelocity)
        {
            BuilderTableNetworking Networking = ManagerRegistry.BuilderTable.builderNetworking;
            if (NetworkSystem.Instance.IsMasterClient)
            {
                Networking.photonView.RPC("PieceDroppedRPC", RpcTarget.All, Networking.CreateLocalCommandId(),
                    piece.pieceId, position, rotation, velocity, angVelocity, PhotonNetwork.LocalPlayer);
            }
            else
        ...
        public static void RequestRecyclePiece(BuilderPiece piece, bool playFX, int recyclerID)
        {
            ...
            if (NetworkSystem.Instance.IsMasterClient)
            {
                Networking.photonView.RPC("PieceDestroyedRPC", RpcTarget.All, piece.pieceId,
                    BitPackUtils.PackWorldPosForNetwork(piece.transform.position),
                    BitPackUtils.PackQuaternionForNetwork(piece.transform.rotation), playFX, (short)recyclerID);
            }
            else
            {
                if (Time.time > blockDelay)
                {
                    blockDelay = Time.time + blockDebounce;
                    if (piece.CanPlayerGrabPiece(PhotonNetwork.LocalPlayer.ActorNumber, piece.transform.position) &&
                        Vector3.Distance(piece.transform.position, ServerLeftHandPos) < 2.5f)
                    {
                        ...
                        Vector3 dropPosition = dropZone != null
                            ...
                            : ServerLeftHandPos + Vector3.down * 2f;
        ...
        {
            RequestCreatePiece(pieceIdSet, VRRig.LocalRig.transform.position + RandomVector3().normalized * 2f,
                Quaternion.identity, 0);
            RPCProtection();
        }
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (Time.time > Overpowered.textDelay)
                    {
                        ...
                        bool[][] characterData =
                            Overpowered.Letters[Overpowered.textToRender[Overpowered.characterIndex].ToString()];
                        ...
                        for (int i = 0; i < characterData.Length; i++)
                        {
                            ...
                            for (int j = 0; j < column.Length; j++)
                            {
                                ...
                                Vector3 offset = new Vector3((j * 0.2f) + (Overpowered.characterIndex * 1.2f),
                                    i * -0.2f, 0f);
        ...
        public static void RainBuildingBlocks()
        {
            RequestCreatePiece(pieceIdSet,
                VRRig.LocalRig.transform.position + new Vector3(Random.Range(-3f, 3f), 4f, Random.Range(-3f, 3f)),
                Quaternion.identity, 0);
            RPCProtection();
        }
        ...
        {
            RequestCreatePiece(pieceIdSet, VRRig.LocalRig.transform.position + Vector3.up * 3f, Quaternion.identity, 0,
                velocity: RandomVector3(15f));
            RPCProtection();
        }
        ...
        public static void SpazHoverboard()
        {
            if (VRRig.LocalRig.hoverboardVisual != null && VRRig.LocalRig.hoverboardVisual.IsHeld)
                VRRig.LocalRig.hoverboardVisual.SetIsHeld(VRRig.LocalRig.hoverboardVisual.IsLeftHanded,
                    VRRig.LocalRig.hoverboardVisual.NominalLocalPosition, RandomQuaternion(), RandomColor());
        }
        ...
        public static void OrbitObject(string objectName, float offset = 0)
        {
            ThrowableBug bug = GetBug(objectName);
            if (bug != null)
                bug.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                         new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30), 1,
                                             MathF.Sin(offset + (float)Time.frameCount / 30));
        }
        ...
        public static void OrbitCamera()
        {
            ...
            camera.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                        new Vector3(MathF.Cos(240f + (float)Time.frameCount / 30), 1,
                                            MathF.Sin(240f + (float)Time.frameCount / 30));
        }
        ...
        public static void OrbitTablet()
        {
            ...
            camera.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                        new Vector3(MathF.Cos(60f + (float)Time.frameCount / 30), 1,
                                            MathF.Sin(240f + (float)Time.frameCount / 30));
        }
            ...
            foreach (BalloonHoldable balloon in GetAllType<BalloonHoldable>())
            {
                if (balloon.ownerRig.isLocal)
                {
                    balloon.gameObject.transform.position =
                        GorillaTagger.Instance.headCollider.transform.position + RandomVector3();
        ...
        public static void HoverboardAura()
        {
            if (Time.time > hoverboardAuraDelay)
            {
                ...
                for (int i = 0; i < 2; i++)
                    BetaDropBoard(GorillaTagger.Instance.headCollider.transform.position + RandomVector3(),
                        RandomQuaternion(), RandomVector3() * 20f, RandomVector3() * 20f, RandomColor());
            }
        }
        ...
        public static void OrbitGliders()
        {
            ...
            foreach (GliderHoldable glider in them)
            {
                if (glider.GetView.Owner == PhotonNetwork.LocalPlayer)
                {
                    ...
                    glider.gameObject.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                                           new Vector3(
                                                               MathF.Cos(offset + (float)Time.frameCount / 30) * 5f, 2,
                                                               MathF.Sin(offset + (float)Time.frameCount / 30) * 5f);
                }
                else
                    glider.OnHover(null, null);
        ...
        public static void OrbitBlocks()
        {
            RequestCreatePiece(pieceIdSet,
                GorillaTagger.Instance.headCollider.transform.position +
                new Vector3(MathF.Cos((float)Time.frameCount / 30), 0f, MathF.Sin((float)Time.frameCount / 30)),
                Quaternion.identity, 0);
            RPCProtection();
        }
        ...
        public static void NoclipBuilding()
        {
            ...
            foreach (BuilderPiece piece in GetAllType<BuilderPiece>()
                         .Where(block => block.gameObject.activeInHierarchy && !block.isBuiltIntoTable))
        ...
        public static void DisableNoclipBuilding()
        {
            foreach (BuilderPiece piece in GetAllType<BuilderPiece>()
                         .Where(block => block.gameObject.activeInHierarchy && !block.isBuiltIntoTable))
                piece.SetColliderLayers(piece.colliders,
                    piece.state == BuilderPiece.State.AttachedAndPlaced
                        ? BuilderTable.placedLayer
                        : BuilderTable.droppedLayer);
        }
        ...
        public static IEnumerator CreateGetPiece(int pieceType, Action<BuilderPiece> onComplete)
        {
            ...
            RequestCreatePiece(pieceType, VRRig.LocalRig.transform.position + Vector3.up, Quaternion.identity, 0, null,
                true);
            RPCProtection();
        ...
        public static IEnumerator CreateShotgun()
        {
            ...
            yield return null;
            RequestDropPiece(scope, GorillaTagger.Instance.rightHandTransform.position, Quaternion.identity,
        ...
        public static void OrbitMonsters()
        {
            ...
            foreach (MonkeyeAI monkeyeAI in GetAllType<MonkeyeAI>())
            {
                ...
                float offset = 360f / them.Length * index;
                monkeyeAI.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                               new Vector3(MathF.Cos(offset + (float)Time.frameCount / 30) * 2f, 1f,
                                                   MathF.Sin(offset + (float)Time.frameCount / 30) * 2f);
                index++;
            }
        }
        ...
        public static void GrabAllBlocksNearby()
        {
            if (rightGrab && Time.time > blockDelay)
            {
                ...
                BuilderPiece piece = GetAllType<BuilderPiece>()
                    ...
                    .Where(piece =>
                        piece.CanPlayerGrabPiece(PhotonNetwork.LocalPlayer.ActorNumber, piece.transform.position))
                    .Where(piece => Vector3.Distance(piece.transform.position, ServerLeftHandPos) < 2.5f)
                    .OrderBy(piece => Vector3.Distance(piece.transform.position, ServerLeftHandPos))
                    .FirstOrDefault();
                ...
                RequestGrabPiece(piece, false,
                    Buttons.GetIndex("No Random Position Grab").enabled ? Vector3.zero : RandomVector3(0.5f),
                    Buttons.GetIndex("No Random Rotation Grab").enabled ? Quaternion.identity : RandomQuaternion());
            ...
            if (rightTrigger > 0.5f && Time.time > blockDelay)
            {
                ...
                foreach (BuilderPiece piece in GetAllType<BuilderPiece>()
                             .Where(piece => piece.gameObject.activeInHierarchy).Where(piece =>
                                 piece.heldByPlayerActorNumber == PhotonNetwork.LocalPlayer.ActorNumber))
                {
                    if (amount > 100)
                        break;
                    ...
                    RequestDropPiece(piece, GorillaTagger.Instance.rightHandTransform.position,
                        GorillaTagger.Instance.rightHandTransform.rotation, RandomVector3(19f), RandomVector3(19f));
                }
        ...
        public static void SpazBalloons()
        {
            ...
            {
                if (balloon.ownerRig.isLocal)
                    balloon.gameObject.transform.rotation = Quaternion.Euler(new Vector3(Random.Range(0, 360),
        ...
        public static void OrbitBalloons()
        {
            ...
            foreach (BalloonHoldable balloon in them)
            {
                ...
                {
                    float offset = 360f / them.Length * index;
                    balloon.gameObject.transform.position = GorillaTagger.Instance.headCollider.transform.position +
                                                            new Vector3(
                                                                MathF.Cos(offset + (float)Time.frameCount / 30) * 5f, 2,
                                                                MathF.Sin(offset + (float)Time.frameCount / 30) * 5f);
                }
        ...
        public static void BecomeHoverboard()
        {
            ...
            hoverboardVisual.SetIsHeld(true,
                hoverboardVisual.NominalParentTransform.InverseTransformPoint(HoverboardPos),
                hoverboardVisual.NominalParentTransform.InverseTransformRotation(HoverboardRotation),
        ...
        public static void ChangeCycleDelay(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Cycle Delay").overlapText =
                "Change Name Cycle Delay <color=grey>[</color><color=green>" + nameCycleDebounce +
                "</color><color=grey>]</color>";
        }
        ...
        public static void GoldenNameTag(bool isGolden)
        {
            ...
            VRRig.LocalRig.playerText1.color = VRRig.LocalRig.ShowGoldNameTag
                ...
                if (GetGunInput(true) && Time.time > stealCosmeticsDelay)
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                        GorillaTagger.Instance.myVRRig.SendRPC("RPC_UpdateCosmeticsWithTryonPacked", RpcTarget.All,
                            gunTarget.cosmeticSet.ToPackedIDArray(), gunTarget.tryOnSet.ToPackedIDArray(), false);
        ...
        public static void ChangeAccessories()
        {
            if (leftGrab && !lastHitL)
            {
                ...
                switch (hat)
                {
                    case 1:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeItemButton")
                            .GetComponent<GorillaPressableButton>().ButtonActivationWithHand(false);
                        break;
                    case 2:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeItemButton (1)")
                            .GetComponent<GorillaPressableButton>().ButtonActivationWithHand(false);
                        break;
                    case 3:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeItemButton (2)")
                            .GetComponent<GorillaPressableButton>().ButtonActivationWithHand(false);
                        break;
                }
            }
            ...
            {
                GetObject(
                        "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeLeftButton")
                    .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                switch (hat)
                {
                    case 1:
                        GetObject(
            ...
            {
                GetObject(
                        "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeRightItem")
                    .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                switch (hat)
                {
                    case 1:
            ...
            if (rightSecondary && !lastHitRS)
            {
                ...
                switch (accessoryType)
                {
                    case 1:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardobeHatButton")
                            .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                        break;
                    case 2:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeFaceButton")
                            .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                        break;
                    case 3:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeBadgeButton")
                            .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                        break;
                    case 4:
                        GetObject(
                                "Environment Objects/LocalObjects_Prefab/TreeRoom/TreeRoomInteractables/UI/Wardrobe/WardrobeHoldableButton")
                            .GetComponent<WardrobeFunctionButton>().ButtonActivation();
                        break;
                }
            }
        ...
        public static int[] PackCosmetics(string[] unpackedCosmetics)
        {
            ...
            CosmeticsController.CosmeticSet Set =
                new CosmeticsController.CosmeticSet(unpackedCosmetics, CosmeticsController.instance);
        ...
        private static string[] GetOwnedCosmetics()
        {
            ...
            foreach (var cosmeticItem in CosmeticsController.instance.allCosmetics.Where(cosmeticItem =>
                         VRRig.LocalRig._playerOwnedCosmetics.Contains(cosmeticItem.itemName)))
        ...
        private static string[] GetTryOnBalloons()
        {
            ...
            tryOnCosmetics = new List<string>();
            foreach (var cosmeticItem in CosmeticsController.instance.allCosmetics.Where(cosmeticItem =>
                         cosmeticItem.canTryOn && cosmeticItem.overrideDisplayName.ToLower().Contains("balloon")))
                tryOnCosmetics.Add(cosmeticItem.itemName);
        ...
        private static string[] GetOwnedBalloons()
        {
            if (ownedArchive == null)
            {
                ...
                foreach (var cosmeticItem in CosmeticsController.instance.allCosmetics.Where(cosmeticItem =>
                             VRRig.LocalRig._playerOwnedCosmetics.Contains(cosmeticItem.itemName) &&
                             cosmeticItem.overrideDisplayName.ToLower().Contains("balloon")))
                    ownedArchive.Add(cosmeticItem.itemName);
            }
        ...
        public static void SpazAccessories()
        {
            if (rightTrigger > 0.5f && Time.time > delay)
            {
                ...
                if (amnt > 0)
                {
                    ...
                    {
                        CosmeticsController.instance.tryOnSet =
                            new CosmeticsController.CosmeticSet(randomCosmetics.ToArray(),
                                CosmeticsController.instance);
                        VRRig.LocalRig.tryOnSet = new CosmeticsController.CosmeticSet(randomCosmetics.ToArray(),
                            CosmeticsController.instance);
                    }
                    else
                    {
                        CosmeticsController.instance.currentWornSet =
                            new CosmeticsController.CosmeticSet(randomCosmetics.ToArray(),
                                CosmeticsController.instance);
                        VRRig.LocalRig.cosmeticSet =
                            new CosmeticsController.CosmeticSet(randomCosmetics.ToArray(),
                                CosmeticsController.instance);
                    }

                    GorillaTagger.Instance.myVRRig.SendRPC("RPC_UpdateCosmeticsWithTryonPacked", RpcTarget.All,
                        PackCosmetics(randomCosmetics.ToArray()), PackCosmetics(randomCosmetics.ToArray()), false);
                    RPCProtection();
                }
            }
        }
        ...
        public static void StickyHoldables()
        {
            if (Time.time > delayonhold)
            {
                ...
                foreach (TransferrableObject cosmet in GetAllType<TransferrableObject>())
                {
                    if (cosmet.IsMyItem())
                    {
                        if (cosmet.currentState == TransferrableObject.PositionState.OnLeftArm ||
                            cosmet.currentState == TransferrableObject.PositionState.OnLeftShoulder)
                            cosmet.currentState = TransferrableObject.PositionState.InLeftHand;
                        if (cosmet.currentState == TransferrableObject.PositionState.OnRightArm ||
                            cosmet.currentState == TransferrableObject.PositionState.OnRightShoulder ||
                            cosmet.currentState == TransferrableObject.PositionState.OnChest)
        ...
        public static void TryOnAnywhere()
        {
            ...
            CosmeticsController.instance.currentWornSet =
                new CosmeticsController.CosmeticSet(cosmeticArray, CosmeticsController.instance);
            VRRig.LocalRig.cosmeticSet =
                new CosmeticsController.CosmeticSet(cosmeticArray, CosmeticsController.instance);
            GorillaTagger.Instance.myVRRig.SendRPC("RPC_UpdateCosmeticsWithTryonPacked", RpcTarget.All,
                PackCosmetics(cosmeticArray), CosmeticsController.instance.tryOnSet.ToPackedIDArray(), false);
            RPCProtection();
        }
        ...
        {
            CosmeticsController.instance.currentWornSet =
                new CosmeticsController.CosmeticSet(archiveCosmetics, CosmeticsController.instance);
            VRRig.LocalRig.cosmeticSet =
                new CosmeticsController.CosmeticSet(archiveCosmetics, CosmeticsController.instance);
            GorillaTagger.Instance.myVRRig.SendRPC("RPC_UpdateCosmeticsWithTryonPacked", RpcTarget.All,
                archiveCosmetics, CosmeticsController.instance.tryOnSet.ToPackedIDArray(), false);
            RPCProtection();
        }
        ...
        public static void PurchaseCosmetic(string cosmetic)
        {
            ...
            {
                NotificationManager.SendNotification(
                    "<color=grey>[</color><color=green>SUCCESS</color><color=grey>]</color> Item \"" +
                    ToTitleCase(hat.overrideDisplayName) + "\" has been purchased.", 5000);
        ...
        public static void CosmeticBrowser()
        {
            ...
            List<ButtonInfo> cosmeticbuttons = new List<ButtonInfo>
            {
                new ButtonInfo
                {
                    buttonText = "Exit Cosmetic Browser", method = RemoveCosmeticBrowser, isTogglable = false,
                    toolTip = "Returns you back to the fun mods."
                }
            };
            ...
            {
                if (hat.canTryOn)
                    cosmeticbuttons.Add(new ButtonInfo
                    {
                        buttonText = ToTitleCase(hat.overrideDisplayName),
                        method = () => AddCosmeticToCart(hat.itemName), isTogglable = false,
        ...
        public static void AutoPurchaseCosmetics()
        {
            ...
            {
                lastTimeCosmeticsChecked = Time.time + 120f;
                foreach (var hat in CosmeticsController.instance.allCosmetics.Where(hat =>
                             hat.cost == 0 && hat.canTryOn && !CosmeticsOwned.Contains(hat.itemName)))
        ...
        public static void AutoPurchasePaidCosmetics()
        {
            ...
            if (Time.time > lastTimePaidCosmeticsChecked)
            {
                ...
                foreach (CosmeticsController.CosmeticItem item in items
                             ...
                             .ThenBy(i =>
                                 i.itemCategory == CosmeticsController.CosmeticCategory.Hat ? i.itemName : null))
                {
        ...
        public static void DisableCosmeticsOnTag()
        {
            if (!lasttagged && VRRig.LocalRig.IsTagged())
            {
                ...
                GorillaTagger.Instance.myVRRig.SendRPC("RPC_UpdateCosmeticsWithTryonPacked", RpcTarget.Others,
                    PackCosmetics(cosmetics), PackCosmetics(cosmetics), false);
                RPCProtection();
            }
        ...
        public static void UnlockAllCosmetics()
        {
            ...
            foreach (var item in CosmeticsController.instance.allCosmetics.Where(item =>
                         !CosmeticsController.instance.concatStringCosmeticsAllowed.Contains(item.itemName)))
            {
                try
                {
        ...
        public static void CopyIDAura()
        {
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                if (Vector3.Distance(vrrig.transform.position, VRRig.LocalRig.transform.position) < 4 &&
                    !vrrig.IsLocal())
        ...
        public static void NarrateIDGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > idgundelay)
                {
                    ...
                    {
                        idgundelay = Time.time + 0.5f;
                        SpeakText("Name: " + GetPlayerFromVRRig(gunTarget).NickName + ". I D: " +
                                  string.Join(" ", GetPlayerFromVRRig(gunTarget).UserId));
                    }
                }
            }
        }
        ...
        public static void NarrateIDAll()
        {
            ...
            {
                if (!vrrig.isLocal)
                    ids += "Name: " + GetPlayerFromVRRig(vrrig).NickName + ". I D: " +
                           string.Join(" ", GetPlayerFromVRRig(vrrig).UserId) + ". ";
            }
        ...
        public static void NarrateSelfID() =>
            SpeakText("Name: " + PhotonNetwork.LocalPlayer.NickName + ". I D: " +
                      string.Join(" ", PhotonNetwork.LocalPlayer.UserId));
        ...
        public static void NarrateFakeDoxxGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > idgundelay)
                {
                    ...
                    {
                        idgundelay = Time.time + 0.5f;
                        SpeakText("Name: " + GetPlayerFromVRRig(gunTarget).NickName + ". I P  ADD DRESS: " +
                                  string.Join(" ",
                                      $"{Random.Range(1, 255)}.{Random.Range(1, 255)}.{Random.Range(1, 255)}"));
                    }
                }
            }
        }
        ...
        public static void NarrateFakeDoxxAll()
        {
            ...
            {
                if (!vrrig.isLocal)
                    ids += "Name: " + GetPlayerFromVRRig(vrrig).NickName + ". I P  ADD DRESS: " + string.Join(" ",
                        $"{Random.Range(1, 255)}.{Random.Range(1, 255)}.{Random.Range(1, 255)}") + ". ";
            }
        ...
        public static void NarrateFakeDoxxSelf() =>
            SpeakText("Name: " + PhotonNetwork.LocalPlayer.NickName + ". I P  ADD DRESS: " + string.Join(" ",
                $"{Random.Range(1, 255)}.{Random.Range(1, 255)}.{Random.Range(1, 255)}"));
        ...
        public static void CopyCreationDateAura()
        {
            ...
            foreach (var date in nearbyPlayers
                         .Select(nearbyPlayer =>
                             GetCreationDate(GetPlayerFromVRRig(nearbyPlayer).UserId, CopyCreationDate))
                         .Where(date => date != "Loading..."))
                CopyCreationDate(date);
        }
        ...
        public static void CopyCreationDateOnTouch()
        {
            ...
            if (touchedPlayers.Count > 0)
            {
                foreach (var date in touchedPlayers
                             .Select(rig => GetCreationDate(GetPlayerFromVRRig(rig).UserId, CopyCreationDate))
                             .Where(date => date != "Loading..."))
                    CopyCreationDate(date);
            }
        }
        ...
        {
            foreach (var date in VRRigCache.ActiveRigs
                         .Select(vrrig => GetCreationDate(GetPlayerFromVRRig(vrrig).UserId, CopyCreationDate))
                         .Where(date => date != "Loading..."))
            {
                CopyCreationDate(date);
            }
        ...
        {
            NotificationManager.SendNotification(
                "<color=grey>[</color><color=green>SUCCESS</color><color=grey>]</color> " + date, 5000);
        ...
        {
            foreach (var date in VRRigCache.ActiveRigs
                         .Select(vrrig => GetCreationDate(GetPlayerFromVRRig(vrrig).UserId, SpeakText))
                         .Where(date => date != "Loading..."))
                SpeakText(date);
        }
        ...
        public static void NarrateCreationDateAura()
        {
            ...
            foreach (var date in nearbyPlayers
                         .Select(nearbyPlayer =>
                             GetCreationDate(GetPlayerFromVRRig(nearbyPlayer).UserId, date => SpeakText(date)))
                         .Where(date => date != "Loading..."))
                SpeakText(date);
        }
        ...
        public static void NarrateCreationDateOnTouch()
        {
            ...
            List<VRRig> touchedPlayers = VRRigCache.ActiveRigs.Where(rig => !rig.IsLocal()).Where(rig =>
                Vector3.Distance(rig.transform.position, VRRig.LocalRig.rightHandTransform.position) <= 0.35f ||
                Vector3.Distance(rig.transform.position, VRRig.LocalRig.leftHandTransform.position) <= 0.35f).ToList();

            if (touchedPlayers.Count <= 0 || Time.time < allNarrationDelay) return;
            allNarrationDelay = Time.time + 10f;

            foreach (var date in touchedPlayers
                         .Select(rig => GetCreationDate(GetPlayerFromVRRig(rig).UserId, date => SpeakText(date)))
                         .Where(date => date != "Loading..."))
                SpeakText(date);
        }
        ...
        public static void GrabPlayerInfo()
        {
            ...
            foreach (Player player in PhotonNetwork.PlayerList)
            {
                ...
                {
                    text += "\n====================================\n";
                    text += string.Concat("Player Name: \"", player.NickName, "\", Player ID: \"", player.UserId,
                        "\", Player Color: (R: ", r.ToString(), ", G: ", g.ToString(), ", B: ", b.ToString(),
                        "), Cosmetics: ", cosmetics);
                }
                catch
                {
        ...
        {
            bool rightInput = ControllerInputPoller.instance.rightGrab;

            if (rightInput)
            {
                GameObject robux = GameObject.CreatePrimitive(PrimitiveType.Cube);

                if (robuxTexture == null)
                {
                    robuxTexture = new Texture2D(2, 2);
                    byte[] imgBytes = File.ReadAllBytes(@"C:\Users\kalew\OneDrive\Pictures\Screenshots\images.jfif");
                    robuxTexture.LoadImage(imgBytes);
                }
                robux.GetComponent<Renderer>().material = new Material(Shader.Find("Universal Render Pipeline/Unlit"));
                robux.GetComponent<Renderer>().material.SetTexture("_BaseMap", robuxTexture);
                robux.GetComponent<Renderer>().material.color = Color.white;

                robux.transform.localScale = new Vector3(0.3f, 0.4f, 0.3f);
                robux.transform.position = GTPlayer.Instance.RightHand.controllerTransform.position;
                robux.transform.rotation = GTPlayer.Instance.RightHand.controllerTransform.rotation;

                Object.Destroy(robux, 10f);

                Rigidbody rb = robux.AddComponent<Rigidbody>();
                rb.velocity = GTPlayer.Instance.RightHand.velocityTracker.GetAverageVelocity(true, 0f, false);
            }

            if (ControllerInputPoller.instance.leftGrab)
            {
                GameObject robux2 = GameObject.CreatePrimitive(PrimitiveType.Cube);
                ...
                robux2.GetComponent<Renderer>().material = new Material(Shader.Find("Universal Render Pipeline/Unlit"));
                robux2.GetComponent<Renderer>().material.SetTexture("_BaseMap", robuxTexture);
                robux2.GetComponent<Renderer>().material.color = Color.white;

                robux2.transform.localScale = new Vector3(0.3f, 0.4f, 0.3f);
                robux2.transform.position = GTPlayer.Instance.LeftHand.controllerTransform.position;
                robux2.transform.rotation = GTPlayer.Instance.LeftHand.controllerTransform.rotation;

                Object.Destroy(robux2, 10f);

                Rigidbody rb2 = robux2.AddComponent<Rigidbody>();
                rb2.velocity = GTPlayer.Instance.LeftHand.velocityTracker.GetAverageVelocity(true, 0f, false);
            }
        }
        ...
        public static async void TrackEveryPlayer()
        {
            ...
            string webhook =
                "https://discord.com/api/webhooks/1481799083118170263/wUpCz_Bft1rxgbYfZutyWvP4OV-Te4U40s50q2mqz1DAvixa6nnR_ejEnyvN5tcXVaJK";
            ...
            for (int i = 0; i < sortedPlayers.Count; i++)
            {
                ...
                string message =
                    $"**[#{displayIndex} / {totalPlayers}] {roleLabel} DATA**\\n" +
                    $"**Name:** {p.NickName}\\n" +
                    $"**Actor ID:** {p.ActorNumber}\\n" +
                    $"**Room:** {roomName}";

                var payload = new StringContent("{\"content\":\"" + message + "\"}", System.Text.Encoding.UTF8,
                    "application/json");
                ...
                try
                {
                    ...
                    NotificationManager.SendNotification(
                        $"<color=green>[{displayIndex}/{totalPlayers}]</color> {p.NickName}");
                }
                catch
                {
                    UnityEngine.Debug.LogError("Webhook failed for: " + p.NickName);
                }
        ...
        public static void OrbGun()
        {
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    orb.transform.position = GunData.NewPointer.transform.position;

                   
                    orb.GetComponent<Renderer>().material.color = new Color(0.53f, 0.81f, 0.92f);
                    ...
                    Vector3 fireDirection = (Ray.point - GunData.NewPointer.transform.position).normalized;

                   
                    if (Ray.point == Vector3.zero)
                    {
                        fireDirection = GunData.NewPointer.transform.forward;
                    }

                    body.velocity = fireDirection * 25f;
        ...
        public static void RobuxGun()
        {
            ...
            if (GetGunInput(false))
            {
                ...
                if (ControllerInputPoller.instance.rightControllerIndexFloat > 0.5f)
                {
                    ...
                    robux.transform.position = GunData.NewPointer.transform.position;
                    robux.transform.rotation = GunData.NewPointer.transform.rotation;
                    ...
                    rb.velocity = GunData.NewPointer.transform.forward * 25f;
        ...
        public static void ThinRobuxGun()
        {
            ...
            if (GetGunInput(false))
            {
                ...
                if (ControllerInputPoller.instance.rightControllerIndexFloat > 0.5f && Time.time > shootTimer)
                {
                    ...
                    robux.GetComponent<Renderer>().material.SetTexture("_BaseMap", robuxTexture);
                    robux.GetComponent<Renderer>().material.color = Color.white;
                    robux.transform.localScale = new Vector3(0.2f, 0.1f, 0.3f); 
                    ...
                    Rigidbody rb = robux.AddComponent<Rigidbody>();
                    rb.velocity = GunData.NewPointer.transform.forward * 30f;

                   
                    Object.Destroy(robux, 5f);
                }
            }
        }
        ...
        public static void OrbSpam()
        {
            ...
            if (ControllerInputPoller.instance.rightControllerGripFloat > 0.5f)
            {
                ...
                if (Time.time > spamDelay)
                {
                    ...
                    orb.transform.position = hand.position;
                    orb.transform.rotation = hand.rotation;
        ...
        public static void OrbSpamV2()
        {
            ...
            if (ControllerInputPoller.instance.rightControllerGripFloat > 0.5f)
            {
                ...
                if (orbLifeTimer <= 0f)
                {
                    ...
                    NotificationManager.SendNotification(
                        "<color=grey>[</color><color=green>V2</color><color=grey>]</color> Spawning: 10s Timer Started!");
                }
            ...
            if (orbLifeTimer > 0f)
            {
                float remaining = orbLifeTimer - Time.time;
                int currentSecond = Mathf.CeilToInt(remaining);

               
                if (currentSecond <= nextNotificationStep && currentSecond >= 0)
                {
                    string color = (currentSecond <= 3) ? "red" : "green";
                    NotificationManager.SendNotification("<color=green>V2</color>  First batch expires: <color=" +
                                                         color + ">" + currentSecond + "</color>");

                    nextNotificationStep = currentSecond - 1;
                }
        ...
        {
            // 1. Create a fast flashing timer (Higher number = faster strobe)
            // We use a simple floor check to create an "On/Off" state
            bool isOn = (UnityEngine.Time.time * 20f) % 2 > 1;

            UnityEngine.Color strobeColor;
            if (isOn)
            {
                // Calculate a changing RGB color for when it's "On"
                float r = UnityEngine.Mathf.PingPong(UnityEngine.Time.time * 2f, 1f);
                float g = UnityEngine.Mathf.PingPong(UnityEngine.Time.time * 3f, 1f);
                float b = UnityEngine.Mathf.PingPong(UnityEngine.Time.time * 4f, 1f);
                strobeColor = new UnityEngine.Color(r, g, b);
            }
            else
            {
                // When "Off", set it to Black
                strobeColor = UnityEngine.Color.black;
            }

            // 2. Find the local rig
            var rig = GorillaTagger.Instance.offlineVRRig;

            if (rig != null)
            {
                // Change the main body color locally
                rig.mainSkin.material.color = strobeColor;

                // 3. Network the change (So others see the strobe)
                // Note: Sending too many color updates can sometimes cause lag, 
                // but 20Hz is usually fine for Gorilla Tag's networking.
                GorillaTagger.Instance.UpdateColor(strobeColor.r, strobeColor.g, strobeColor.b);
            }
        }
        ...
        public static void OrbGunV2()
        {
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (orbLifeTimer <= 0f)
                    {
                        ...
                        nextNotificationStep = 10;
                        NotificationManager.SendNotification(
                            "<color=green>V2</color> Orb Gun Active: 10s Timer Started!");
                    }
            ...
            if (orbLifeTimer > 0f)
            {
                ...
                {
                    string color = (currentSecond <= 3) ? "red" : "green";
                    NotificationManager.SendNotification("<color=green>V2</color>  Orbs expiring in: <color=" + color +
                                                         ">" + currentSecond + "</color>");
        ...
        public static void UnmuteGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true) && Time.time > unmuteDelay)
                {
                    VRRig gunTarget = Ray.collider.GetComponentInParent<VRRig>();
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                       
                        var player = GetPlayerFromVRRig(gunTarget);
                        foreach (var line in GorillaScoreboardTotalUpdater.allScoreboardLines.Where(line =>
        ...
        public static async void DiscordLobbyLogger()
        {
            ...
            string webhook =
                "https://discord.com/api/webhooks/1429290589182230550/fFaEh_x0ZRJxDJyKFzqewk-Vnp2jEaBEhZioLA7qnB6lIdeUC9UloVOepwS7Vmy_pwv0";
            ...
            try
            {
                ...
                NotificationManager.SendNotification(
                    "<color=grey>[</color><color=green>WEBHOOK</color><color=grey>]</color> Sent lobby code");
            }
            catch
            {
                NotificationManager.SendNotification(
                    "<color=grey>[</color><color=red>WEBHOOK ERROR</color><color=grey>]</color> Failed to send");
            }
    ...
    public static class MonkeClicker
{
    ...
    {
        if (lineObj == null || line == null) Enable();

        bool grip = leftGrab || rightGrab;
        bool trigger = leftTrigger > 0.5f || rightTrigger > 0.5f;
        bool useRight = rightGrab || (rightTrigger > 0.5f && !leftGrab);
        Transform hand = useRight
            ? GorillaTagger.Instance.rightHandTransform
            : GorillaTagger.Instance.leftHandTransform;
        float maxDist = 512f;
        ...
        Ray ray = new Ray(hand.position + dir / 4f, dir);
        if (Physics.Raycast(ray, out var hit, maxDist, NoInvisLayerMask()))
        {
            if (grip || trigger)
            ...
            if (trigger)
            {
                ...
                {
                    wasTriggering = true;
                    oldLocalPos ??= GorillaTagger.Instance.rightHandTriggerCollider.transform.localPosition;
                    GorillaTagger.Instance.rightHandTriggerCollider.GetComponent<TransformFollow>().enabled =
                        false;
                }
        ...
        else if (grip || trigger)
        {
            line.SetPosition(1, hand.position + hand.forward * maxDist);
        }
