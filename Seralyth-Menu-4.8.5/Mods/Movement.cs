...
namespace Seralyth.Mods
{
    public static class Movement
    {
        ...
        public static void ChangePlatformType(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Platform Type").overlapText =
                "Change Platform Type <color=grey>[</color><color=green>" + platformNames[platformMode] +
        ...
        public static void ChangePlatformShape(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Platform Shape").overlapText =
                "Change Platform Shape <color=grey>[</color><color=green>" + platformShapes[platformShape] +
                "</color><color=grey>]</color>";
        }
        ...
        {
            var (position, rotation, _, _, right) =
                left ? ControllerUtilities.GetTrueLeftHand() : ControllerUtilities.GetTrueRightHand();

            platform.transform.position = position;
            platform.transform.rotation = rotation;

            if (Buttons.GetIndex("Non-Sticky Platforms").enabled)
                platform.transform.position += right * ((left ? 1f : -1f) *
                                                        ((0.025f + platform.transform.localScale.x / 2f) *
                                                         (scaleWithPlayer ? GTPlayer.Instance.scale : 1f)));

            FriendManager.PlatformSpawned(true, platform.transform.position, platform.transform.rotation,
                platform.transform.localScale, GetPlatformPrimitiveType());
        }
        ...
        private static readonly Dictionary<bool, List<GameObject>> frozonicPlatforms =
            new Dictionary<bool, List<GameObject>>();
        ...
        public static void HandleFrozone(bool left)
        {
            ...
            if (grip)
            {
                ...
                platform.transform.position = position + (right * ((left ? 1f : -1f) *
                                                                   ((0.025f + platform.transform.localScale.x / 2f) *
                                                                    (scaleWithPlayer ? GTPlayer.Instance.scale : 1f))));
                platform.transform.rotation = rotation;
        ...
        public static void ChangeSpeedBoostAmount(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Speed Boost Amount").overlapText =
                "Change Speed Boost Amount <color=grey>[</color><color=green>" + speedNames[speedboostCycle] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void PlatformSpam()
        {
            if (rightGrab)
            {
                ...
                PhotonNetwork.RaiseEvent(69, new object[] { platform.transform.position, platform.transform.rotation },
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    PhotonNetwork.RaiseEvent(69,
                        new object[] { platform.transform.position, platform.transform.rotation },
                        new RaiseEventOptions { Receivers = ReceiverGroup.Others }, SendOptions.SendReliable);
                }
            }
        }
        ...
        public static void ChangeFlySpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Fly Speed").overlapText = "Change Fly Speed <color=grey>[</color><color=green>" +
                                                               speedNames[flySpeedCycle] +
                                                               "</color><color=grey>]</color>";
        }
        ...
        public static void ChangePlayspaceAbuseSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Playspace Abuse Speed").overlapText =
                "Change Playspace Abuse Speed <color=grey>[</color><color=green>" + speedNames[playspaceAbuseIndex] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void ChangeArmLength(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Arm Length").overlapText = "Change Arm Length <color=grey>[</color><color=green>" +
                                                                lengthNames[longarmCycle] +
                                                                "</color><color=grey>]</color>";
        }
        ...
        {
            if (Mathf.Abs(leftJoystick.x) > 0.3 || Mathf.Abs(leftJoystick.y) > 0.3 ||
                Mathf.Abs(rightJoystick.x) > 0.3 || Mathf.Abs(rightJoystick.y) > 0.3)
                BarkFly();
        }
        ...
        public static void HandFly()
        {
            ...
            {
                GTPlayer.Instance.transform.position +=
                    ControllerUtilities.GetTrueRightHand().forward * (Time.deltaTime * FlySpeed);
                GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
            }
        }
        ...
        public static void FlyTowardsGun()
        {
            if (GetGunInput(false))
            {
                ...
                {
                    GTPlayer.Instance.transform.position +=
                        (lockTarget.transform.position - GorillaTagger.Instance.bodyCollider.transform.position) *
                        (Time.deltaTime * FlySpeed);
                    GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
                }
        ...
        public static void FlyGun()
        {
            ...
            {
                var GunData = RenderGun();
                Vector3 hitPoint = GunData.Ray.point;

                if (GetGunInput(true))
                {
                    Vector3 direction = (hitPoint - GorillaTagger.Instance.bodyCollider.transform.position).normalized;
                    GTPlayer.Instance.transform.position += direction * (Time.deltaTime * FlySpeed);
                    GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
                }
            }
        }
        ...
        {
            if (rightPrimary)
                GorillaTagger.Instance.rigidbody.linearVelocity += GTPlayer.Instance.headCollider.transform.forward *
                                                                   (Time.deltaTime * (FlySpeed * 2));
        }
        ...
        public static void ZeroGravitySlingshotFly()
        {
            if (rightPrimary)
            {
                ZeroGravity();
                GorillaTagger.Instance.rigidbody.linearVelocity +=
                    GTPlayer.Instance.headCollider.transform.forward * (Time.deltaTime * FlySpeed);
            }
        }
            ...
            if (!menu)
            {
                ...
                if (W)
                    GorillaTagger.Instance.rigidbody.transform.position +=
                        GTPlayer.Instance.GetControllerTransform(false).parent.forward * (Time.deltaTime * speed);
                ...
                if (A)
                    GorillaTagger.Instance.rigidbody.transform.position +=
                        GTPlayer.Instance.GetControllerTransform(false).parent.right * (Time.deltaTime * -speed);
        ...
        public static void ChangeDriveSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("cdSpeed").overlapText = "Change Drive Speed <color=grey>[</color><color=green>" +
                                                      speedNames[driveInt] + "</color><color=grey>]</color>";
        }
        ...
        public static void ChangeFastRopesSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Fast Ropes Speed").overlapText =
                "Change Fast Ropes Speed <color=grey>[</color><color=green>" + speedNames[driveInt] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void Drive()
        {
            ...
            Physics.Raycast(GorillaTagger.Instance.bodyCollider.transform.position - new Vector3(0f, 0.2f, 0f),
                Vector3.down, out var Ray, 512f, GTPlayer.Instance.locomotionEnabledLayers);
            Vector3 targetVelocity = addition * driveSpeed;

            if (Ray.distance < 0.2f &&
                (Mathf.Abs(driveLerpDirection.x) > 0.05f || Mathf.Abs(driveLerpDirection.y) > 0.05f))
        ...
        public static void HardDrive()
        {
                ...
                closePosition == Vector3.zero)
            {
                ...
                Physics.Raycast(raycastPosition, Vector3.down, out var Ray, 50f,
        ...
        {
            if (Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position,
                    GorillaTagger.Instance.headCollider.transform.position) < 0.63f ||
                Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position,
                    GorillaTagger.Instance.headCollider.transform.position) < 0.63f)
                return;

            if (Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position,
                    GorillaTagger.Instance.rightHandTransform.position) < 1f)
                return;
            if (Physics.Raycast(GorillaTagger.Instance.bodyCollider.attachedRigidbody.position, Vector3.down,
                    hitInfo: out _, Physics.AllLayers))
                return;
            ...
            if (LeftHand.TryGetFeatureValue(UnityEngine.XR.CommonUsages.deviceVelocity, out Vector3 leftVel) &&
                RightHand.TryGetFeatureValue(UnityEngine.XR.CommonUsages.deviceVelocity, out Vector3 rightVel))
            {
                ...
                if (leftVel.y < -1.2f && rightVel.y < -1.2f)
                {
                    ...
                    GorillaTagger.Instance.bodyCollider.attachedRigidbody.AddForce(Vector3.up * force,
        ...
        private static BalloonHoldable GetTargetBalloon()
        {
            ...
            if (Time.time > loaoalsode)
            {
                NotificationManager.SendNotification(
                    "<color=grey>[</color><color=red>ERROR</color><color=grey>]</color> You must equip a balloon.");
        ...
        public static void GrapplingHooks()
        {
            if (leftGrab)
            {
                if (!isLeftGrappling)
                {
                    ...
                    GorillaTagger.Instance.rigidbody.linearVelocity +=
                        Vector3.Normalize(leftgrapplePoint - GorillaTagger.Instance.leftHandTransform.position) * 0.5f;
            ...
            if (rightGrab)
            {
                if (!isRightGrappling)
                {
                    ...
                    GorillaTagger.Instance.rigidbody.linearVelocity +=
                        Vector3.Normalize(rightgrapplePoint - GorillaTagger.Instance.rightHandTransform.position) *
                        0.5f;
        ...
        public static void NetworkedGrappleMods()
        {
            if (Buttons.GetIndex("Spider Man").enabled || Buttons.GetIndex("Grappling Hooks").enabled)
            {
                ...
                else
                {
                    ...
                    if (balloonState != BalloonHoldable.BalloonStates.Pop &&
                        balloonState != BalloonHoldable.BalloonStates.Waiting &&
                        balloonState != BalloonHoldable.BalloonStates.Refilling &&
                        balloonState != BalloonHoldable.BalloonStates.Returning)
                        tb.balloonState = BalloonHoldable.BalloonStates.Normal;
        ...
        public static void PortalGun()
        {
            if (portalGun == null)
            {
                ...
                LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portalgun_powerup.ogg",
                    "Audio/Mods/Movement/PortalGun/portalgun_powerup.ogg",
                    clip => Play2DAudio(clip, buttonClickVolume / 10f));
            }

            if (portalGun)
            {
                Transform RayPoint = portalGun.transform.Find("PortalGun/Ray");
                Physics.Raycast(RayPoint.position, RayPoint.forward, out var ray, 512f,
                    GTPlayer.Instance.locomotionEnabledLayers);
                ...
                if (crosshair)
                    crosshair.transform.position = ray.point == Vector3.zero
                ...
                if (rightTrigger > 0.5f && Time.time > portalDelay)
                {
                    ...
                    if (portalNotToUse && (Vector3.Distance(ray.point, portalNotToUse.transform.position) < 1f ||
                                           ray.point == Vector3.zero))
                    {
                        LoadSoundFromURL(
                            $"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portal_invalid.ogg",
                            "Audio/Mods/Movement/PortalGun/portal_invalid.ogg",
                            clip => Play2DAudio(clip, buttonClickVolume / 10f));
                    ...
                    LoadSoundFromURL(
                        $"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portalgun_blue.ogg",
                        "Audio/Mods/Movement/PortalGun/portalgun_blue.ogg",
                        clip => Play2DAudio(clip, buttonClickVolume / 10f));
                    ...
                    portalToUse.transform.rotation =
                        Quaternion.LookRotation(ray.normal, Vector3.up) * Quaternion.Euler(90, 0, 0);
                ...
                if (rightGrab && Time.time > flipDelay)
                {
                    ...
                    LoadSoundFromURL(
                        $"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portalgun_fizzle.ogg",
                        "Audio/Mods/Movement/PortalGun/portalgun_fizzle.ogg",
                        clip => Play2DAudio(clip, buttonClickVolume / 10f));
                ...
                if (bluePortal && orangePortal)
                {
                    ...
                    if (blueView.activeSelf && orangeView.activeSelf && !playedOpen)
                    {
                        ...
                        LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/{sound}",
                            $"Audio/Mods/Movement/PortalGun/{sound}",
                            clip => Play2DAudio(clip, buttonClickVolume / 10f));
                ...
                {
                    LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portal_close.ogg",
                        "Audio/Mods/Movement/PortalGun/portal_close.ogg",
                        clip => Play2DAudio(clip, buttonClickVolume / 10f));
            ...
            if (bluePortal && orangePortal)
            {
                ...
                {
                    if (Vector3.Distance(portal.transform.position,
                            GorillaTagger.Instance.bodyCollider.transform.position) < 0.6f)
                    {
                        goingThrough = true;
                        break;
                    }
                ...
                switch (goingThrough)
                {
                    case true when !inPortal:
                        LoadSoundFromURL(
                            $"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portal_enter1.ogg",
                            "Audio/Mods/Movement/PortalGun/portal_enter1.ogg",
                            clip => Play2DAudio(clip, buttonClickVolume / 10f));
                        break;
                    case false when inPortal:
                        LoadSoundFromURL(
                            $"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portal_exit1.ogg",
                            "Audio/Mods/Movement/PortalGun/portal_exit1.ogg",
                            clip => Play2DAudio(clip, buttonClickVolume / 10f));
                        break;
                }
                ...
                {
                    if (IsOverlapping(_.transform.Find("Rim/View").GetComponent<Collider>(),
                            ControllerUtilities.GetTrueLeftHand().position, 0.1f))
                    {
                ...
                {
                    if (IsOverlapping(_.transform.Find("Rim/View").GetComponent<Collider>(),
                            ControllerUtilities.GetTrueRightHand().position, 0.1f))
                    {
                ...
                {
                    if (IsOverlapping(_.transform.Find("Rim/View").GetComponent<Collider>(),
                            GTPlayer.Instance.bodyCollider.transform.position, 0.05f))
                    {
        ...
        {
            GameObject mainObject = LoadObject<GameObject>(orange ? "OrangePortal" : "BluePortal").transform
                .Find("Portal").gameObject;
            return mainObject;
        }
        ...
        {
            LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Movement/PortalGun/portal_exit1.ogg",
                "Audio/Mods/Movement/PortalGun/portal_exit1.ogg",
                clip => clip.PlayAt(obj.transform.position, buttonClickSound / 20f));
        ...
        public static void LeftAndRight()
        {
            ...
            if (rightTrigger > 0.5f)
                GorillaTagger.Instance.rigidbody.linearVelocity += GorillaTagger.Instance.bodyCollider.transform.right *
                                                                   (Time.deltaTime * FlySpeed * -3f);
        ...
        public static void ForwardsAndBackwards()
        {
            ...
            if (rightTrigger > 0.5f)
                GorillaTagger.Instance.rigidbody.linearVelocity +=
                    GorillaTagger.Instance.bodyCollider.transform.forward * (Time.deltaTime * FlySpeed * 3f);
        ...
        public static void AutoWalk()
        {
            ...
            if (Mathf.Abs(joy.y) > 0.05f || Mathf.Abs(joy.x) > 0.05f)
            {
                GorillaTagger.Instance.leftHandTransform.position =
                    ...
                    (Mathf.Sin(Time.time * animSpeed) * (joy.y * armLength)) +
                    GorillaTagger.Instance.bodyCollider.transform.right *
                    (Mathf.Sin(Time.time * animSpeed) * (joy.x * armLength) - 0.2f) +
            ...
            if (rightGrab)
            {
                if (bothHands)
                {
                    ...
                    GorillaTagger.Instance.rightHandTransform.position =
                        ...
                        GorillaTagger.Instance.headCollider.transform.right * -0.05f;
                    GorillaTagger.Instance.leftHandTransform.position =
                        GorillaTagger.Instance.headCollider.transform.position +
        ...
        public static void AutoPinchClimb()
        {
            if (rightGrab)
            {
                ...
                GorillaTagger.Instance.rightHandTransform.position =
                    GorillaTagger.Instance.headCollider.transform.position +
                    GorillaTagger.Instance.headCollider.transform.right * (0.4f + MathF.Cos(time) * 0.4f) +
                    GorillaTagger.Instance.headCollider.transform.up * (MathF.Sin(time) * 0.6f) +
                    GorillaTagger.Instance.headCollider.transform.forward * 0.75f;
                GorillaTagger.Instance.leftHandTransform.position =
                    GorillaTagger.Instance.headCollider.transform.position +
                    GorillaTagger.Instance.headCollider.transform.right * -(0.4f + MathF.Cos(time) * 0.4f) +
                    GorillaTagger.Instance.headCollider.transform.up * (MathF.Sin(time) * 0.6f) +
        ...
        public static void AutoBranch()
        {
            ...
            if (rightGrab)
            {
                ...
                foreach (Vector3 treeBranchPos in GetAllTreeBranchPositions())
                {
                    ...
                    float dot = Vector3.Dot(treeBranchPos - compareDist,
                        GorillaTagger.Instance.bodyCollider.transform.right);
            ...
            if (isOnBranch)
                GorillaTagger.Instance.rigidbody.linearVelocity =
                    GTPlayer.Instance.headCollider.transform.forward * 10f;
        ...
        public static void ChangeMacroPlaybackRange(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Macro Playback Range").overlapText =
                "Change Macro Playback Range <color=grey>[</color><color=green>" + rangeNames[macroPlaybackRangeIndex] +
                "</color><color=grey>]</color>";
        }
        ...
        public struct PlayerPosition
        {
            ...
            public static PlayerPosition CurrentPosition() =>
                new PlayerPosition
                {
                    ...
                    leftHand = (GorillaTagger.Instance.leftHandTransform.position,
                        GorillaTagger.Instance.leftHandTransform.rotation),
                    rightHand = (GorillaTagger.Instance.rightHandTransform.position,
                        GorillaTagger.Instance.rightHandTransform.rotation),
        ...
        public class Macro
        {
            ...
            public static Macro LoadJSON(string json)
            {
                ...
                macro.macroStepDuration =
                    obj.TryGetValue("step-time", out JToken stepTimeToken) ? (float)stepTimeToken : 0.1f;
        ...
        public static void LoadMacros()
        {
            ...
            List<ButtonInfo> buttons = new List<ButtonInfo>
            {
                new ButtonInfo
                {
                    buttonText = "Exit Macros", method = () => Buttons.CurrentCategoryName = "Movement Mods",
                    isTogglable = false, toolTip = "Returns you back to the movement mods."
                },
            };
            ...
            foreach (KeyValuePair<string, Macro> macroData in macros)
            {
                ...
                {
                    buttonText = $"Macro{macroName}", overlapText = macro.name, enabled = macro.enabled,
                    enableMethod = () => ToggleMacro(macroName, true), method = () => ExecuteMacroButton(macro),
                    disableMethod = () => ToggleMacro(macroName, false),
            ...
            buttons.AddRange(new[]
            {
                new ButtonInfo
                {
                    ...
                    method = RecordMacro, toolTip = "Record your macros with your <color=green>left trigger</color>."
                },
                new ButtonInfo
                {
                    buttonText = "Macro Gun", method = MacroGun,
                    toolTip = "Record your macros using a <color=green>gun</color>. Grip to aim, trigger to record."
                },
                new ButtonInfo
                {
                    buttonText = "Open Macros Folder", method = OpenMacrosFolder, isTogglable = false,
                    toolTip = "Opens the folder in which your plugins are located."
                },
                new ButtonInfo
                {
                    buttonText = "Reload Macros", method = LoadMacros, isTogglable = false,
        ...
        public static void RecordMacro()
        {
            if (leftTrigger > 0.5f)
            {
                if (!recordingMacro)
                {
                    ...
                    NotificationManager.SendNotification(
                        "<color=grey>[</color><color=green>RECORDING</color><color=grey>]</color> Started recording...");
                }
            ...
            else
            {
                if (recordingMacro)
                {
                    ...
                    NotificationManager.SendNotification(
                        "<color=grey>[</color><color=green>RECORDING</color><color=grey>]</color> Stopped recording.");
                    FinalizeRecording();
                }
            }
        }
        ...
        public static void MacroGun()
        {
            if (GetGunInput(false))
            {
                if (!gunLocked)
                {
                    VRRig target = RenderGun().Ray.collider.GetComponentInParent<VRRig>();
                    if (target != null && !target.IsLocal() && GetGunInput(true))
                    {
                        lockTarget = target;
                        gunLocked = true;
                        ...
                        recordingMacro = true;
                        NotificationManager.SendNotification(
                            $"<color=grey>[</color><color=green>MACRO GUN</color><color=grey>]</color> Recording <color=green>{target.GetName()}</color>...");
                    }
                }

                RenderGun();

                if (gunLocked && lockTarget != null && recordingMacro && Time.time > positionDelay)
                {
                    positionDelay = Time.time + defaultMacroStep;
                    Rigidbody targetRb = lockTarget.GetComponent<Rigidbody>();
                    recordingData.Add(new PlayerPosition
                    {
                        position = lockTarget.transform.position,
                        velocity = targetRb != null ? targetRb.linearVelocity : Vector3.zero,
                        leftHand = (lockTarget.leftHandTransform.position, lockTarget.leftHandTransform.rotation),
                        rightHand = (lockTarget.rightHandTransform.position, lockTarget.rightHandTransform.rotation),
                        leftGrip = false,
                        rightGrip = false,
                        leftTrigger = false,
                        rightTrigger = false
                ...
                if (!GetGunInput(true))
                {
                    if (recordingMacro)
                    {
                        recordingMacro = false;
                        NotificationManager.SendNotification(
                            "<color=grey>[</color><color=green>MACRO GUN</color><color=grey>]</color> Stopped recording.");
                        FinalizeRecording();
                    }
        ...
        public static IEnumerator PlayMacro(Macro macro, int startFromPosition = 0)
        {
            ...
            while (Time.time < macroStartTime + macroEndTime)
            {
                ...
                GorillaTagger.Instance.rigidbody.linearVelocity =
                    lastPosition.velocity.Lerp(currentPosition.velocity, t);

                GorillaTagger.Instance.leftHandTransform.position =
                    lastPosition.leftHand.position.Lerp(currentPosition.leftHand.position, t);
                GorillaTagger.Instance.leftHandTransform.rotation =
                    lastPosition.leftHand.rotation.Lerp(currentPosition.leftHand.rotation, t);

                GorillaTagger.Instance.rightHandTransform.position =
                    lastPosition.rightHand.position.Lerp(currentPosition.rightHand.position, t);
                GorillaTagger.Instance.rightHandTransform.rotation =
                    lastPosition.rightHand.rotation.Lerp(currentPosition.rightHand.rotation, t);

                ControllerInputPoller.instance.leftControllerGripFloat = Mathf.Lerp(lastPosition.leftGrip ? 1f : 0f,
                    currentPosition.leftGrip ? 1f : 0f, t);
                ControllerInputPoller.instance.rightControllerGripFloat = Mathf.Lerp(lastPosition.rightGrip ? 1f : 0f,
                    currentPosition.rightGrip ? 1f : 0f, t);
                ControllerInputPoller.instance.leftControllerIndexFloat = Mathf.Lerp(lastPosition.leftTrigger ? 1f : 0f,
                    currentPosition.leftTrigger ? 1f : 0f, t);
                ...
                if (currentMacroPosition + (int)(1 / macro.macroStepDuration) < positions.Count)
                {
                    PlayerPosition futurePosition =
                        positions[currentMacroPosition + (int)(1 / macro.macroStepDuration)];
        ...
        {
            Visuals.VisualizeCube(position.position, Quaternion.LookRotation(position.velocity),
                new Vector3(0.1f, 0.1f, 0.25f), color, -39228393, alpha);
            Visuals.VisualizeCube(position.position + position.velocity.normalized * 0.125f,
                Quaternion.LookRotation(position.velocity), new Vector3(0.15f, 0.15f, 0.05f), color, -48492012, alpha);
        ...
        public static Dictionary<Color, (GameObject head, GameObject leftHand, GameObject rightHand)> positions =
            new Dictionary<Color, (GameObject head, GameObject leftHand, GameObject rightHand)>();
        ...
        public static void VisualizePositionCoroutine(PlayerPosition position, Color color)
        {
            ...
            {
                data = (
                    Visuals.VisualizeCubeObject(position.position, Quaternion.LookRotation(position.velocity),
                        new Vector3(0.1f, 0.1f, 0.25f), color),
                    Visuals.VisualizeAuraObject(position.leftHand.position, 0.15f, color),
                    Visuals.VisualizeAuraObject(position.rightHand.position, 0.15f, color));
        ...
        public static void ExecuteMacroButton(Macro macro)
        {
            ...
            if (midpointMacros)
            {
                position = macro.positions
                    ...
                    {
                        position, index,
                        distance = Vector3.Distance(GorillaTagger.Instance.bodyCollider.transform.position,
                            position.position)
                    })
            ...
            if (frameStepper)
            {
                ...
                {
                    NotificationManager.SendNotification(
                        "<color=grey>[</color><color=green>MACRO</color><color=grey>]</color> Frame Stepper is on. Hit the A button to progress instead.");
            ...
            bool doMacro = !directionBased || (GorillaTagger.Instance.rigidbody.linearVelocity.magnitude > 2f &&
                                               Vector3.Angle(startPosition.velocity.normalized,
                                                   GorillaTagger.Instance.rigidbody.linearVelocity.normalized) < 70f);

            VisualizePlayerPosition(startPosition, doMacro ? buttonColors[1].GetCurrentColor() : Color.white,
                doMacro ? 0.15f : 0.05f);
            if (doMacro)
        ...
        public static void ChangeWallWalkStrength(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Wall Walk Strength").overlapText =
                "Change Wall Walk Strength <color=grey>[</color><color=green>" + strengthNames[wallWalkStrengthIndex] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void LegitimateWallWalk()
        {
            ...
            if (leftGrab && (leftWallWalk || bothHands))
            {
                ...
                if (Physics.Raycast(ControllerUtilities.GetTrueLeftHand().position, -ray.normal, out var Ray, range,
                        GTPlayer.Instance.locomotionEnabledLayers))
            ...
            if (rightGrab && (!leftWallWalk || bothHands))
            {
                ...
                if (Physics.Raycast(ControllerUtilities.GetTrueRightHand().position, -ray.normal, out var Ray, range,
                        GTPlayer.Instance.locomotionEnabledLayers))
                    GorillaTagger.Instance.rigidbody.AddForce(Ray.normal * power, ForceMode.Acceleration);
            }
        }
        ...
        public static void SpiderWalk()
        {
            ...
            if (walkPos != Vector3.zero)
            {
                ...
                GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.Lerp(
                    GTPlayer.Instance.GetControllerTransform(false).parent.rotation,
                    Quaternion.LookRotation(walkNormal) * Quaternion.Euler(90f, 0f, 0f), Time.deltaTime);
                ZeroGravity();
            }
        }
        ...
        public static void EnterTeleportToMap() // Credits to Malachi for some of the positions
        {
            ...
            List<ButtonInfo> tpbuttons = new List<ButtonInfo>
            {
                new ButtonInfo
                {
                    buttonText = "Exit Teleport to Map", method = ExitTeleportToMap, isTogglable = false,
            ...
            foreach (string[] Data in mapData)
                ...
                {
                    buttonText = "TeleportMap" + tpbuttons.Count, overlapText = Data[0],
                    method = () => TeleportToMap(Data[1], Data[2]), isTogglable = false,
        ...
        public static void AdvancedCheckpoints()
        {
            if (rightGrab)
            {
                ...
                foreach (var checkpoint in checkpoints.Where(checkpoint =>
                             Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position,
                                 checkpoint.transform.position) < 0.2f))
                {
            ...
            if (rightTrigger > 0.5f)
            {
                foreach (var checkpoint in checkpoints.ToList().Where(checkpoint =>
                             Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position,
                                 checkpoint.transform.position) < 0.2f))
                {
        ...
        public static void Bomb()
        {
            ...
            if (BombObject != null)
            {
                if (rightPrimary)
                {
                    Vector3 dir = GorillaTagger.Instance.bodyCollider.transform.position -
            ...
            if (rightGrab || leftGrab)
            {
                if (pearl == null)
                {
                    ...
                    if (pearlmat == null)
                    {
                        ...
                        if (pearltxt == null)
                        {
                            pearltxt = LoadTextureFromURL(
                                $"{PluginInfo.ServerResourcePath}/Images/Mods/Movement/pearl.png",
                                "Images/Mods/Movement/pearl.png");
            ...
            else
            {
                if (pearl != null)
                {
                    ...
                    Physics.Raycast(pearl.transform.position, pearl.GetComponent<Rigidbody>().linearVelocity,
                        out var Ray, 0.25f, GTPlayer.Instance.locomotionEnabledLayers);
        ...
        public static void FunMove() =>
            GorillaTagger.Instance.rigidbody.linearVelocity +=
                GorillaTagger.Instance.rigidbody.linearVelocity * Time.deltaTime;
        ...
        public static void DynamicSpeedBoost()
        {
            ...
            VRRig closestRig = VRRigCache.ActiveRigs
                ...
                .OrderBy(rig =>
                    Vector3.Distance(rig.transform.position, GorillaTagger.Instance.bodyCollider.transform.position))
                .FirstOrDefault();

            float rigDistance = closestRig == null
                ? float.MaxValue
                : Vector3.Distance(GorillaTagger.Instance.bodyCollider.transform.position,
                    closestRig.transform.position);
        ...
        public static void SpazHands()
        {
            if (rightPrimary)
            {
                ...
                VRRig.LocalRig.leftHand.rigTarget.transform.position =
                    GorillaTagger.Instance.leftHandTransform.position +
                    VRRig.LocalRig.leftHand.rigTarget.transform.forward * 3f;
                VRRig.LocalRig.rightHand.rigTarget.transform.position =
                    GorillaTagger.Instance.rightHandTransform.position +
                    VRRig.LocalRig.rightHand.rigTarget.transform.forward * 3f;
            }
            else
                VRRig.LocalRig.enabled = true;
        }
        ...
        public static void SpazRealHands()
        {
            if (rightPrimary)
            {
                ...
                GTPlayer.Instance.GetControllerTransform(true).position =
                    GorillaTagger.Instance.leftHandTransform.position +
                    GTPlayer.Instance.GetControllerTransform(true).forward * 3f;
                ...
                GTPlayer.Instance.GetControllerTransform(false).position =
                    GorillaTagger.Instance.rightHandTransform.position +
                    GTPlayer.Instance.GetControllerTransform(false).forward * 3f;
            }
            else
                VRRig.LocalRig.enabled = true;
        }
        ...
        public static void ParalyzeRig()
        {
            ...
            VRRig.LocalRig.leftHand.rigTarget.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.position +
                GorillaTagger.Instance.bodyCollider.transform.right * -0.08f +
                GorillaTagger.Instance.bodyCollider.transform.up * 0.12f;
            VRRig.LocalRig.rightHand.rigTarget.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.position +
                GorillaTagger.Instance.bodyCollider.transform.right * 0.08f +
                GorillaTagger.Instance.bodyCollider.transform.up * 0.12f;
            ...
            VRRig.LocalRig.leftHand.rigTarget.transform.rotation =
                GorillaTagger.Instance.bodyCollider.transform.rotation * Quaternion.Euler(0f, 180f, 180f);
            VRRig.LocalRig.rightHand.rigTarget.transform.rotation =
                GorillaTagger.Instance.bodyCollider.transform.rotation * Quaternion.Euler(0f, 180f, 180f);
        }
        ...
        public static void ChickenRig()
        {
            ...
            VRRig.LocalRig.leftHand.rigTarget.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.position +
                GorillaTagger.Instance.bodyCollider.transform.right * 0.2f +
                GorillaTagger.Instance.bodyCollider.transform.up * -0.2f;
            VRRig.LocalRig.rightHand.rigTarget.transform.position =
                GorillaTagger.Instance.bodyCollider.transform.position +
                GorillaTagger.Instance.bodyCollider.transform.right * -0.2f +
                GorillaTagger.Instance.bodyCollider.transform.up * -0.2f;
        ...
        public static void FreezeBodyRotation()
        {
            ...
            recBodyRotary.transform.rotation = rightGrab
                ? recBodyRotary.transform.rotation
                : Quaternion.Euler(0f, GorillaTagger.Instance.headCollider.transform.rotation.eulerAngles.y, 0f);
        }
        ...
        public static void AutoDance()
        {
            if (rightPrimary)
            {
                ...
                Vector3 bodyOffset =
                    GorillaTagger.Instance.bodyCollider.transform.right * (Mathf.Cos(Time.frameCount / 20f) * 0.3f) +
                    new Vector3(0f, Mathf.Abs(Mathf.Sin(Time.frameCount / 20f) * 0.2f), 0f);
                VRRig.LocalRig.transform.position = GorillaTagger.Instance.bodyCollider.transform.position +
                                                    new Vector3(0f, 0.15f, 0f) + bodyOffset;
                VRRig.LocalRig.transform.rotation = GorillaTagger.Instance.bodyCollider.transform.rotation;
                ...
                VRRig.LocalRig.leftHand.rigTarget.transform.position = VRRig.LocalRig.transform.position +
                                                                       VRRig.LocalRig.transform.forward * 0.2f +
                                                                       VRRig.LocalRig.transform.right * -0.4f +
                                                                       VRRig.LocalRig.transform.up *
                                                                       (0.3f + Mathf.Sin(Time.frameCount / 20f) * 0.2f);
                VRRig.LocalRig.rightHand.rigTarget.transform.position = VRRig.LocalRig.transform.position +
                                                                        VRRig.LocalRig.transform.forward * 0.2f +
                                                                        VRRig.LocalRig.transform.right * 0.4f +
                                                                        VRRig.LocalRig.transform.up *
                                                                        (0.3f + Mathf.Sin(Time.frameCount / 20f) *
                                                                            -0.2f);
        ...
        public static void Helicopter()
        {
            if (rightPrimary)
            {
                ...
                VRRig.LocalRig.transform.rotation =
                    Quaternion.Euler(VRRig.LocalRig.transform.rotation.eulerAngles + new Vector3(0f, 10f, 0f));
        ...
        public static void StillBeyblade()
        {
            if (rightPrimary)
            {
                if (stillBeybladeStartPos == Vector3.zero)
                    stillBeybladeStartPos = GorillaTagger.Instance.bodyCollider.transform.position +
                                            new Vector3(0f, 0.15f, 0f);
        ...
        public static void Fan()
        {
            if (rightPrimary)
            {
                ...
                VRRig.LocalRig.leftHand.rigTarget.transform.position = VRRig.LocalRig.transform.position +
                                                                       (VRRig.LocalRig.transform.up *
                                                                        (Mathf.Cos(Time.time * 15f) * 2f) +
                                                                        VRRig.LocalRig.transform.right *
        ...
        public static void GhostAnimations()
        {
            ...
            if (Vector3.Distance(handPos_L, GorillaTagger.Instance.leftHandTransform.transform.position) >
                positionThreshold)
                handPos_L +=
                    Vector3.Normalize(GorillaTagger.Instance.leftHandTransform.transform.position - handPos_L) *
                    positionSpeed;

            if (Quaternion.Angle(Quaternion.Euler(handRot_L),
                    GorillaTagger.Instance.leftHandTransform.transform.rotation) > rotationThreshold)
            ...
            if (Vector3.Distance(handPos_R, GorillaTagger.Instance.rightHandTransform.transform.position) >
                positionThreshold)
                handPos_R +=
                    Vector3.Normalize(GorillaTagger.Instance.rightHandTransform.transform.position - handPos_R) *
                    positionSpeed;
        ...
        public static void MinecraftAnimations()
        {
            ...
            if (rightPrimary)
            {
                VRRig.LocalRig.leftHand.rigTarget.transform.position =
                    GorillaTagger.Instance.bodyCollider.transform.position +
                    GorillaTagger.Instance.bodyCollider.transform.right * -0.25f +
                    GorillaTagger.Instance.bodyCollider.transform.up * -1f +
                    GorillaTagger.Instance.bodyCollider.transform.forward * Mathf.Sin(Time.frameCount / 10f);
                VRRig.LocalRig.rightHand.rigTarget.transform.position =
                    GorillaTagger.Instance.bodyCollider.transform.position +
                    GorillaTagger.Instance.bodyCollider.transform.right * 0.25f +
                    GorillaTagger.Instance.bodyCollider.transform.up * -1f +
            ...
            if (rightSecondary)
            {
                VRRig.LocalRig.rightHand.rigTarget.transform.position =
                    GorillaTagger.Instance.bodyCollider.transform.position +
                    GorillaTagger.Instance.bodyCollider.transform.right * 0.25f + Vector3.Lerp(
                        GorillaTagger.Instance.rightHandTransform.forward,
                        -GorillaTagger.Instance.rightHandTransform.up, 0.5f) * 2f;
                VRRig.LocalRig.rightHand.rigTarget.transform.rotation =
                    GorillaTagger.Instance.rightHandTransform.rotation;
            }
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    VRRig.LocalRig.head.rigTarget.transform.rotation =
                        Quaternion.LookRotation(
                            Vector3.Normalize(GetVRRigFromPlayer(Player).headMesh.transform.position));
        ...
        public static void EyeContact()
        {
            ...
            {
                if (Physics.SphereCast(rig.headMesh.transform.position + (rig.headMesh.transform.forward * 0.25f),
                        0.25f, rig.headMesh.transform.forward, out _, 512f, NoInvisLayerMask()))
                {
        ...
        public static void FloatingRig() =>
            VRRig.LocalRig.head.trackingPositionOffset =
                offsetH + new Vector3(0f, 0.65f + Mathf.Sin(Time.frameCount / 40f) * 0.2f, 0f);
        ...
        public static void VRRigLateUpdate_Dinnerbone() =>
            VRRig.LocalRig.transform.RotateAround(VRRig.LocalRig.bodyTransform.position, Camera.main.transform.forward,
                180f);
        ...
        private static readonly Dictionary<GorillaSurfaceOverride, float> velocityArchive =
            new Dictionary<GorillaSurfaceOverride, float>();

        public static void SlipSlap()
        {
            foreach (var surface in GetAllType<GorillaSurfaceOverride>())
            {
                float slidePercent = surface.slidePercentageOverride > 0f
                    ? surface.slidePercentageOverride
                    : GTPlayer.Instance.materialData[surface.overrideIndex].slidePercent;
                if (slidePercent > 0f)
                {
        ...
        public static void ClimbyHands()
        {
            ...
            if (leftGrab)
            {
                if (GTPlayer.Instance.IsHandTouching(true) && !leftisclimbing)
                {
                    ...
                    leftisclimbing = true;
                    GTPlayer.Instance.BeginClimbing(climb.AddComponent<GorillaClimbable>(),
                        GetObject(
                                "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHand Controller/GorillaHandClimber")
                            .GetComponent<GorillaHandClimber>());
                }
            }
            else
            ...
            if (rightGrab)
            {
                if (GTPlayer.Instance.IsHandTouching(false) && !rightisclimbing)
                {
                    ...
                    GTPlayer.Instance.BeginClimbing(climb.AddComponent<GorillaClimbable>(),
                        GetObject(
                                "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/RightHand Controller/GorillaHandClimber")
                            .GetComponent<GorillaHandClimber>());
                }
            }
            else
        ...
        public static void PunchMod()
        {
            ...
            foreach (var vrrig in VRRigCache.ActiveRigs.Where(vrrig => !vrrig.isLocal))
            {
                ...
                if (distance < 0.25f)
                    GorillaTagger.Instance.rigidbody.linearVelocity +=
                        Vector3.Normalize(vrrig.rightHandTransform.position - lastRight[index]) * 10f;
                ...
                if (distance < 0.25f)
                    GorillaTagger.Instance.rigidbody.linearVelocity +=
                        Vector3.Normalize(vrrig.leftHandTransform.position - lastLeft[index]) * 10f;
        ...
        public static void Telekinesis()
        {
                    ...
                    try
                    {
                        if (!vrrig.isLocal)
                        {
                            if (vrrig.rightIndex.calcT < 0.5f && vrrig.rightMiddle.calcT > 0.5f)
                            {
                                ...
                                Physics.SphereCast(vrrig.rightHandTransform.position + dir * 0.1f, 0.3f, dir,
                            ...
                            if (vrrig.leftIndex.calcT < 0.5f && vrrig.leftMiddle.calcT > 0.5f)
                            {
                                ...
                                Physics.SphereCast(vrrig.leftHandTransform.position + dir * 0.1f, 0.3f, dir,
                                    out var Ray, 512f, NoInvisLayerMask());
                                {
                                    VRRig gunTarget = Ray.collider.GetComponentInParent<VRRig>();
                                    if (gunTarget && gunTarget.isLocal)
            ...
            {
                if (sithright
                        ? sithlord.rightIndex.calcT < 0.5f && sithlord.rightMiddle.calcT > 0.5f
                        : sithlord.leftMiddle.calcT < 0.5f && sithlord.leftMiddle.calcT > 0.5f)
                {
                    Transform hand = sithright ? sithlord.rightHandTransform : sithlord.leftHandTransform;
                    Vector3 dir = sithright
                        ? sithlord.transform.Find("rig/hand.R").up
                        : sithlord.transform.Find("rig/hand.L").up;
                    TeleportPlayer(Vector3.Lerp(GorillaTagger.Instance.bodyCollider.transform.position,
                        hand.position + dir * sithdist, 0.1f));
                    GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
                    ZeroGravity();
                }
                else
        ...
        public static void SafetyBubble()
        {
            foreach (VRRig rig in
                     VRRigCache.ActiveRigs
                         .Where(rig => rig != null && !rig.isLocal)
                         .OrderBy(rig => Vector3.Distance(rig.transform.position,
                             GorillaTagger.Instance.bodyCollider.transform.position)))
            {
                if (Vector3.Distance(rig.transform.position, GorillaTagger.Instance.bodyCollider.transform.position) <
                    2f)
                {
        ...
        public static readonly Dictionary<VRRig, List<GameObject>> RigColliders =
            new Dictionary<VRRig, List<GameObject>>();
        ...
        public static void ChangePullModPower(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Pull Mod Power").overlapText =
                "Change Pull Mod Power <color=grey>[</color><color=green>" + powerNames[pullPowerInt] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void ProcessPullHand(bool left)
        {
            ...
            if (!touchingGround && wasTouchingGround)
            {
                ...
                GTPlayer.Instance.transform.position +=
                    ...
                    (direction.magnitude / GTPlayer.Instance.maxJumpSpeed * (pullPower * 5f)) *
                    (scaleWithPlayer ? GTPlayer.Instance.scale : 1f);
            }
        ...
        public static void ThrowControllers()
        {
            if (leftPrimary)
            {
                ...
                else
                {
                    ...
                    {
                        if (GetObject(
                                    "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHand Controller")
                                .GetComponent<GorillaVelocityEstimator>() == null)
                            GetObject(
                                    "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHand Controller")
                                .AddComponent<GorillaVelocityEstimator>();

                        comp.angularVelocity =
                            GetObject(
                                    "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHand Controller")
                                .GetComponent<GorillaVelocityEstimator>().angularVelocity;
                    }
                    catch
                    {
                    }
            ...
            if (rightPrimary)
            {
                ...
                else
                {
                    ...
                    {
                        if (GetObject(
                                    "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/RightHand Controller")
                                .GetComponent<GorillaVelocityEstimator>() == null)
                            GetObject(
                                    "Player Objects/Player VR Controller/GorillaPlayer/TurnParent/RightHand Controller")
                                .AddComponent<GorillaVelocityEstimator>();
        ...
        public static void ControllerFlick()
        {
            if (leftPrimary)
            {
                ...
                if (rigidbody.isKinematic)
                {
                    ...
                    rigidbody.linearVelocity =
                        rigidbody.GetComponent<GorillaVelocityTracker>().GetAverageVelocity(true, 0);
                }

                GorillaTagger.Instance.leftHandTransform.position =
                    GorillaTagger.Instance.headCollider.transform.position - flickLeft.transform.position;
            ...
            else
            {
                ...
                flickLeft.transform.position = GorillaTagger.Instance.headCollider.transform.position -
                                               GorillaTagger.Instance.leftHandTransform.position;
            ...
            if (rightPrimary)
            {
                ...
                GorillaTagger.Instance.rightHandTransform.position =
                    GorillaTagger.Instance.headCollider.transform.position - flickRight.transform.position;
            ...
            else
            {
                Rigidbody rigidbody = flickRight.GetComponent<Rigidbody>();
                rigidbody.isKinematic = true;
                flickRight.transform.position = GorillaTagger.Instance.headCollider.transform.position -
                                                GorillaTagger.Instance.rightHandTransform.position;
        ...
        {
            GTPlayer.Instance.GetControllerTransform(true).transform.position =
                GorillaTagger.Instance.leftHandTransform.position + GorillaTagger.Instance.leftHandTransform.forward *
                ((armlength - 0.917f) * GTPlayer.Instance.scale);
            GTPlayer.Instance.GetControllerTransform(false).transform.position =
                GorillaTagger.Instance.rightHandTransform.position + GorillaTagger.Instance.rightHandTransform.forward *
                ((armlength - 0.917f) * GTPlayer.Instance.scale);
        }
        ...
        public static void MultipliedLongArms()
        {
            GTPlayer.Instance.GetControllerTransform(true).transform.position =
                GorillaTagger.Instance.headCollider.transform.position -
                (GorillaTagger.Instance.headCollider.transform.position -
                 GorillaTagger.Instance.leftHandTransform.position) * armlength;
            GTPlayer.Instance.GetControllerTransform(false).transform.position =
                GorillaTagger.Instance.headCollider.transform.position -
                (GorillaTagger.Instance.headCollider.transform.position -
                 GorillaTagger.Instance.rightHandTransform.position) * armlength;
        }

        public static void VerticalLongArms()
        {
            Vector3 lefty = GorillaTagger.Instance.headCollider.transform.position -
                            GorillaTagger.Instance.leftHandTransform.position;
            lefty.y *= armlength;
            Vector3 righty = GorillaTagger.Instance.headCollider.transform.position -
                             GorillaTagger.Instance.rightHandTransform.position;
            righty.y *= armlength;
            GTPlayer.Instance.GetControllerTransform(true).transform.position =
                GorillaTagger.Instance.headCollider.transform.position - lefty;
            GTPlayer.Instance.GetControllerTransform(false).transform.position =
                GorillaTagger.Instance.headCollider.transform.position - righty;
        }
        ...
        public static void ChangePredictionAmount(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Prediction Amount").overlapText =
                "Change Prediction Amount <color=grey>[</color><color=green>" + predAmntNames[predInt] +
                "</color><color=grey>]</color>";
        }
        ...
        public static void VelocityLongArms()
        {
            ...
            rvT.transform.position = GorillaTagger.Instance.headCollider.transform.position -
                                     GorillaTagger.Instance.rightHandTransform.position;
            GTPlayer.Instance.GetControllerTransform(true).transform.position -=
                lvT.GetComponent<GorillaVelocityTracker>().GetAverageVelocity(true, 0) * predCount;
            GTPlayer.Instance.GetControllerTransform(false).transform.position -=
                rvT.GetComponent<GorillaVelocityTracker>().GetAverageVelocity(true, 0) * predCount;
        }
        ...
        public static void ChangeFakeLagStrength(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Fake Lag Strength").overlapText =
                "Change Fake Lag Strength <color=grey>[</color><color=green>" + fakeLagDelayIndex +
                "</color><color=grey>]</color>";
        }
        ...
        public static void ChangeTimerSpeed(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Timer Speed").overlapText =
                "Change Timer Speed <color=grey>[</color><color=green>" + (timerPowerIndex / 10f) +
                "</color><color=grey>]</color>";
        }
        ...
        public static void FlickJump()
        {
            if (rightPrimary)
                GTPlayer.Instance.GetControllerTransform(false).transform.position =
                    GorillaTagger.Instance.rightHandTransform.position + new Vector3(0f, -1.5f, 0f);
        }
        ...
        public static void BunnyHop()
        {
            ...
            if (Ray.distance < 0.15f)
                GorillaTagger.Instance.rigidbody.linearVelocity = new Vector3(
                    GorillaTagger.Instance.rigidbody.linearVelocity.x, GTPlayer.Instance.jumpMultiplier * 2.727272727f,
        ...
        public static void Strafe()
        {
            Vector3 direction = Buttons.GetIndex("Hand Oriented Strafe").enabled
                ? new Vector3(-GorillaTagger.Instance.rightHandTransform.up.x, 0f,
                    -GorillaTagger.Instance.rightHandTransform.up.z).normalized
                : GorillaTagger.Instance.bodyCollider.transform.forward;

            float power = GTPlayer.Instance.maxJumpSpeed;
            Vector3 velocity = direction * power;

            GorillaTagger.Instance.rigidbody.linearVelocity = new Vector3(velocity.x,
                GorillaTagger.Instance.rigidbody.linearVelocity.y, velocity.z);
        }
        ...
        public static void DynamicStrafe()
        {
            ...
            float power = new Vector3(GorillaTagger.Instance.rigidbody.linearVelocity.x, 0,
                GorillaTagger.Instance.rigidbody.linearVelocity.z).magnitude;
            Vector3 velocity = direction * power;
        ...
        public static void AirSwim()
        {
            if (airSwimPart == null)
            {
                airSwimPart = Object.Instantiate(GetObject(
                    "Environment Objects/LocalObjects_Prefab/ForestToBeach/ForestToBeach_Prefab_V4/ForestToBeach_Geo/CaveWaterVolume"));
            ...
            else
            {
                ...
                airSwimPart.transform.position =
                    GorillaTagger.Instance.headCollider.transform.position + new Vector3(0f, 2.5f, 0f);
            }
        }
        ...
        public static void GiveSwimGun()
        {
            if (GetGunInput(false))
            {
                var result = RenderGun(null);
                RaycastHit hit = result.Item1;

                if (GetGunInput(true) && Time.time > giveSwimDelay)
                {
                    VRRig target = hit.collider.GetComponentInParent<VRRig>();
                    if (target && !target.isOfflineVRRig)
                    {
                        giveSwimDelay = Time.time + 0.5f;
                        gunLocked = !gunLocked;
                        lockTarget = gunLocked ? target : null;

                        if (gunLocked && giveSwimWater == null)
                        {
                            giveSwimWater = Object.Instantiate(GetObject(
                                "Environment Objects/LocalObjects_Prefab/ForestToBeach/ForestToBeach_Prefab_V4/ForestToBeach_Geo/CaveWaterVolume"));
                            giveSwimWater.transform.localScale = new Vector3(5f, 5f, 5f);
                            giveSwimWater.GetComponent<Renderer>().enabled = false;
                        }
                        else if (!gunLocked && giveSwimWater != null)
                        {
                            Object.Destroy(giveSwimWater);
                            giveSwimWater = null;
                        }
                    }
                }

                if (gunLocked && lockTarget != null && giveSwimWater != null)
                {
                    GTPlayer.Instance.audioManager.UnsetMixerSnapshot();
                    giveSwimWater.transform.position = lockTarget.transform.position + new Vector3(0f, 2.5f, 0f);
                }
            }
        }
        ...
        {
            var swimmingParams = GetSwimmingParams();
            if (swimmingParams == null) return;
            Traverse.Create(swimmingParams).Field("swimmingVelocityOutOfWaterDrainRate").SetValue(speed);
        }
        ...
        {
            return Traverse.Create(GTPlayer.Instance).Field("swimmingParams").GetValue();
        }
        ...
        public static void WaterRunHelper(bool enable)
        {
            ...
            var swimTraverse = Traverse.Create(swimmingParams);

            if (enable)
            {
                waterSurfaceJumpAmount = swimTraverse.Field("waterSurfaceJumpAmount").GetValue<float>();
                waterSurfaceJumpMaxSpeed = swimTraverse.Field("waterSurfaceJumpMaxSpeed").GetValue<float>();

                swimTraverse.Field("waterSurfaceJumpAmount").SetValue(1.25f);
                swimTraverse.Field("waterSurfaceJumpMaxSpeed").SetValue(4.333f);
            }
            else
            {
                swimTraverse.Field("waterSurfaceJumpAmount").SetValue(waterSurfaceJumpAmount ?? 0.6f);
                swimTraverse.Field("waterSurfaceJumpMaxSpeed").SetValue(waterSurfaceJumpMaxSpeed ?? 1f);
            }
        }
            ...
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    VRRig.LocalRig.transform.position = lockTarget.transform.position +
                                                        new Vector3(Mathf.Cos(Time.frameCount / 20f), 0.5f,
        ...
        public static void JumpscareGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    VRRig.LocalRig.transform.position = lockTarget.headMesh.transform.position +
                                                        lockTarget.headMesh.transform.forward *
                    ...
                    VRRig.LocalRig.leftHand.rigTarget.transform.position = lockTarget.headMesh.transform.position +
                                                                           lockTarget.headMesh.transform.right * 0.2f;
                    VRRig.LocalRig.rightHand.rigTarget.transform.position = lockTarget.headMesh.transform.position +
                                                                            lockTarget.headMesh.transform.right * -0.2f;

                    VRRig.LocalRig.head.rigTarget.transform.rotation = dirLook;

                    VRRig.LocalRig.leftHand.rigTarget.transform.rotation =
                        Quaternion.Euler(VRRig.LocalRig.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
                    VRRig.LocalRig.rightHand.rigTarget.transform.rotation =
                        Quaternion.Euler(VRRig.LocalRig.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
        ...
        public static void JumpscareAll()
        {
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    ...
                    VRRig.LocalRig.transform.position = targetRig.headMesh.transform.position +
                                                        targetRig.headMesh.transform.forward * Random.Range(0.1f, 0.5f);
                    VRRig.LocalRig.head.rigTarget.transform.LookAt(targetRig.headMesh.transform.position);
                    Quaternion dirLook = VRRig.LocalRig.head.rigTarget.transform.rotation;

                    VRRig.LocalRig.transform.rotation = dirLook;

                    VRRig.LocalRig.leftHand.rigTarget.transform.position = targetRig.headMesh.transform.position +
                                                                           targetRig.headMesh.transform.right * 0.2f;
                    VRRig.LocalRig.rightHand.rigTarget.transform.position = targetRig.headMesh.transform.position +
                                                                            targetRig.headMesh.transform.right * -0.2f;
        ...
        public static void AnnoyPlayerGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    VRRig.LocalRig.leftHand.rigTarget.transform.position =
                        lockTarget.transform.position + RandomVector3();
                    VRRig.LocalRig.rightHand.rigTarget.transform.position =
                        lockTarget.transform.position + RandomVector3();
        ...
        public static void AnnoyAllPlayers()
        {
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    ...
                    VRRig.LocalRig.head.rigTarget.transform.rotation = RandomQuaternion();
                    VRRig.LocalRig.leftHand.rigTarget.transform.position =
                        targetRig.transform.position + RandomVector3();
                    VRRig.LocalRig.rightHand.rigTarget.transform.position =
                        targetRig.transform.position + RandomVector3();
        ...
        public static void ConfusePlayerGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    {
                        GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlaySplashEffect", GetPlayerFromVRRig(lockTarget),
                            lockTarget.transform.position + RandomVector3(0.5f), RandomQuaternion(), 4f, 100f, true,
                            false);
                        RPCProtection();
        ...
        public static void ConfuseAllPlayersSplash()
        {
            if (Time.time > Fun.splashDel)
            {
                ...
                GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlaySplashEffect", GetPlayerFromVRRig(rig),
                    rig.transform.position + RandomVector3(0.5f), RandomQuaternion(), 4f, 100f, true, false);
            }
        }
        ...
        public static void ChangeTinnitusHz(bool positive = true)
        {
            ...
            Buttons.GetIndex("Change Tinnitus Hertz").overlapText =
                "Change Tinnitus Hertz <color=grey>[</color><color=green>" + targetHz + "</color><color=grey>]</color>";
        }
        ...
        public static Dictionary<AudioClip, VoiceManager.Clip>
            tinnitus = new Dictionary<AudioClip, VoiceManager.Clip>();
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal() && !gunLocked)
                    {
                        ...
                        SerializePatch.OverrideSerialization = () =>
                        {
                            ...
                            VRRig.LocalRig.transform.position = lockTarget.transform.position -
                                                                (lockTarget.headMesh.transform.forward * 0.2f);
                            SendSerialize(VRRig.LocalRig.GetPhotonView(),
                                new RaiseEventOptions { TargetActors = new[] { target.ActorNumber } });

                            VRRig.LocalRig.transform.position = new Vector3(Random.Range(-99999f, 99999f), 99999f,
                                Random.Range(-99999f, 99999f));
                            SendSerialize(VRRig.LocalRig.GetPhotonView(),
                                new RaiseEventOptions
                                {
                                    TargetActors = PhotonNetwork.PlayerList
                                        .Where(plr => plr.ActorNumber != target.ActorNumber)
        ...
        public static void TinnitusAll()
        {
            ...
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    ...
                    VRRig.LocalRig.transform.position =
                        targetRig.transform.position - (targetRig.headMesh.transform.forward * 0.2f);
                    SendSerialize(VRRig.LocalRig.GetPhotonView(),
                        new RaiseEventOptions { TargetActors = new[] { Player.ActorNumber } });
                }
        ...
        public static void OverstimulateGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    {
                        GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlaySplashEffect", GetPlayerFromVRRig(lockTarget),
                            lockTarget.headMesh.transform.TransformPoint(Vector3.forward * 0.2f), RandomQuaternion(),
                            4f, 100f, true, false);
                        Fun.splashDel = Time.time + 0.1f;
                    }
                    ...
                    if (Random.Range(0f, 1f) > 0.5f)
                    {
                        if (Time.time > soundSpamDelay)
                        {
                            ...
                            GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlayHandTap", lockTarget.GetPhotonPlayer(),
                                Random.Range(336, 338), false, 999999f);
                        }
                    }
                    else
                    {
                        if (Time.time > soundSpamDelay)
                        {
                            ...
                            soundSpamDelay = Time.time + 0.1f;
                            GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlayHandTap", lockTarget.GetPhotonPlayer(),
                                sounds[Random.Range(0, 1)], false, 999999f);
                        }
                    }
                    ...
                    if (Time.time > hoverboardSpawnDelay)
                    {
                        ...
                        FreeHoverboardManager.DataPerPlayer orCreatePlayerData =
                            FreeHoverboardManager.instance.GetOrCreatePlayerData(NetworkSystem.Instance.LocalPlayer
                                .ActorNumber);
                        int boardIndex = orCreatePlayerData.board0.gameObject.activeSelf
                            ? ((!orCreatePlayerData.board1.gameObject.activeSelf)
                                ? 1
                                : (1 - FreeHoverboardManager.instance.localPlayerLastSpawnedBoardIndex))
                            : 0;

                        FreeHoverboardManager.instance.photonView.RPC("DropBoard_RPC", lockTarget.GetPhotonPlayer(),
                            boardIndex == 1,
                            BitPackUtils.PackWorldPosForNetwork(
                                lockTarget.headMesh.transform.TransformPoint(Vector3.forward * 0.2f)),
                            BitPackUtils.PackQuaternionForNetwork(RandomQuaternion()),
                            BitPackUtils.PackWorldPosForNetwork(RandomVector3(3)),
                            BitPackUtils.PackWorldPosForNetwork(RandomVector3(3)),
        ...
        public static void OverstimulateAll()
        {
            ...
            if (Time.time > Fun.splashDel)
            {
                GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlaySplashEffect", GetPlayerFromVRRig(randomRig),
                    randomRig.headMesh.transform.TransformPoint(Vector3.forward * 0.2f), RandomQuaternion(), 4f, 100f,
                    true, false);
                Fun.splashDel = Time.time + 0.1f;
            }
            ...
            if (Random.Range(0f, 1f) > 0.5f)
            {
                ...
                {
                    soundSpamDelay = Time.time + 0.1f;
                    GorillaTagger.Instance.myVRRig.SendRPC("RPC_PlayHandTap", randomRig.GetPhotonPlayer(),
                        Random.Range(336, 338), false, 999999f);
                }
            }
            else
            ...
            if (Time.time > hoverboardSpawnDelay)
            {
                ...
                FreeHoverboardManager.instance.photonView.RPC("DropBoard_RPC", randomRig.GetPhotonPlayer(),
                    boardIndex == 1,
                    BitPackUtils.PackWorldPosForNetwork(
                        randomRig.headMesh.transform.TransformPoint(Vector3.forward * 0.2f)),
                    BitPackUtils.PackQuaternionForNetwork(RandomQuaternion()),
                    BitPackUtils.PackWorldPosForNetwork(RandomVector3(3)),
                    BitPackUtils.PackWorldPosForNetwork(RandomVector3(3)),
                    BitPackUtils.PackColorForNetwork(RandomColor()));
            ...
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    if (gunTarget && !gunTarget.IsLocal())
                    {
                        ...
                        LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Mods/Fun/shutdown.ogg",
                            "Audio/Mods/Fun/shutdown.ogg", clip => Sound.PlayAudio(clip));
                    }
                }
            }
            else
        ...
        public static void IntercourseGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
                    ...
                    {
                        VRRig.LocalRig.transform.position = lockTarget.transform.position +
                                                            lockTarget.transform.forward *
                                                            -(0.2f + Mathf.Sin(Time.frameCount / 8f) * 0.1f);
                        VRRig.LocalRig.transform.rotation = lockTarget.transform.rotation;

                        VRRig.LocalRig.leftHand.rigTarget.transform.position = lockTarget.transform.position +
                                                                               lockTarget.transform.right * -0.2f +
                                                                               lockTarget.transform.up * -0.4f;
                        VRRig.LocalRig.rightHand.rigTarget.transform.position = lockTarget.transform.position +
                            lockTarget.transform.right * 0.2f + lockTarget.transform.up * -0.4f;
                    ...
                    else
                    {
                        ...
                        VRRig.LocalRig.leftHand.rigTarget.transform.rotation =
                            Quaternion.Euler(lockTarget.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
                        VRRig.LocalRig.rightHand.rigTarget.transform.rotation =
                            Quaternion.Euler(lockTarget.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
            ...
            if (Time.frameCount % 45 == 0)
            {
                if (PhotonNetwork.InRoom)
                {
                    ...
                    if (Buttons.GetIndex("Splash Intercourse").enabled)
                        Fun.BetaWaterSplash(VRRig.LocalRig.transform.position, VRRig.LocalRig.transform.rotation, 4f,
                            100f, true, false);
        ...
        public static void IntercourseAll()
        {
            SerializePatch.OverrideSerialization = () =>
            {
                ...
                foreach (NetPlayer Player in NetworkSystem.Instance.PlayerListOthers)
                {
                    ...
                    {
                        VRRig.LocalRig.transform.position = targetRig.transform.position +
                                                            targetRig.transform.forward *
                                                            -(0.2f + Mathf.Sin(Time.frameCount / 8f) * 0.1f);
                        VRRig.LocalRig.transform.rotation = targetRig.transform.rotation;

                        VRRig.LocalRig.leftHand.rigTarget.transform.position = targetRig.transform.position +
                                                                               targetRig.transform.right * -0.2f +
                                                                               targetRig.transform.up * -0.4f;
                        VRRig.LocalRig.rightHand.rigTarget.transform.position = targetRig.transform.position +
                            targetRig.transform.right * 0.2f + targetRig.transform.up * -0.4f;
                    ...
                    else
                    {
                        ...
                        VRRig.LocalRig.leftHand.rigTarget.transform.rotation =
                            Quaternion.Euler(targetRig.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
                        VRRig.LocalRig.rightHand.rigTarget.transform.rotation =
                            Quaternion.Euler(targetRig.transform.rotation.eulerAngles + new Vector3(0f, 180f, 0f));
        ...
        {
            Prompt(
                "You have to be age verified to use this mod. Would you like to proceed to the age verification process?",
                () =>
                {
                    NotificationManager.SendNotification(
                        $"<color=grey>[</color><color=red>SEX</color><color=grey>]</color> A browser tab has been opened on your computer.");
                    PromptSingle("A browser tab has been opened on your computer. Please go and verify your age.", null,
                        "Ok frick off buddy");
        ...
        public static IEnumerator Sex()
        {
            ...
            sex.transform.position = VRRig.LocalRig.headMesh.transform.position +
                                     VRRig.LocalRig.headMesh.transform.forward * 1.5f;
            ...
            while (true)
            {
                ...
                {
                    if (rightGrab && rightHand != null &&
                        Vector3.Distance(sex.transform.position, rightHand.position) <= grabRadius)
                        activeHand = rightHand;
                    else if (leftGrab && leftHand != null &&
                             Vector3.Distance(sex.transform.position, leftHand.position) <= grabRadius)
                        activeHand = leftHand;
                }
        ...
        public static void SpazHeadPosition() =>
            VRRig.LocalRig.head.trackingPositionOffset = headoffs + new Vector3(Random.Range(-0.1f, 0.1f),
        ...
        public static void MultiplicationAmount(bool positive = true)
        {
            ...
            Buttons.GetIndex("Knockback Multiplication Amount").overlapText =
                "Knockback Multiplication Amount <color=grey>[</color><color=green>" + (multiplicationAmount / 10f) +
                "</color><color=grey>]</color>";
        }
        ...
        public static void VRRigLateUpdate_BackFlip()
        {
            ...
            if (backflip.active)
            {
                float t = (Time.time - backflip.start) / FlipDuration;
                if (t >= 1f)
                {
                    backflip.active = false;
                    lastBackflipEnd = Time.time;
                    rig.transform.rotation = backflip.rot;
                    rig.head.rigTarget.transform.rotation = backflip.headRot;
                    return;
                }

                Quaternion flipRot = Quaternion.AngleAxis(backflip.dir * 360f * t, backflip.axis);
                rig.transform.rotation = flipRot * backflip.rot;
                rig.head.rigTarget.transform.rotation = flipRot * backflip.headRot;
            }
            else
            {
                bool pressed = leftSecondary;

                if (pressed && !wasBackflipPressed && Time.time - lastBackflipEnd >= FlipCooldown)
                {
                    backflip = new FlipState
                    {
                        active = true,
                        rot = rig.transform.rotation,
                        headRot = rig.head.rigTarget.transform.rotation,
                ...
                wasBackflipPressed = pressed;
            }
        }

        public static void Zoom()
        {
            if (rightTrigger > 0.5f && !Zoomed)
            {
                ShouldZoom = !ShouldZoom;
                CoroutineManager.instance.StartCoroutine(Zoom(ShouldZoom ? 1f : 4f, ShouldZoom ? 4f : 1f));
            }

            Zoomed = rightTrigger > 0.5f;
        }
        ...
        {
            if (trackedPlayer == null || !trackedPlayer.Active())
                trackedPlayer = GetClosestVRRig();

            if (trackedPlayer == null || trackedPlayer.IsLocal())
            {
                NotificationManager.SendNotification("<color=grey>[</color><color=purple>TRACK</color><color=grey>]</color> No players to track.");
                return;
            }

            trackDistance = Vector3.Distance(VRRig.LocalRig.transform.position, trackedPlayer.transform.position);
            NotificationManager.information["Tracking"] = trackedPlayer.GetName() + " (" + trackDistance.ToString("F1") + "m)";

            if (trackFollowing)
            {
                Vector3 dir = (trackedPlayer.transform.position - VRRig.LocalRig.transform.position).normalized;
                float speed = FlySpeed * 2f;
                GTPlayer.Instance.bodyCollider.attachedRigidbody.linearVelocity = dir * speed;
            }
        }
        ...
        public static void TeleportToTracked()
        {
            ...
            closePosition = Vector3.zero;
            TeleportPlayer(trackedPlayer.headMesh.transform.position);
            GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
        ...
        {
            List<VRRig> rigs = VRRigCache.ActiveRigs.Where(r => !r.IsLocal()).ToList();
            if (rigs.Count == 0)
            {
                NotificationManager.SendNotification("<color=grey>[</color><color=purple>TRACK</color><color=grey>]</color> No players to track.");
                return;
            ...
            int currentIndex = trackedPlayer != null ? rigs.IndexOf(trackedPlayer) : -1;
            int nextIndex = (currentIndex + 1) % rigs.Count;
            trackedPlayer = rigs[nextIndex];
            trackDistance = Vector3.Distance(VRRig.LocalRig.transform.position, trackedPlayer.transform.position);
        ...
        private static string SavedTeleportsPath =>
            System.IO.Path.Combine(Application.persistentDataPath, "SeralythTeleports.json");

        private static void SaveTeleports()
        {
            try
            {
                SavedTeleportData data = new SavedTeleportData();
                foreach (var s in savedTeleports)
                    data.spots.Add(s);
                File.WriteAllText(SavedTeleportsPath, JsonUtility.ToJson(data, true));
            }
            catch { }
        }
        ...
        private static void LoadTeleports()
        {
            try
            {
                if (!File.Exists(SavedTeleportsPath)) return;
                string json = File.ReadAllText(SavedTeleportsPath);
                SavedTeleportData data = JsonUtility.FromJson<SavedTeleportData>(json);
                if (data == null || data.spots == null) return;
                savedTeleports.Clear();
                foreach (var s in data.spots)
                    if (!string.IsNullOrEmpty(s.name))
                        savedTeleports.Add(s);
            }
            catch { }
        }
        ...
        {
            if (!teleportsLoaded) { LoadTeleports(); teleportsLoaded = true; }

            rememberPageNumber = pageNumber;

            List<ButtonInfo> qtButtons = new List<ButtonInfo>
            {
                new ButtonInfo
                {
                    buttonText = "Exit Quick Teleports", method = () => Buttons.CurrentCategoryName = "Movement Mods", isTogglable = false,
                    toolTip = "Returns you back to the movement mods."
                }
            };

            qtButtons.Add(new ButtonInfo
            {
                ...
                method = SaveCurrentPosition, isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => TeleportPlayer(VRRig.LocalRig.transform.position), isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/TreeRoomSpawnForestZone", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Forest, Tree Exit"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/ForestToCity", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - City Front"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/ForestToCave", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Cave"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/BeachToForest", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Beach for Computer"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/ForestCanyonTransition", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Canyon"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/CityToMountain", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Mountain"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/CityToSkyJungle", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Clouds From Computer"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/CityToBasement", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - Basement For Computer"); },
                isTogglable = false,
            ...
            qtButtons.Add(new ButtonInfo
            {
                ...
                method = () => { TeleportToMap("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/Regional Transition/BayouOnly", "Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab/JoinPublicRoom - BayouComputer2"); },
                isTogglable = false,
            ...
            if (savedTeleports.Count > 0)
            {
                ...
                for (int i = 0; i < savedTeleports.Count; i++)
                {
                    int idx = i;
                    var spot = savedTeleports[i];
                    qtButtons.Add(new ButtonInfo
                    {
                        buttonText = "TeleportSaved" + i,
                        overlapText = $"<color=green>{spot.name}</color>",
                        method = () =>
                        {
                            TeleportPlayer(new Vector3(spot.x, spot.y, spot.z));
                            GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
                            VRRig.LocalRig.PlayHandTapLocal(50, rightHand, 0.4f);
                    ...
                    qtButtons.Add(new ButtonInfo
                    {
                        buttonText = "DeleteSaved" + i,
                        overlapText = $"<color=red>Delete {spot.name}</color>",
                        method = () =>
                        {
                            string removedName = savedTeleports[idx].name;
                            savedTeleports.RemoveAt(idx);
                            SaveTeleports();
                            OpenQuickTeleports();
                            NotificationManager.SendNotification("<color=grey>[</color><color=yellow>TELEPORT</color><color=grey>]</color> Deleted <color=red>" + removedName + "</color>.");
                        },
                        isTogglable = false,
            ...
            Buttons.buttons[Buttons.GetCategory("Temporary Category")] = qtButtons.ToArray();
            Buttons.CurrentCategoryName = "Temporary Category";
        }
        ...
        private static void SaveCurrentPosition()
        {
            ...
            string spotName = "Spot " + (savedTeleports.Count + 1);
            ...
            SaveTeleports();
            OpenQuickTeleports();
            NotificationManager.SendNotification("<color=grey>[</color><color=yellow>TELEPORT</color><color=grey>]</color> Saved <color=green>" + spotName + "</color> at your position.");
        }
